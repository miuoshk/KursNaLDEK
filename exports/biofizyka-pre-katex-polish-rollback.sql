...
UPDATE public.questions
   SET text = 'Zdolność rozdzielcza mikroskopu zależy od',
       ...
       explanation = 'Zdolność rozdzielcza mikroskopu zależy od długości fali oświetlającej preparat i współczynnika załamania ośrodka przed obiektywem. Wzór Abbego: $d = \lambda/(2 \cdot n \cdot \\sin(u))$, gdzie n*sin(u) to apertura numeryczna.'
...
UPDATE public.questions
   SET text = 'Odwrotność najmniejszego kąta, pod jakim widziane są ze źrenicy wyjściowej oka osobno obrazy dwóch punktów nazwiemy',
       ...
       explanation = 'Zdolność rozdzielcza kątowa oka to odwrotność najmniejszego kąta, pod jakim można rozróżnić dwa punkty jako osobne. Dla zdrowego oka wynosi ok. 1 minuta kątowa.'
...
UPDATE public.questions
   SET text = 'Zgodnie z prawem de Broglie’a każdą cząstkę materialną znajdującą się w ruchu można rozpatrywać jako falę o długości ($h$ - stała Plancka, m - masa, v - prędkość, f - częstotliwość)',
       options = '[{"id":"a","text":"$\\\\lambda = \\dfrac{v}{f}$"},{"id":"b","text":"$\\\\lambda = \\tfrac{1}{2} mv^{2}$"},{"id":"c","text":"$\\\\lambda = \\dfrac{h}{mv}$"},{"id":"d","text":"$\\\\lambda = \\dfrac{h}{mv^{2}}$"}]'::jsonb,
       explanation = 'Hipoteza de Broglie''a: każda cząstka w ruchu ma przypisana fale o długości $\\lambda = \dfrac{h}{mv} = \dfrac{h}{p}$, gdzie h to stała Plancka, m masa, v prędkość. Elektrony w mikroskopie elektronowym mają krótsze fale niż światło.'
...
UPDATE public.questions
   SET text = 'Zdolność skupiającą D soczewki korekcyjnej znajdującej się w odległości x od oka o refrakcji R_K obliczamy ze wzoru',
       options = '[{"id":"a","text":"$D = \\dfrac{1}{1+x \\cdot R_{K}}$"},{"id":"b","text":"$D = \\dfrac{R_{K}}{1-x \\cdot R_{K}}$"},{"id":"c","text":"$D = \\dfrac{1}{1-x \\cdot R_{K}}$"},{"id":"d","text":"$D = \\dfrac{R_{K}}{1+x \\cdot R_{K}}$"}]'::jsonb,
       explanation = 'Zdolność skupiającą soczewki korekcyjnej w odległości x od oka o refrakcji R: $D = \dfrac{R_{K}}{1-x \cdot R_{K}}$. Uwzględnia to fakt, ze soczewka nie jest dokładnie przy oku.'
...
UPDATE public.questions
   SET text = 'Przedmiot umieszczony w podwójnej ogniskowej soczewki cienkiej wypukłej daje obraz:',
       ...
       explanation = 'Przedmiot w podwójnej ogniskowej (x=2f) daje obraz rzeczywisty, niepowiększony, niezmniejszony, odwrócony, również w odległości 2f od soczewki. Powiększenie = -1.'
...
UPDATE public.questions
   SET text = 'Ogniskowa przedmiotowa to odległość między punktami',
       ...
       explanation = 'Ogniskowa przedmiotowa f to odległość od płaszczyzny głównej przedmiotowej H do ogniska przedmiotowego F. Promienie rownolegle po stronie przedmiotowej skupiają się w ognisku obrazowym.'
...
UPDATE public.questions
   SET text = 'W przypadku nadwzroczności zmieniając korekcję okularową na korekcję za pomocą soczewek kontaktowych soczewki będą miały',
       ...
       explanation = 'Przy nadwzroczności (R>0): soczewki kontaktowe mają większa moc niż okulary. Soczewka kontaktowa jest blizej oka, wiec potrzebna większa korekcja. Wzór: $D_{kontakt} = \dfrac{D_{okular}}{1-x \cdot D_{okular}}$.'
...
UPDATE public.questions
   SET text = 'Czas wygaszenia fluorescencji jest zazwyczaj … niż fosforescencji.',
       ...
       explanation = 'Fluorescencja ma krótszy czas wygaszenia ($10^{-9}$ do $10^{-6}$ s) niż fosforescencja ($10^{-3}$ do sekund/minut). Fluorescencja = przejscie singlet-singlet, fosforescencja = przejscie triplet-singlet (wolniejsze).'
...
UPDATE public.questions
   SET text = 'Czas wygaszenia fosforescencji jest zazwyczaj … niż fluorescencji.',
       ...
       explanation = 'Fosforescencja ma dłuższy czas wygaszenia niż fluorescencja. Fosforescencja wymaga "zabronionych" przejsc między stanami o roznym spinie (triplet->singlet), co trwa dluzej.'
...
UPDATE public.questions
   SET text = 'Co nazywamy dyspersją przenikalności dielektrycznej tkanek?',
       ...
       explanation = 'Dyspersją przenikalności dielektrycznej to zależność przenikalności od częstotliwości pola elektrycznego. Różne mechanizmy polaryzacji mają różne czasy relaksacji.'
...
UPDATE public.questions
   SET text = 'Widmo emisyjne to:',
       ...
       explanation = 'Widmo emisyjne: liniowe dla gazów atomowych (dyskretne przejscia elektronowe), pasmowe dla gazów czasteczkowych (przejscia rotacyjno-oscylacyjne), ciągłe dla ciał stałych i cieczy.'
...
UPDATE public.questions
   SET text = 'Energia emitowana przez cząsteczkę składa się z trzech części: - zmian energii związanej ze zmianą poziomu oscylacyjnego E_o, zmian energii związanej z przejściem elektronu E_e, zmian energii związanej ze zmianą poziomu rotacyjnego E_r. Ogólnie emitowana energia jest wynikiem',
       ...
       explanation = 'Energie cząstek: $E_{elektronowa}$ >> $E_{oscylacyjna}$ >> $E_{rotacyjna}$. Elektrony mają największa energie (eV), oscylacje ~0.1 eV, rotacje ~0.001 eV. Dlatego widma rotacyjne sa w podczerwieni/mikrofalach.'
...
UPDATE public.questions
   SET text = 'Tkanki biologiczne mają charakter',
       ...
       explanation = 'Tkanki biologiczne mają charakter pojemnościowo-oporowy (RC). Blony działają jak kondensatory (pojemność), cytozol i plyny zewnatrzkomorkowe jak opory. Indukcyjnosc jest pomijalna.'
...
UPDATE public.questions
   SET text = 'Prawo Beera stosuje się:',
       ...
       explanation = 'Prawo Beera stosuje się do roztworów, których struktura nie zmienia się ze stezeniem - brak asocjacji, dysocjacji, reakcji chemicznych. Wtedy absorpcja jest wprost proporcjonalna do stężenia.'
...
UPDATE public.questions
   SET text = 'Korzystając z prawa Lamberta-Beera można wyznaczyć nieznane stężenie roztworu. Sporządzamy wówczas wykres A = f(c), ponieważ',
       ...
       explanation = 'Prawo Lamberta-Beera: $A = \epsilon \cdot c \cdot l. Absorbancja ( A) jest liniowo zale$żna od stężenia (c). Wykres A=f( c) jest linia prosta przechodzaca przez poczatek ukladu.'
...
UPDATE public.questions
   SET text = 'Dla dielektryków szerokość pasma wzbronionego wynosi',
       ...
       explanation = 'Dielektryk (izolator): pasmo wzbronione > 2-3 eV. Półprzewodnik: pasmo wzbronione < 2 eV. Metal: brak pasma wzbronionego. Szerokość pasma okresla, czy elektrony mogą byc wzbudzone.'
 WHERE id = 'biofiz-c1-021';

UPDATE public.questions
   SET text = 'Moment sił działających na dipol ($p$) w polu elektrycznym ($E$) określa wzór ($a$ - jest kątem między polem E i p',
       options = '[{"id":"a","text":"$p \\cdot E \\cdot \\\\tan(a)$"},{"id":"b","text":"$p \\cdot E \\cdot \\\\sin(a)$"},{"id":"c","text":"$p \\cdot E \\cdot \\\\cos(a)$"},{"id":"d","text":"$p \\cdot E \\cdot a$"}]'::jsonb,
       explanation = 'Moment siły działający na dipol w polu elektrycznym: $M = p \times E = p \cdot E \cdot \\sin(\alpha)$, gdzie alpha to kąt między wektorem dipola p i polem E. Siła dąży do ustawienia dipola wzdłuż pola.'
...
UPDATE public.questions
   SET text = 'Błonę komórkową możemy określić jako',
       ...
       explanation = 'Błona komórkowa jest izolatorem (warstwa lipidowa) o przenikalności dielektrycznej epsilon = 5-6 (podobna do oleju). Bardzo cienka (7-10 nm), ale skutecznie izoluje cytozol od środowiska.'
...
UPDATE public.questions
   SET text = 'Stratami przewodzenia w dielektryku rzeczywistym umieszczonym w zewnętrznym polu elektrycznym nazywamy ciepło wydzielone w trakcie',
       ...
       explanation = 'Straty przewodzenia to ciepło wydzielane wskutek przepływu ładunków swobodnych (elektronów, jonow) przez dielektryk. Proporcjonalne do przewodności właściwej i kwadratu pola.'
...
UPDATE public.questions
   SET text = 'Polaryzację polegającą na ustawianiu się molekuł dipolowych zgodnie z zewnętrznym polem elektrycznym nazywamy polaryzacją',
       ...
       explanation = 'Polaryzacją orientacyjną polega na ustawianiu się trwałych dipoli molekularnych zgodnie z zewnętrznym polem elektrycznym. Występuje w dielektrykach polarnych (np. woda). Maleje ze wzrostem temperatury.'
 WHERE id = 'biofiz-c1-025';

UPDATE public.questions
   SET text = 'Dipol elektryczny definiujemy jako ($q$ - ładunek, I - odległość między ładunkiem + i - ):',
       options = '[{"id":"a","text":"$q \\cdot l i jest to wektor skierowany od + do -$"},{"id":"b","text":"$\\dfrac{q}{l} i jest to skalar$"},{"id":"c","text":"$q \\cdot l i jest to wektor skierowany od - do +$"},{"id":"d","text":"$\\dfrac{q}{l} i jest to wektor skierowany od - do +$"}]'::jsonb,
       explanation = 'Dipol elektryczny: p = q*l (iloczyn ładunku i odległości). Jest wektorem skierowanym od ładunku ujemnego do dodatniego (umownie). Jednostka: C*m lub Debye.'
...
UPDATE public.questions
   SET text = 'Czas relaksacji dielektrycznej nazwiemy czas w którym, po wyłączeniu pola elektrycznego polaryzacja dielektryka (e = 2,71, π = 3,14)',
       ...
       explanation = 'Czas relaksacji dielektrycznej tau to czas, po którym polaryzacja maleje e-krotnie (e = 2.718...) po wyłączeniu pola. Różne mechanizmy polaryzacji mają różne czasy relaksacji.'
...
UPDATE public.questions
   SET text = 'Fluorescencję zaliczamy do świecenia:',
       ...
       explanation = 'Fluorescencja to swiecenie nietermiczne (luminescencja) z krótkim czasem trwania (nanosekundy). Emisja nastepuje natychmiast po absorpcji fotonu, bez udzialu ciepla.'
 WHERE id = 'biofiz-c1-029';

UPDATE public.questions
   SET text = 'Widmo emisyjne jako otrzymujemy dla gazów wieloatomowych klasyfikujemy jako widmo:',
       options = '[{"id":"a","text":"charakterystyczne"},{"id":"b","text":"ciągłe"},{"id":"c","text":"$pasmowe (jezeli wieloatomowe = czasteczkowe)$"},{"id":"d","text":"$liniowe (jezeli wieloatomowe = atomowe)$"}]'::jsonb,
...
UPDATE public.questions
   SET text = 'Zgodnie z prawem Beera, dla pewnych roztworów o małym stężeniu współczynnik osłabienia "k" jest:',
       ...
       explanation = 'Prawo Beera: współczynnik absorpcji k (lub osłabienia) jest wprost proporcjonalny do stężenia roztworu. k = alpha*c, gdzie alpha to współczynnik absorpcji molowej.'
...
UPDATE public.questions
   SET text = 'Dla roztworu o małym stężeniu roztworu współczynnika absorpcji a jest charakterystyczny dla λ',
       ...
       explanation = 'Współczynnik absorpcji molowej (epsilon) jest charakterystyczny dla danej substancji i długości fali promieniowania. Nie zależy od stężenia ani mocy promieniowania - to wlasnosc materialu.'
...
UPDATE public.questions
   SET text = 'Kompensator w refraktometrze Abbego',
       ...
       explanation = 'Kompensator (pryzmat Amiciego) w refraktometrze Abbego likwiduje efekt dyspersji światła - różne długości fal sa inaczej zalamywane. Pozwala uzyskac ostra granice między polem jasnym i ciemnym.'
...
UPDATE public.questions
   SET text = 'Polaryzacja zachodząca na powierzchni dielektryka spełnia warunek ($α$ - kąt padania wiązki świetlnej na dielektryk, n - współczynnik załamania światła)',
       options = '[{"id":"a","text":"$\\\\tan(\\\\alpha) = n, całkowicie spolaryzowanym jest promien odbity$"},{"id":"b","text":"$\\\\tan(\\\\alpha) = n, całkowicie spolaryzowanym jest promien załamany$"},{"id":"c","text":"$\\\\sin(\\\\alpha) = n, całkowicie spolaryzowanym jest promien odbity$"},{"id":"d","text":"$\\\\sin(\\\\alpha) = n, całkowicie spolaryzowanym jest promien załamany$"}]'::jsonb,
...
UPDATE public.questions
   SET text = 'Aby dwa polaryzatory ustawione jeden za drugim nie przepuszczały światła trzeba ich kierunek światła ustawić pod kątem',
       ...
       explanation = 'Dwa polaryzatory ustawione prostopadle (90 stopni) nie przepuszczaja światła - tzw. polaryzatory skrzyzowane. Gdy osie polaryzacji sa rownolegle (0 stopni), światło przechodzi maksymalnie.'
...
UPDATE public.questions
   SET text = 'Sposób polaryzacji światła przez dichroizm polega na',
       ...
       explanation = 'Dichroizm to zjawisko roznego pochlaniania światła w zależności od kierunku drgań wektora E wzgledem osi krysztalograficznych. Wykorzystywane w polaroidach i krysztale turmalinu.'
...
UPDATE public.questions
   SET text = 'Bezwzględny współczynnik załamania światła jest',
       ...
       explanation = 'Bezwzględny współczynnik załamania n = c/v, gdzie c to prędkość światła w próżni, v w ośrodku. Jest odwrotnie proporcjonalny do prędkości światła w ośrodku, wprost proporcjonalny do c.'
...
UPDATE public.questions
   SET text = 'Prawo Malusa opisuje równanie ($I$ - natężenie wiązki świetlnej, α - kąt skręcenia płaszczyzny polaryzacji):',
       options = '[{"id":"a","text":"$I = I_{0} \\\\sin(\\\\alpha)$"},{"id":"b","text":"$I = I_{0} \\\\sin^{2}(\\\\alpha)$"},{"id":"c","text":"$I = I_{0} \\\\cos^{2}(\\\\alpha)$"},{"id":"d","text":"$I = I_{0} \\\\cos(\\\\alpha)$"}]'::jsonb,
       explanation = 'Prawo Malusa: $I = I_{0} \cdot \cos^{2}(\alpha)$, gdzie alpha to kąt między płaszczyznami polaryzacji polaryzatora i analizatora. Dla alpha=0: $I = I_{0}$, dla alpha=90: $I = 0$.'
...
UPDATE public.questions
   SET text = 'W refraktometrze Abbego pole jasne i pole ciemne otrzymujemy na skutek',
       ...
       explanation = 'W refraktometrze Abbego pole jasne i ciemne powstają na skutek odbicia calkowitego. Promienie padające pod kątem większym od granicznego ulegają całkowitemu odbiciu, pod mniejszym - przechodza.'
...
UPDATE public.questions
   SET text = 'Laserowa korekcja wady wzroku polega na',
       ...
       explanation = 'Laserowa korekcja wzroku (LASIK, PRK) polega na precyzyjnym usuwaniu warstw rogówki laserem ekscymerowym, zmieniajac jej krzywizne i zdolność skupiajaca oka. Nie ingeruje w soczewke ani siatkówke.'
...
UPDATE public.questions
   SET text = 'Zjawisko dichroizmu jest wykorzystane przy polaryzacji światła przez',
       ...
       explanation = 'Kryształ turmalinu wykorzystuje dichroizm do polaryzacji światła - absorbuje skladowa E rownolegle do osi, przepuszcza prostopadla. Pryzmat Nicola wykorzystuje dwojlomnosc.'
...
UPDATE public.questions
   SET text = 'Jeżeli światło przechodzi z ośrodka o współczynniku załamania n1 ($α$ - kąt padania) do ośrodka o współczynniku załamania n2 ($β$ - kąt załamania) to prawo załamania światła w tym przypadku wyraża równanie',
       options = '[{"id":"a","text":"$n1 \\\\cos(\\\\alpha) = n2 \\\\cos(\\\\beta)$"},{"id":"b","text":"$n2 \\\\cos(\\\\alpha) = n1 \\\\cos(\\\\beta)$"},{"id":"c","text":"$n2 \\\\sin(\\\\alpha) = n1 \\\\sin(\\\\beta)$"},{"id":"d","text":"$n1 \\\\sin(\\\\alpha) = n2 \\\\sin(\\\\beta) sin \\\\alpha n2 = sin \\\\beta n1 \\\\alpha - kat padania \\\\beta - kat załamania$"}]'::jsonb,
...
UPDATE public.questions
   SET text = 'Sposób polaryzacji światła przez dwójłomność polega na',
       ...
       explanation = 'Dwójłomność (birefringencja) polega na rozszczepieniu wiązki na dwa promienie (zwyczajny i nadzwyczajny) o różnych predkosciach i polaryzacji. Wykorzystywane w pryzmacie Nicola.'
...
UPDATE public.questions
   SET text = 'Jeśli kąt padania światła w ośrodku o większym współczynniku załamania jest mniejszy od kąta granicznego to',
       ...
       explanation = 'Gdy kąt padania < kąta granicznego, promień przechodzi do ośrodka o mniejszym n. Kąt załamania jest większy od kąta padania (promień oddala się od normalnej). Przy kacie granicznym beta=90.'
...
UPDATE public.questions
   SET text = 'Zgodnie z prawem ciągłości przepływu, przepływ cieczy przez przewężenie naczynia powoduje, że prędkość cieczy w przewężeniu (w porównaniu do szerszej części naczynia) jest',
       ...
       explanation = 'Prawo ciągłości przepływu: $A1 \cdot v1 = A2 \cdot v2. W przew$ężeniu pole przekroju jest mniejsze, wiec prędkość musi byc większa, by przepływ objetosciowy byl stały.'
...
UPDATE public.questions
   SET text = 'Opór naczyniowy kapilary jest proporcjonalny do',
       ...
       explanation = 'Opór naczyniowy R = 8*eta*L/(pi*r^4). Jest proporcjonalny do długości L i lepkości eta, odwrotnie proporcjonalny do r^4. Maly promien = duzy Opór.'
...
UPDATE public.questions
   SET text = 'Przeciętna wydajność serca u człowieka wynosi około',
       ...
       explanation = 'Wydajność serca (sprawnosc) w spoczynku wynosi ok. 14-20%. Wiekszosc energii zamieniana jest na cieplo. Przy wysiłku moze wzrosnac do 25-40%.'
...
UPDATE public.questions
   SET text = 'Przeciętna objętość wyrzutowa serca u człowieka wynosi około',
       ...
       explanation = 'Objętość wyrzutowa serca (SV - stroke volume) wynosi ok. 70 ml w spoczynku. Pojemność minutowa = SV * HR = 70 ml * 70/min = ok. 5 L/min.'
...
UPDATE public.questions
   SET text = 'Wraz z oddalaniem się w układzie krwionośnym (krążenie duże, zgodne z przepływem krwi) od serca średnia prędkość krwi w naczyniach',
       ...
       explanation = 'Ciśnienie krwi maleje w układzie tętniczym (od aorty do kapilar), a potem rośnie w układzie żylnym (powrot do serca). Gradient ciśnienia napedza przepływ.'
...
UPDATE public.questions
   SET text = 'Ciśnieniem transmuralnym nazwiemy różnicę między ciśnieniem krwi',
       ...
       explanation = 'Ciśnienie transmuralne to roznica między ciśnieniem wewnatrz naczynia a ciśnieniem w otaczających tkankach. Okresla obciążenie sciany naczynia.'
...
UPDATE public.questions
   SET text = 'Prawo mówiące, że suma ciśnień: statycznego, dynamicznego i hydrostatycznego jest stała w naczyniach połączonych szeregowo nazwiemy prawem',
       ...
       explanation = 'Równanie Bernoulliego: p + (1/2)*rho*v^2 + rho*g*h = const. Suma ciśnienia statycznego, dynamicznego i hydrostatycznego jest stała wzdłuż linii prądu.'
...
UPDATE public.questions
   SET text = 'Prędkość fali tętna w porównaniu ze średnią prędkością krwi w aorcie jest',
       ...
       explanation = 'Fala tętna rozchodzi się z prędkością ok. 5-10 m/s, podczas gdy średnia prędkość krwi w aorcie to ok. 0.3-0.5 m/s. Fala tętna jest ponad 10x szybsza.'
...
UPDATE public.questions
   SET text = 'Krążenie duże w układzie krwionośnym zaczyna się w',
       ...
       explanation = 'Krążenie duże (systemowe): lewa komora -> aorta -> tkanki -> zyly -> prawy przedsionek. Krążenie male: prawa komora -> pluca -> lewy przedsionek.'
...
UPDATE public.questions
   SET text = 'Kapilara o tej samej długości ale o dwukrotnie większym promieniu będzie miała opór naczyniowy dla tej samej cieczy',
       ...
       explanation = 'Opór R ~ 1/r^4. Dwukrotnie większy promien: $R2 = \dfrac{R1}{2^{4}} = \dfrac{R1}{16}$, czyli opór jest 16 razy mniejszy. Maly promien dramatycznie zwieksza opór.'
...
UPDATE public.questions
   SET text = 'Krew jest cieczą nienewtonowską i tiksotropową. Wzrost lepkości krwi jest powodowany przez',
       ...
       explanation = 'Lepkość krwi rosnie przy: nizszej temperaturze, wyzszym hematokrycie, agregacji erytrocytów. Krew jest cieczą tiksotropową - lepkość zależy od szybkosci ścinania.'
 WHERE id = 'biofiz-c3-011';

UPDATE public.questions
   SET text = 'W metodzie Stokesa wyznaczania współczynnika lepkości obserwujemy kroplę cieczy opadająca w cieczy o mniejszej gęstości. Jeśli siły działające na kroplę opadającą w cieczy lepkiej równoważą się i kropla porusza się ruchem jednostajnym, to o siłach działających na kulkę możemy powiedzieć, że',
       ...
       explanation = 'Metoda Stokesa: kulka osiaga prędkość graniczna gdy siła ciężkości jest równowazona przez sume siły wyporu i siły lepkości. F_g = F_wyporu + F_lepkości.'
...
UPDATE public.questions
   SET text = 'Zmniejszenie stopnia agregacji krwinek czerwonych, przy dużych szybkościach ścinania',
       ...
       explanation = 'Przy dużych szybkościach ścinania agregaty erytrocytow rozpadaja się, co zmniejsza lepkość krwi. Krew staje się bardziej plynna przy szybszym przeplywie.'
...
UPDATE public.questions
   SET text = 'Wzrost temperatury krwi powoduje',
       ...
       explanation = 'Wzrost temperatury zmniejsza lepkość bezwzględna (ciecz staje się bardziej plynna). Lepkość względna (stosunek do wody) prawie się nie zmienia, bo woda tez staje się mniej lepka.'
...
UPDATE public.questions
   SET text = 'W trakcie przepływu krwi przez naczynia krwionośne na lepkość krwi mogą wpływać różne czynniki. Powoduje to, że lepkość krwi może być różna w różnych częściach układu naczyniowego. Jednym ze zjawisk wpływających na lepkość krwi to efekt Magnusa. Można go wyjaśnić poprzez',
       ...
       explanation = 'Akumulacja osiowa erytrocytów (efekt Fahraeus-Lindqvist): czerwone krwinki gromadza się w osi naczynia, przy scianach plynie osocze. Zmniejsza to pozorna lepkość w malych naczyniach.'
...
UPDATE public.questions
   SET text = 'Po wkropieniu kropli cieczy o większej gęstości niż ciecz w naczyniu, kropla cieczy zaczyna opadać ruchem niejednostajnie przyśpieszonym. Przyśpieszenie w tym ruchu stopniowo zmniejsza się (do zera) na skutek',
       ...
       explanation = 'Kropla przyspieszajac zwieksza prędkość, co zwieksza sile lepkości (F = 6*pi*eta*r*v). W koncu siła lepkości zrownowazy sile wypadkowa i kropla osiagnie prędkość graniczna.'
...
UPDATE public.questions
   SET text = 'Każde ciało poruszające się w ośrodku lepkim doznaje siły oporu, przeciwnie skierowanej do prędkości ciała. Siła oporu działająca na ciało w kształcie kuli, poruszające się ze stałą prędkością jest proporcjonalna',
       ...
       explanation = 'Siła Stokesa: $F = 6 \cdot \pi \cdot eta \cdot r \cdot v$. Proporcjonalna do współczynnika lepkości eta, promienia kuli r i prędkości v. Dziala przeciwnie do kierunku ruchu.'
...
UPDATE public.questions
   SET text = 'Głównym elementem wiskozymetru Ostwalda jest kapilara, przez którą przepuszczamy określoną objętość cieczy. Wykorzystując prawo Poiseuille’a przy wyznaczaniu lepkości cieczy metodą wiskozymetryczną możemy stwierdzić że lepkość cieczy przepływającej przez kapilarę (przy ustalonej objętości - objętość górnego zbiorniczka) jest proporcjonalna do',
       ...
       explanation = 'Wiskozymetr Ostwalda: lepkość proporcjonalna do czasu przepływu i gęstości cieczy. eta = K*rho*t, gdzie K to stała aparatu.'
...
UPDATE public.questions
   SET text = 'Współczynnik lepkości cieczy zależy od temperatury, przy czym wzrost temperatury najczęściej powoduje zmniejszenie współczynnika lepkości. Określ parametry występujące w poniższym wzorze zależności lepkości od temperatury',
       ...
       explanation = 'Zależność lepkości od temperatury: $eta = A \cdot \exp(\dfrac{W}{k \cdot T})$, gdzie k to stała Boltzmanna, T temperatura w Kelwinach, W energia aktywacji przepływu lepkiego.'
...
UPDATE public.questions
   SET text = 'Ze względu na właściwości lepkie krew nie można zaliczyć do cieczy',
       ...
       explanation = 'Krew NIE jest cieczą newtonowska. Jest cieczą nieniutonowska, pseudoplastyczna i tiksotropowa - jej lepkość zależy od szybkosci scinania i historii przepływu.'
...
UPDATE public.questions
   SET text = 'Ciecz Newtonowska jest cieczą wzorcową, dla której krzywa płynięcia przedstawiona na wykresie zależności naprężenia ścinającego od szybkości ścinania jest',
       ...
       explanation = 'Ciecz newtonowska: krzywa plynięcia to linią prostą przechodzącą przez początek układu, nachyloną pod kątem rownym współczynnikowi lepkości. tau = eta * (dv/dy).'
...
UPDATE public.questions
   SET text = 'Graniczna liczba lepkościowa określa:',
       ...
       explanation = 'Graniczna liczba lepkościowa [eta] = lim(c->0) [eta_sp/c], gdzie eta_sp to lepkość wlasciwa. Charakteryzuje pojedyncza cząsteczkę polimeru w roztworze.'
...
UPDATE public.questions
   SET text = 'Wzrost lepkości krwi powoduje:',
       ...
       explanation = 'Lepkość krwi rosnie przy: wyzszym hematokrycie (wiecej komorek) i nizszej temperaturze (większa lepkość osocza). Odwrotne czynniki zmniejszaja lepkość.'
...
UPDATE public.questions
   SET text = 'Zaznacz prawidłowe stwierdzenie dotyczące lepkości krwi',
       ...
       explanation = 'Pełna krew jest nieniutonowską, tiksotropowa, jej lepkość zależy od hematokrytu i szybkości przepływu.'
...
UPDATE public.questions
   SET text = 'Zjawisko akumulacji osiowej krwinek wpływa na lepkość krwi i powoduje',
       ...
       explanation = 'Akumulacja osiowa (efekt Fahraeus-Lindqvist) zmniejsza pozorna lepkość krwi w malych naczyniach. Erytrocyty plyna w osi, przy scianach jest osocze o mniejszej lepkości.'
...
UPDATE public.questions
   SET text = 'Na załączonym wykresie przedstawiono',
       ...
       explanation = 'Histereza krzywej plynięcia jest typowa dla cieczy tiksotropowych jak krew. Krzywa przy wzroście i spadku szybkości scinania nie pokrywa się.'
...
UPDATE public.questions
   SET text = 'Do makroreologicznych czynników lepkościowych krwi należą',
       ...
       explanation = 'Makroreologiczne czynniki lepkosciowe krwi to: hematokryt, lepkość osocza, temperatura. Agregacja i odksztalcalnosc erytrocytów to czynniki mikroreologiczne.'
...
UPDATE public.questions
   SET text = 'Jakie zjawisko ma największy wpływ na lepkość krwi przy stałym hematokrycie i małych prędkościach ścinania?',
       ...
       explanation = 'Przy małych prędkościach ścinania dominuje agregacja erytrocytów - krwinki tworzą rulony (rouleaux), co znacznie zwiększa lepkość krwi.'
...
UPDATE public.questions
   SET text = 'W jaki sposób lepkość krwi zależy od temperatury?',
       ...
       explanation = 'Lepkość krwi zwiększa się z obniżeniem temperatury. Nizszа temperatura = wolniejsze ruchy czasteczek = większe tarcie wewnetrzne = większa lepkość.'
...
UPDATE public.questions
   SET text = 'Kulka zanurzona w cieczy zaczyna opadać. Siła działająca na tę kulkę, skierowana pionowo do góry to',
       ...
       explanation = 'Siła wyporu hydrostatycznego (Archimedesa) dziala pionowo do góry - przeciwnie do siły ciężkości. F_wyporu = rho_cieczy * V * g.'
...
UPDATE public.questions
   SET text = 'Lepkością nie jest',
       ...
       explanation = 'Lepkość to tarcie wewnętrzne cieczy, opór przy wzajemnym przesuwaniu warstw. Opór na granicy plyny-scianka to cos innego - to warunek brzegowy (brak poslizgu).'
...
UPDATE public.questions
   SET text = 'Od czego wprost zależy współczynnik lepkości dynamicznej dla cieczy newtonowskiej',
       ...
       explanation = 'Współczynnik lepkości dynamicznej cieczy newtonowskiej zależy od temperatury i rodzaju cieczy. Nie zależy od szybkosci scinania (definicja cieczy newtonowskiej).'
...
UPDATE public.questions
   SET text = 'Lepkość pozorna krwi jest funkcją:',
       ...
       explanation = 'Lepkość pozorna krwi jest funkcją malejąca szybkosci ścinania - im szybszy przepływ, tym mniejsza lepkość (rozpad agregatow, elongacja erytrocytow). To cecha cieczy pseudoplastycznej.'
...
UPDATE public.questions
   SET text = 'Na osiach krzywej naprężeniowo-odkształceniowej ciała stałego (przedstawionej poniżej) znajdują się odpowiednio (oś pionowa - oś pozioma)',
       ...
       explanation = 'Krzywa naprężeniowo-odksztalceniowa: os pionowa - naprężenie sigma (siła/pole), os pozioma - odkształcenie względne epsilon (delta_L/L). To standardowy wykres w mechanice materialow.'
...
UPDATE public.questions
   SET text = 'Elementami składowymi komórek mięśniowych są miofilamenty, których rozmiary są tego samego rzędu wielkości. Średnica miofilamentu cienkiego jest rzędu',
       ...
       explanation = 'Miofilamenty (aktyna, miozyna) mają rozmiary rzędu nanometrow. Filament gruby (miozyna): ok. 15 nm Średnica. Filament cienki (aktyna): ok. 7 nm Średnica.'
...
UPDATE public.questions
   SET text = 'Cząsteczka ATP, dostarczając energię do skurczu mięśnia, wiąże się z:',
       ...
       explanation = 'ATP wiąże się z glowka miozyny. Hydroliza ATP dostarcza energii do zmiany konformacji miozyny i wykonania "power stroke" - ruchu glowki wzgledem aktyny.'
 WHERE id = 'biofiz-c4-004';

UPDATE public.questions
   SET text = 'Zmiany wychylenia ($x$) ciała drgającego od czasu ($t$) dla ruchu drgającego tłumionego przedstawia równanie ($A$ - amplituda drgań, λ - współczynnik tłumienia, ω - częstość drgań): o',
       options = '[{"id":"a","text":"$x = A \\cdot \\exp(\\lambdat) \\cdot \\\\sin(\\omegat)$"},{"id":"b","text":"$x = A \\cdot \\exp(-\\omegat) \\cdot \\\\sin(\\lambdat)$"},{"id":"c","text":"$x = A \\cdot \\exp(-\\lambdat) \\cdot \\\\sin(\\omegat)$"},{"id":"d","text":"$x = A \\cdot \\\\lambda \\cdot \\\\sin(\\omegat)$"}]'::jsonb,
       explanation = 'Ruch drgajacy tlumiony: $x = A_{0} \cdot \exp(-\lambda \cdot t) \cdot \\sin(\omega \cdot t)$. Amplituda maleje wykładniczo w czasie (exp(-lambda*t)), drgania sa sinusoidalne.'
...
UPDATE public.questions
   SET text = 'Jony wapnia uwolnione po depolaryzacji błony komórkowej łączą się w obrębie miofilamentów z:',
       ...
       explanation = 'Jony Ca2+ łączą się z troponiną C. Powoduje to zmiane konformacji troponiny, przesunięcie tropomiozyny i odsloniecie miejsc wiazania miozyny na aktynie.'
 WHERE id = 'biofiz-c4-006';

UPDATE public.questions
   SET text = 'Z wykresu zależności prędkości skurczu mięśnia ($v$) od jego obciążenia ($F$) dla mięśni poprzecznie prążkowanych można wyciągnąć wniosek, że:',
       ...
       explanation = 'Krzywa Hilla: prędkość skurczu maleje ze wzrostem obciążenia. Przy zerowym obciążeniu prędkość maksymalna, przy maksymalnym obciążeniu (siła izometryczna) prędkość = 0.'
...
UPDATE public.questions
   SET text = 'Głównym składnikiem miofilamentu grubego są cząsteczki:',
       ...
       explanation = 'Miofilament gruby sklada się glownie z miozyny - ok. 300-400 czasteczek miozyny tworzacych bipolarny filament o długości ok. 1.6 mikrometra.'
...
UPDATE public.questions
   SET text = 'Mięśnie poprzecznie prążkowane są wydłużonymi komórkami o wymiarach:',
       ...
       explanation = 'Wlokna miesniowe poprzecznie prążkowane: średnica ok. 10-100 mikrometrow (0.01-0.1 mm), długość od milimetrow do kilku centymetrow.'
...
UPDATE public.questions
   SET text = 'W mięśniu po jego wydłużeniu z początkowej długości i pozostawieniu stałej długości mięśnia występuje zjawisko:',
       ...
       explanation = 'Relaksacja naprężenia: przy stałej długości (stalym odksztalceniu) naprezenie stopniowo maleje w czasie. Charakterystyczne dla materialow lepko-sprezystych.'
...
UPDATE public.questions
   SET text = 'W skład jednego miofilamentu grubego wchodzi około',
       ...
       explanation = 'Jeden filament gruby zawiera ok. 300-400 cząsteczek miozyny ulozonych bipolarnie - glowki miozyny wystaja na zewnatrz, tworzac mostki poprzeczne.'
...
UPDATE public.questions
   SET text = 'Okres drgań',
       ...
       explanation = 'Okres T = 1/f (odwrotność częstotliwości). Okres i częstotliwość sa odwrotnie proporcjonalne. W ruchu harmonicznym prostym okres jest stały.'
...
UPDATE public.questions
   SET text = 'Potencjał elektryczny na błonie komórki mięśnia poprzecznie prążkowanego wynosi około',
       ...
       explanation = 'Potencjał spoczynkowy komórki miesniowej wynosi ok. -60 do -90 mV (wnetrze ujemne wzgledem zewnetrza). Depolaryzacja do ok. +30 mV wyzwala skurcz.'
...
UPDATE public.questions
   SET text = 'Model Kelvina-Voigta służy do opisu:',
       ...
       explanation = 'Model Kelvina-Voigta: sprezyna i tlumik rownolegle. Opisuje ciala lepko-sprezysste o przewadze elementów sprężystych. Charakterystyczna jest opozniona odpowiedz na obciążenie.'
...
UPDATE public.questions
   SET text = 'Maksymalny zasięg, kiedy ciało po odjęciu działającej siły powraca do poprzedniego kształtu to:',
       ...
       explanation = 'Granica sprężystości: maksymalne naprezenie, przy ktorym material wraca do pierwotnego kształtu po odjęciu siły. Powyzej - trwale odksztalcenie plastyczne.'
...
UPDATE public.questions
   SET text = 'Jaka jest rola kompleksu troponin w funkcjonowaniu mięśni?',
       ...
       explanation = 'Troponina reguluje skurcz mięśni poprzecznie prazkowanych. Sklada się z 3 podjednostek: TnC (wiaze Ca2+), TnI (inhibitor), TnT (wiaze tropomiozyne).'
...
UPDATE public.questions
   SET text = 'Które z poniższych jonów odgrywa najważniejszą rolę regulacyjną w funkcjonowaniu mięśni?',
       ...
       explanation = 'Jony wapnia Ca2+ sa glownym regulatorem skurczu mięśni. Wzrost stężenia Ca2+ w cytoplazmie (z 0.1 do 10 mikroM) wyzwala skurcz przez wiazanie z troponina.'
...
UPDATE public.questions
   SET text = 'Liniowa wprost proporcjonalna zależność między naprężeniem wewnętrznym względnym wydłużeniem wynikającym z prawa Hooke’a nie jest spełniona:',
       ...
       explanation = 'Prawo Hookea (sigma = E * epsilon) obowiazuje w zakresie od zera do granicy proporcjonalności. Powyżej zależność jest nieliniowa.'
...
UPDATE public.questions
   SET text = 'Model Maxwella służy do opisu:',
       ...
       explanation = 'Model Maxwella: sprezyna i tlumik szeregowo. Opisuje ciala o przewadze elementów lepkich (ciecze lepko-sprezysте). Charakterystyczna jest relaksacja naprezenia.'
...
UPDATE public.questions
   SET text = 'Głównym składnikiem miofilamentu cienkiego jest:',
       ...
       explanation = 'Miofilament cienki sklada się glownie z aktyny (F-aktyna - filamentowa). Dodatkowo zawiera tropomiozyne i troponine jako bialka regulatorowe.'
...
UPDATE public.questions
   SET text = 'Wskaż błędne dopasowanie definicji do pojęcia',
       ...
       explanation = 'Wytrzymałość to zdolność materiału do przenoszenia obciążenia bez zniszczenia. Kruchość - pekanie bez odkształceń. Plastyczność - trwale odksztalcenie. Twardosc - Odporność na wciskanie.'
...
UPDATE public.questions
   SET text = 'Dopasuj podpis do rysunku',
       ...
       explanation = 'Drgania tłumione: amplituda maleje wykładniczo w czasie, krzywa wychylenia to sinusoida z malejaca amplituda (obwiednia wykladnicza).'
...
UPDATE public.questions
   SET text = 'Spoczynkowy potencjał wnętrza komórki w stosunku do jej powierzchni wynosi?',
       ...
       explanation = 'Potencjał spoczynkowy komórki wynosi ok. -60 do -90 mV (wnetrze ujemne). Powstaje dzieki roznej przepuszczalnosci blony dla jonow K+ i Na+ oraz pompy sodowo-potasowej.'
...
UPDATE public.questions
   SET text = 'Prawo Hilla głosi że',
       ...
       explanation = 'Prawo Hilla: prędkość skurczu jest maksymalna gdy mięsień nie jest obciążony (F=0). Ze wzrostem obciążenia prędkość maleje nieliniowo do zera przy sile izometrycznej.'
...
UPDATE public.questions
   SET text = 'Reologiczny model Maxwella opisuje',
       ...
       explanation = 'Model Maxwella opisuje zachowanie mięśni gładkich podczas rozciągania - wykazuja one relaksacje naprezenia (naprezenie maleje przy stalym odksztalceniu).'
...
UPDATE public.questions
   SET text = 'Jak nazywa się wzrost amplitud drgań układu przy charakterystycznych częstotliwościach wzbudzających?',
       ...
       explanation = 'Rezonans to gwaltowny wzrost amplitudy drgań gdy częstotliwość wymuszenia jest bliska częstotliwości wlasnej układu. Moze prowadzic do zniszczenia konstrukcji.'
...
UPDATE public.questions
   SET text = 'Kiedy wahadło jest w równowadze, to jego energia kinetyczna jest:',
       ...
       explanation = 'W polozeniu rownowagi (najnizszy punkt) wahadło ma maksymalna prędkość, wiec maksymalna energie kinetyczna. Energia potencjalna jest minimalna (zero przy wyborze tego poziomu odniesienia).'
...
UPDATE public.questions
   SET text = 'Jak nazywa się prawo, któremu podlega wiele materiałów poddanych obciążeniom, o ile obciążenie nie przekracza granicy sprężystości materiału',
       ...
       explanation = 'Prawo Hookea: $\sigma = E \cdot \epsilon (naprezenie proporcjonalne do odksztalcenia)$. Obowiazuje dla malych odksztalcen w zakresie sprezystym. E to modul Younga.'
...
UPDATE public.questions
   SET text = 'Nazwa parametru związanego z ruchem harmonicznym, mierzona w radianach na sekundę, to',
       ...
       explanation = 'Częstość kątowa (pulsacja) omega = 2*pi*f, mierzona w rad/s. Opisuje szybkosc zmian fazy w ruchu harmonicznym. Amplituda mierzona w metrach, prędkość w m/s.'
...
UPDATE public.questions
   SET text = 'Które stwierdzenie najlepiej opisuje pierwszą zasadę termodynamiki?',
       ...
       explanation = '**I zasada termodynamiki** (zachowanie energii): $\Delta U = Q + W$, gdzie $\Delta U$ to zmiana energii wewnętrznej, Q – ciepło **dostarczone** do układu, W – pracą **wykonaną nad** układem (przyjmując tę konwencję znaków). Energia nie ginie ani nie powstaje, jedynie zmienia formę (ciepło ↔ pracą). Opcja C pomija pracę, a D zaprzecza możliwości zmiany energii wewnętrznej. $\Delta U = Q + W$ (ciepło i pracą jako formy przekazu energii).'
...
UPDATE public.questions
   SET text = 'Efektywny równoważnik dawki (dawka skuteczna) wyraża się wzorem indeks T oznacza określoną tkankę lub narząd, symbol w oznacza współczynnik wagowy związany z T prawdopodobieństwem wystąpienia skutków napromieniowania tkanki T, natomiast H oznacza: T',
       ...
       explanation = 'Efektywny równoważnik dawki (dawka skuteczna) E = suma(w_T * H_T), gdzie H_T to równoważnik dawki pochłoniętej w tkance T, a w_T to współczynnik wagowy tkanki.'
...
UPDATE public.questions
   SET text = 'Jednostką efektywnego równoważnika dawki (dawki skutecznej) jest',
       ...
       explanation = 'Dawka skuteczna (efektywny rownowaznik dawki) mierzona jest w siwertach (Sv). Uwzględnia rozny wpływ biologiczny różnych rodzajow promieniowania i czulosc tkanek.'
...
UPDATE public.questions
   SET text = 'Wykres przedstawia zależność liczby jąder izotopu promieniotwórczego N od czasu t, zgodną z prawem rozpadu promieniotwórczego. Ile wynosi N ? x',
       options = '[{"id":"a","text":"$N = \\dfrac{N}{12} x$"},{"id":"b","text":"$N = \\dfrac{N}{8} x$"},{"id":"c","text":"$N = \\dfrac{N}{4} x$"},{"id":"d","text":"$N = \\dfrac{N}{16} x$"}]'::jsonb,
       explanation = 'Po 4 okresach polowicznego rozpadu pozostaje 1/16 poczatkowej liczby jąder: $N = N_{0} \cdot (\dfrac{1}{2})^4 = \dfrac{N_{0}}{16}$. Każdy okres polowica liczbe jąder.'
...
UPDATE public.questions
   SET text = 'Zależność liczby jąder izotopu promieniotwórczego N od czasu , zgodną z prawem rozpadu promieniotwórczego przedstawia wykres:',
       ...
       explanation = 'Prawo rozpadu promieniotwórczego: $N(t) = N_{0} \cdot e^{-\lambda \cdot t}. Krzywa wyk$ładniczo malejaca, gdzie lambda to stała rozpadu.'
...
UPDATE public.questions
   SET text = 'Prawo rozpadu promieniotwórczego tj. zależność liczby jąder izotopu promieniotwórczego N od czasu t przedstawia wzór ($λ$ - stała rozpadu)',
       options = '[{"id":"a","text":"$N(t) = N_{0} e^{-\\lambda t}$"},{"id":"b","text":"$N(t) = N_{0} e^{\\lambda t}$"},{"id":"c","text":"$dN(t) = \\\\lambda N(t) dt$"},{"id":"d","text":"$dN(t) = \\\\lambda N(t) / dt$"}]'::jsonb,
       explanation = 'Prawo rozpadu: $N(t) = N_{0} \cdot e^{-\lambda \cdot t}$, gdzie lambda to stała rozpadu. Liczba jąder maleje wykładniczo w czasie. Równanie różniczkowe: $dN = -\lambda \cdot N \cdot dt$.'
...
UPDATE public.questions
   SET text = 'W oddziaływaniu promieniowania γ z materią NIE zachodzi zjawisko',
       ...
       explanation = 'Promieniowanie gamma oddzialuje z materią przez: efekt fotoelektryczny, efekt Comptona, kreacje par. Zjawisko tunelowe występuje przy rozpadzie alfa, nie przy oddziaływaniu gamma.'
 WHERE id = 'biofiz-s1-009';

UPDATE public.questions
   SET text = 'Przemianą jądrowa polegająca na emisji cząstki helu z jądra atomu nazywana jest',
       ...
       explanation = 'Przemianą alfa: jadro emituje czastke alfa (jadro helu: 2 protony + 2 neutrony). Liczba masowa A maleje o 4, liczba atomowa Z o 2. Typowa dla ciezkich jader.'
...
UPDATE public.questions
   SET text = 'Stała rozpadu to',
       ...
       explanation = 'Stała rozpadu lambda to prawdopodobienstwo rozpadu pojedynczego jądra w jednostce czasu. Zwiazana z czasem polowicznego rozpadu: T_1/2 = ln(2)/lambda.'
...
UPDATE public.questions
   SET text = 'Miarą pochłaniania promieniowania jonizującego jest:',
       ...
       explanation = 'Dawka pochłonieta (Gy) mierzy energie promieniowania zaabsorbowana przez jednostke masy tkanki. To podstawowa Miarą fizyczna pochłaniania promieniowania.'
...
UPDATE public.questions
   SET text = 'Składnikiem jądra atomowego nie są:',
       ...
       explanation = 'Jadro atomowe sklada się z nukleonow: protonow i neutronow. Pozytony (antyelektrony) nie sa Składnikiem jądra - powstają przy rozpadzie beta plus.'
...
UPDATE public.questions
   SET text = 'Promień R jądra o liczbie masowej A wynosi w przybliżeniu: (cbrt to pierwiastek sześcienny -> cbrt8 = 2)',
       options = '[{"id":"a","text":"$R = 1,4 · cbrtA · 10^−12 m$"},{"id":"b","text":"$R = 1,4 · cbrtA · 10^−15 m$"},{"id":"c","text":"$R = 1,4 · A · 10^−15 m$"},{"id":"d","text":"$R = 1,4 · A · 10 m$"}]'::jsonb,
       explanation = 'Promień jądra: $R = r_{0} \cdot A^(\dfrac{1}{3})$, gdzie r_0 ≈ 1.2-1.4 fm (femtometry = $10^{-15}$ m). Objetosc jądra jest proporcjonalna do liczby nukleonow A.'
...
UPDATE public.questions
   SET text = 'Wyrażenie h/m c, związane z jednym ze zjawisk opisujących współdziałanie promieniowania elektromagnetycznego z materią nosi nazwę',
       ...
       explanation = 'Wyrażenie h/(m_e*c) = lambda_C to comptonowska długość fali elektronu (ok. 2.43 pm). Charakteryzuje efekt Comptona - rozpraszanie fotonow na elektronach.'
...
UPDATE public.questions
   SET text = 'Od czego zależy natężenie promieniowania rentgenowskiego?',
       ...
       explanation = 'Natężenie promieniowania RTG jest proporcjonalne do kwadratu napięcia anodowego (U^2) i do natężenia prądu (I). Wyzsze napięcie = wiecej fotonow o wiekszej energii.'
...
UPDATE public.questions
   SET text = 'W którym z wymienionych zjawisk, atom pozbawiony elektronu staje się jonem dodatnim, zderza się z sąsiednimi atomami jonizując je?',
       ...
       explanation = 'LET (liniowe przeniesienie energii) opisuje energie traconą przez czastke jonizujaca na jednostke drogi. Atom tracacy elektron staje się jonem i zderzenia z sasiadami to jonizacja.'
 WHERE id = 'biofiz-s1-017';

UPDATE public.questions
   SET text = 'Efekt tunelowy towarzyszy jednemu z rozpadów promieniotwórczych, któremu?',
       options = '[{"id":"a","text":"β-"},{"id":"b","text":"γ"},{"id":"c","text":"α"},{"id":"d","text":"$\\\\beta+$"}]'::jsonb,
       explanation = 'Efekt tunelowy jest kluczowy przy rozpadzie alfa - cząstka alfa "tuneluje" przez bariere potencjalu coulombowskiego, mimo ze klasycznie nie ma wystarczajacej energii.'
 WHERE id = 'biofiz-s1-018';

UPDATE public.questions
   SET text = 'Pozytony są emitowane podczas przemiany',
       options = '[{"id":"a","text":"$\\\\beta+$"},{"id":"b","text":"α"},{"id":"c","text":"γ"},{"id":"d","text":"β-"}]'::jsonb,
       explanation = 'Przemiana beta plus (β+): proton zamienia się w neutron z emisja pozytonu (e+) i neutrina elektronowego. Zachodzi w jadrach z nadmiarem protonow.'
...
UPDATE public.questions
   SET text = 'Efektem trzech przemian α oraz dwóch przemian β, jakim ulega jądro o liczbie A-238, Z-92 jest powstanie jądra',
       ...
       explanation = '3 przemiany alfa: A zmniejsza się o 3*4=12, Z o 3*2= 6. 2 przemiany beta: Z zwieksza się o 2. Wynik: $A = 238-12 = 226$, Z=92-6+2=88 (rad-226).'
...
UPDATE public.questions
   SET text = 'Czas połowicznego rozpadu pewnego pierwiastka wynosi 4 dni. W ciągu 12 dni z 20 g tego pierwiastka rozpadnie się',
       ...
       explanation = '12 dni = 3 okresy połowicznego rozpadu (T_1/2=4 dni). Po 3 okresach zostaje: 20g * (1/2)^3 = 2.5g. Rozpadlo się: 20 - 2.5 = 17.5g.'
...
UPDATE public.questions
   SET text = 'Stabilność jądra atomowego jest charakteryzowana przez',
       ...
       explanation = 'Stabilność jądra najlepiej charakteryzuje energia wiązania przypadającą na nukleon. Maksymalna (ok. 8.8 MeV) dla pierwiastkow srednich (zelazo). Zbyt male lub duze jądra sa mniej stabilne.'
...
UPDATE public.questions
   SET text = 'Od czego zależy długość fali promieniowania rentgenowskiego?',
       ...
       explanation = 'Minimalna długość fali RTG: $lambda_{min} = \dfrac{hc}{eU}$. Jest odwrotnie proporcjonalna do napięcia anodowego - wyzsze napięcie daje krótsza (bardziej energetyczna) fale.'
...
UPDATE public.questions
   SET text = 'Jak nazywa się detektor promieniowania jądrowego, który opiera się na zdolności skraplania przesyconej pary wodnej na zarodnikach kondensacji, powstających wzdłuż toru cząstki α lub β?',
       ...
       explanation = 'Komora Wilsona: przesycona para wodna skapla się na jonach utworzonych przez promieniowanie, tworząc widoczne ślady cząstek. Historycznie wazna w fizyce jadra.'
...
UPDATE public.questions
   SET text = 'Jądra atomowe o tej samej liczbie A, różniące się liczbą Z to',
       ...
       explanation = 'Izobary: Jądra o tej samej liczbie masowej A, ale roznej liczbie atomowej Z (np. C-14 i N-14). Izotopy mają ta sama Z, izotony ta sama liczbe neutronow.'
...
UPDATE public.questions
   SET text = 'Jedna z cząstek elementarnych mając energię większą od 1,022 MeV może w polu jądra atomowego wyzwolić parę elektron-pozyton. Tą cząstką elementarną jest',
       ...
       explanation = 'Foton (kwant gamma) o energii >= 1.022 MeV może w polu jądra utworzyc parę elektron-pozyton. To kreacja par - zamiana energii promieniowania na mase cząstek.'
...
UPDATE public.questions
   SET text = 'Efekt Tyndalla',
       ...
       explanation = 'Efekt Tyndalla to rozpraszanie światła przez cząstki koloidalne - widoczne jako stożek światła przechodzacy przez koloid. Rozmiar cząstek 1 nm - 1 mikrometr.'
...
UPDATE public.questions
   SET text = 'Konwencjonalna technika rentgenowska',
       ...
       explanation = 'Konwencjonalne RTG obrazuje struktury o roznym pochłanianiu - widać te, które pochłaniają więcej (kosci) lub mniej (płuca) niż otoczenie. Brak kontrastu = brak obrazu.'
...
UPDATE public.questions
   SET text = 'Wirowanie preparatywne to',
       ...
       explanation = 'Wirowanie preparatywne obejmuje sedymentacje prosta i wirowanie równowagowe izopiknotyczne (w gradiencie gęstości). Wirowanie analityczne to oddzielna kategoria.'
...
UPDATE public.questions
   SET text = 'Widma ramanowskie obserwuje się',
       ...
       explanation = 'Widma Ramana obserwuje się w świetle widzialnym. Dają informacje o poziomach oscylacyjno-rotacyjnych (podobnie jak IR), ale mechanizm jest inny (nieelastyczne rozpraszanie).'
...
UPDATE public.questions
   SET text = 'W metodach opartych na wirowaniu podstawą metody jest',
       ...
       explanation = 'W wirowaniu podstawą jest różna wielkość i kształt cząsteczek - większe/ciezsze cząstki sedymentuja szybciej. Stała sedymentacji zależy od masy, ksztaltu i gęstości.'
...
UPDATE public.questions
   SET text = 'Rozproszenie Rayleigha',
       ...
       explanation = 'Rozpraszanie Rayleigha to elastyczne rozpraszanie fal EM na czasteczkach mniejszych od długości fali. Intensywnosc proporcjonalna do 1/lambda^4 (dlatego niebo jest niebieskie).'
...
UPDATE public.questions
   SET text = 'Elektroforeza to',
       ...
       explanation = 'Elektroforeza rozdziela mieszanine na frakcje na podstawie ruchu czasteczek naladowanych w polu elektrycznym. Rozna ruchliwosc (zależna od ładunku i rozmiaru) = różne frakcje.'
...
UPDATE public.questions
   SET text = 'Różna wielkość i kształt cząsteczek jest podstawą metody',
       ...
       explanation = 'Chromatografia zelowa (sitowa) rozdziela cząstki na podstawie wielkości. Małe cząstki wnikaja w pory zelu i eleuują pozniej, duze omijają pory i eleuują szybciej.'
...
UPDATE public.questions
   SET text = 'W chromatografii rozdzielczej podstawą metody jest',
       ...
       explanation = 'Chromatografia rozdzielcza (podziałowa) opiera się na roznej rozpuszczalnosci substancji w fazie stacjonarnej i ruchomej. Substancje bardziej rozpuszczalne w fazie ruchomej eleuują szybciej.'
...
UPDATE public.questions
   SET text = 'Detektory (w liczbie kilkuset) zostały umieszczone na łuku pierścienia, obracającego się razem z lampą dookoła pacjenta w',
       ...
       explanation = 'III generacja CT: lampą i detektory na łuku (kilkuset detektorów) obracają się razem wokol pacjenta. Wiazka wachlarzowa, czas ok. 1-2 s na obrót.'
...
UPDATE public.questions
   SET text = 'Znajomość stałej sedymentacji umożliwia',
       ...
       explanation = 'Znajomość stałej sedymentacji ( s) pozwala obliczyc mase czasteczkowa ( M) z równania Svedberga: $s = M\dfrac{1-v \cdot \rho}{N \cdot f}$, gdzie f to współczynnik tarcia.'
...
UPDATE public.questions
   SET text = 'Współczynnik dyfuzji D zależy',
       ...
       explanation = 'Współczynnik dyfuzji D = kT/(6*pi*eta*r) (równanie Stokesa-Einsteina). Zależy od stałej Boltzmanna k, temperatury T, lepkości eta i promienia cząstki r.'
...
UPDATE public.questions
   SET text = 'Interferencja fal wiązki promieniowania rozproszonego zachodzi kiedy spełniony jest między innymi warunek',
       ...
       explanation = 'Interferencja fal rozproszonych wymaga spójności promieniowania - fale musza miec stała roznice faz. Warunek Bragga okresla katy konstruktywnej interferencji.'
...
UPDATE public.questions
   SET text = 'W tomografii spiralnej',
       ...
       explanation = 'Tomografia spiralna (helikalna): lampa i detektory obracają się, jednoczesnie stol z pacjentem przesuwa się - tor skanowania ma ksztalt spirali.'
 WHERE id = 'biofiz-s2-014';

UPDATE public.questions
   SET text = 'W elektroforezie stosuje się natężenie pola',
       options = '[{"id":"a","text":"$10 \\dfrac{V}{m} lub 100 \\dfrac{V}{m}$"},{"id":"b","text":"$10 \\dfrac{mV}{m} lub 100 \\dfrac{mV}{m}$"},{"id":"c","text":"$10 \\dfrac{V}{m2} lub 100 \\dfrac{V}{m2}$"}]'::jsonb,
       explanation = 'W elektroforezie stosuje się pole elektryczne ok. 1-20 V/cm (10-200 V/m). Zbyt silne pole powoduje nagrzewanie i denaturacje bialek.'
...
UPDATE public.questions
   SET text = 'Układ termodynamiczny nazywamy izolowanym gdy',
       ...
       explanation = 'Układ izolowany nie wymienia z otoczeniem ani energii, ani materii. Energia wewnetrzna i masa sa stałe. Entropia może tylko rosnac (II zasada termodynamiki).'
...
UPDATE public.questions
   SET text = 'Funkcje stanu',
       ...
       explanation = 'Funkcje stanu (U, H, S, G, F) zaleza tylko od stanu ukladu, nie od drogi przemiany. Ich zmiana między dwoma stanami jest taka sama niezależnie od sposobu przejscia.'
 WHERE id = 'biofiz-s2-017';

UPDATE public.questions
   SET text = 'Entalpia H jest funkcją stanu w postaci (gdzie: U - energia wewnętrzna, p - ciśnienie, V - objętość)',
       options = '[{"id":"a","text":"$H = U - pV$"},{"id":"b","text":"$H = U + \\dfrac{p}{V}$"},{"id":"c","text":"$H = U - \\dfrac{p}{V}$"},{"id":"d","text":"$H = U + pV$"}]'::jsonb,
       explanation = 'Entalpia H = U + pV (energia wewnętrzna plus iloczyn ciśnienia i objetosci). Reprezentuje calkowita energie cieplna ukladu przy stalym cisnieniu.'
...
UPDATE public.questions
   SET text = 'Statystyczną interpretację pojęcia entropii wyraża wzór (gdzie: k - stała Boltzmanna, W - liczba mikrostanów)',
       options = '[{"id":"a","text":"$S = k ∙ lnW$"},{"id":"b","text":"$S = \\dfrac{k}{lnW}$"},{"id":"c","text":"$S = \\dfrac{1}{k} ∙ lnW$"},{"id":"d","text":"$S = k ∙ \\ln(\\dfrac{1}{W})$"}]'::jsonb,
       explanation = 'Wzór Boltzmanna: $S = k \cdot \ln(W)$, gdzie k to stała Boltzmanna, W to liczba mikrostanów (prawdopodobienstwo termodynamiczne). Większy nieurzadkowanie = wiecej mikrostanów = większa entropia.'
...
UPDATE public.questions
   SET text = 'Potencjał chemiczny składnika i w mieszaninie gazów, względnie w roztworze doskonałym, wyraża się wzorem (gdzie: μo- potencjał chemiczny składnika i w stanie czystym (x=1), w temperaturze T i przy i i ciśnieniu p)',
       options = '[{"id":"a","text":"$\\\\mu = \\muo + RT · \\ln( \\times ) i i i$"},{"id":"b","text":"$\\\\mu = \\muo + \\dfrac{1}{RT} \\ln( \\times ) i i i$"},{"id":"c","text":"$\\\\mu = \\muo + \\dfrac{RT}{\\ln}( \\times ) i i i$"},{"id":"d","text":"$\\\\mu = \\muo + RT · \\ln( \\dfrac{1}{x} ) i i i$"}]'::jsonb,
       explanation = 'Potencjał chemiczny: $mu_{i} = mu_{i}^{0} + RT \cdot \ln(x_{i})$, gdzie x_i to ulamek molowy. Okresla "skłonnosc" substancji do reakcji chemicznych lub transportu.'
 WHERE id = 'biofiz-s2-020';

UPDATE public.questions
   SET text = 'Przepuszczalność błony dla danej substancji (jeżeli stężenie jest w mol/m3) jest wyrażona w',
       options = '[{"id":"a","text":"$\\dfrac{m}{s2}$"},{"id":"b","text":"$\\dfrac{m3}{s}$"},{"id":"c","text":"$\\dfrac{m2}{s}$"},{"id":"d","text":"$\\dfrac{m}{s}$"}]'::jsonb,
       explanation = 'Przepuszczalność błony P ma jednostke m/s (długość/czas). Strumien J = P*(c1-c2), gdzie c w mol/m^3, wiec J w mol/(m^2*s), P = J/delta_c w m/s.'
...
UPDATE public.questions
   SET text = 'Ciśnienie osmotyczne π',
       ...
       explanation = 'Ciśnienie osmotyczne pi = cRT (równanie vant Hoffa). Proporcjonalne do stężenia molowego c i temperatury T. Nie zależy od rodzaju substancji rozpuszczonej (wlasnosc koligatywna).'
...
UPDATE public.questions
   SET text = 'W stanie stacjonarnym',
       ...
       explanation = 'Stan stacjonarny: funkcje termodynamiczne (T, p, stężenia) sa stale w czasie, mimo ze przez uklad przeplywaja strumienie energii i materii. Rozny od rownowagi termodynamicznej.'
...
UPDATE public.questions
   SET text = 'Błona komórkowa',
       ...
       explanation = 'Błona komórkowa zbudowana jest głównie z lipidow (fosfolipidy, cholesterol) i białek. Model mozaikowy Singera-Nicolsona: podwojna warstwa lipidowa z zanurzonymi bialkami.'
...
UPDATE public.questions
   SET text = 'Transport aktywny przez błony odbywa się',
       ...
       explanation = 'Transport aktywny odbywa się wbrew gradientowi (elektrochemicznemu, stezeniowemu) z nakładem energii (ATP). Przyklady: pompa Na/K-ATPaza, pompy jonowe.'
...
UPDATE public.questions
   SET text = 'Entalpia swobodna substancji w stanie czystym zależy od:',
       ...
       explanation = 'Entalpia swobodna substancji czystej zależy od temperatury i ciśnienia: $G = G(T$,p). Dla mieszanin dodatkowo zależy od skladu (stężeń).'
...
UPDATE public.questions
   SET text = 'Chaotyczne ruchy cząsteczek powodujące przypadkowe odchylenia dowolnej wielkości fizycznej od jej wartości średniej to',
       ...
       explanation = 'Fluktuacje to przypadkowe odchylenia wielkości fizycznych od wartości średniej wywolane chaotycznymi ruchami cząsteczek. Amplituda fluktuacji maleje ze wzrostem liczby cząstek.'
...
UPDATE public.questions
   SET text = 'U człowieka stan, w którym ciepło oddawane do otoczenia nie jest w stanie zbilansować ciepła wytwarzanego w organizmie to',
       ...
       explanation = 'Hipertermia: produkcja ciepła przewyzsza oddawanie, temperatura ciala rosnie niekontrolowanie. Rozna od goraczki (kontrolowana przez ośrodek termoregulacji).'
...
UPDATE public.questions
   SET text = 'Przewodnictwo elektryczne G całej błony komórkowej jest',
       ...
       explanation = 'Przewodnictwo błony G = n*g, gdzie n to liczba kanałów, g to przewodnictwo pojedynczego kanału. G jest wprost proporcjonalne do liczby kanałów, a odwrotnie proporcjonalne do oporu pojedynczego kanału.'
...
UPDATE public.questions
   SET text = 'Jeśli nad układem została wykonana praca i układ oddał ciepło to',
       ...
       explanation = 'Praca wykonana NAD układem: W> 0. Układ ODDAŁ ciepło: Q< 0. Zmiana energii wewnetrznej: $dU = Q + W$, wiec znak dU zależy od wartości Q i W.'
...
UPDATE public.questions
   SET text = 'Zaznacz odpowiedź, w której wszystkie wymienione wielkości są funkcjami stanu',
       ...
       explanation = 'Funkcje stanu: H (entalpia), S (entropia), U (energia wewnętrzna), G (entalpia swobodna), F (energia swobodna). Ciśnienie i temperatura to parametry stanu.'
...
UPDATE public.questions
   SET text = 'Jak nazywa się zjawisko unoszenia ciepła za pośrednictwem poruszającej się substancji?',
       ...
       explanation = 'Konwekcja to unoszenie ciepła przez poruszajaca się materie (gaz, ciecz). Przewodzenie - przez zderzenia czasteczek, promieniowanie - przez fale EM.'
...
UPDATE public.questions
   SET text = 'W krzywej przebiegu potencjału czynnościowego można wyróżnić kilka faz. Faza, w czasie której potencjał rośnie do wartości około 30-35 mV to:',
       ...
       explanation = 'Faza depolaryzacji: potencjał blonowy szybko rośnie od ok. -70 mV do ok. +30 mV wskutek otwarcia kanalow Na+ i naplywu jonow sodu do komórki.'
...
UPDATE public.questions
   SET text = 'W układzie otwartym, w stanie równowagi szybkość tworzenia się entropii jest',
       ...
       explanation = 'W stanie równowagi termodynamicznej szybkość tworzenia entropii wynosi zero (dS/dt = 0). W stanie stacjonarnym jest stała, ale różną od zera.'
...
UPDATE public.questions
   SET text = 'W naczyniu zamkniętym mamy parę nasyconą, ale na dnie nie ma już cieczy. Wzrost temperatury tej pary',
       options = '[{"id":"a","text":"spowoduje wzrost ciśnienia, ale Parą nie będzie już parą nasyconą"},{"id":"b","text":"nie spowoduje wzrostu jej ciśnienia"},{"id":"c","text":"spowoduje wzrost jej ciśnienia i w dalszym ciągu będzie to Parą nasyconą"}]'::jsonb,
       explanation = 'Parą nasyconą jest w rownowadze z ciecza. Bez cieczy po podgrzaniu ciśnienie wzrosnie, ale parą nie będzie juz nasyconą - stanie się parą przegrzana.'
...
UPDATE public.questions
   SET text = 'Wielkość fizyczna, która wyraża liczbowo pracę wykonaną podczas zmiany liczby moli składnika roztworu o jeden, przy zachowaniu stałości temperatury, ciśnienia oraz ilości innych składników wchodzących w skład układu to',
       ...
       explanation = 'Potencjał chemiczny mu = (dG/dn)_T,p - zmiana entalpii swobodnej przy zmianie liczby moli składnika. Ma jednostke J/mol.'
...
UPDATE public.questions
   SET text = 'W układzie izolowanym, w którym zachodzi proces nieodwracalny entropia',
       ...
       explanation = 'W układzie izolowanym entropia rośnie podczas procesow nieodwracalnych (II zasada). Osiąga maksimum w stanie równowagi termodynamicznej.'
...
UPDATE public.questions
   SET text = 'Zgodnie z drugą zasadą termodynamiki',
       ...
       explanation = 'II zasadą: ciepło samoistnie przeplywla tylko od ciala cieplejszego do zimniejszego. Lodówka wymaga pracy, sprawność silnika cieplnego < 100%.'
...
UPDATE public.questions
   SET text = 'Która z przedstawionych wielkości fizycznych nie jest funkcją stanu?',
       ...
       explanation = 'Praca i cieplo NIE sa funkcjami stanu - zaleza od drogi przemiany. Energia wewnętrzna, entalpia, entropia, entalpia swobodna, potencjał chemiczny - sa funkcjami stanu.'
...
UPDATE public.questions
   SET text = 'Konwekcja to',
       ...
       explanation = 'Konwekcja to wymiana ciepła przez ruch masy plynów (gazu lub cieczy). Moze byc naturalna (wywolana roznicą gęstość) lub wymuszona (wentylator, pompa).'
...
UPDATE public.questions
   SET text = 'Funkcjami stanu termodynamicznego są',
       ...
       explanation = 'Funkcje stanu: U (energia wew.), H (entalpia), G (entalpia swobodna), F (energia swobodna), S (entropia), mu (potencjał chemiczny). Praca i ciepło - nie.'
...
UPDATE public.questions
   SET text = 'Entropia',
       ...
       explanation = 'Entropia S = k*ln(W) - jest wprost proporcjonalna do logarytmu prawdopodobieństwa termodynamicznego W. Rosnie w procesach nieodwracalnych. Jest funkcją stanu.'
...
UPDATE public.questions
   SET text = 'Któremu z poniższych procesów towarzyszy zmniejszenie entropii układu?',
       ...
       explanation = 'Zamrożenie zmniejsza entropie - cząsteczki przechodza z nieurzadkowanego stanu cieklego do uporzadkowanego stanu stalego. Parowanie, rozpuszczanie, rozprężanie - zwiekszaja S.'
...
UPDATE public.questions
   SET text = 'Współczynnik dyfuzji nie jest',
       ...
       explanation = 'Współczynnik dyfuzji D ROSNIE ze wzrostem temperatury (większe ruchy termiczne). Zależy od wielkości i kształtu cząsteczek, jest współczynnikiem w prawie Ficka.'
...
UPDATE public.questions
   SET text = 'Klasyczna termodynamika nie jest w stanie opisać',
       ...
       explanation = 'Termodynamika klasyczna opisuje stany równowagi i ich zmiany, ale nie przebieg procesów w czasie (kinetyka). Do opisu procesów potrzebna jest termodynamika nierownowagowa.'
...
UPDATE public.questions
   SET text = 'Strumień dyfuzji przez błonę zależy od',
       ...
       explanation = 'Strumień dyfuzji J = P*S*delta_c, gdzie P to przepuszczalnosc, S to powierzchnia, delta_c to roznica stężeń. Zależy od przepuszczalności i różnicy stężeń.'
...
UPDATE public.questions
   SET text = 'Zgodnie z drugą zasadą termodynamiki podczas dowolnego procesu całkowita entropia wszechświata',
       ...
       explanation = 'II zasadą: całkowita entropia wszechświata (uklad + otoczenie) wzrasta lub pozostaje stała. W procesach odwracalnych dS_total = 0, w nieodwracalnych dS_total > 0.'
...
UPDATE public.questions
   SET text = 'Układ termodynamiczny można uznać za układ otwarty',
       ...
       explanation = 'Układ otwarty wymienia z otoczeniem zarowno energie jak i materię. Układ zamkniety wymienia tylko energie. Układ izolowany nie wymienia niczego.'
 WHERE id = 'biofiz-s2-049';

UPDATE public.questions
   SET text = 'Zgodnie z uogólnioną drugą zasadą termodynamiki na przyrost entropii dS układu składa się',
       options = '[{"id":"a","text":"$przyrost dSE = \\dfrac{dQe}{T} wynikajacy z dodania ciepła w ilosci dQe z otoczenia do układu oraz przyrost dSi = \\dfrac{dQi}{T} bedacy wynikiem procesow odwracalnych$"},{"id":"b","text":"$przyrost dSE = \\dfrac{dQe}{T} wynikajacy z dodania ciepła w ilosci dQe z układu do otoczenia oraz przyrost dSi = \\dfrac{dQi}{T} bedacy wynikiem procesow nieodwracalnych$"},{"id":"c","text":"$przyrost dSE = \\dfrac{dQe}{T} bedacy wynikiem procesow nieodwracalnych dQe oraz przyrost dSi = \\dfrac{dQi}{T} wynikajacy z dodanie ciepła procesow nieodwracalnych$"},{"id":"d","text":"$przyrost dSE = \\dfrac{dQe}{T} wynikajacy z dodania ciepła w ilosci dQe z otoczenia do układu oraz przyrost dSi = \\dfrac{dQi}{T} bedacy wynikiem procesow nieodwracalnych$"}]'::jsonb,
       explanation = 'Przyrost entropii: $dS = dS_{e} + dS_{i}$, gdzie dS_e = dQ_e/T (wymiana z otoczeniem), dS_i ≥ 0 (produkcja wewnętrzna przez NIEODWRACALNE procesy). Procesy odwracalne: $dS_{i} = 0$. Rzeczywiste procesy zawsze mają dS_i > 0.'
...
UPDATE public.questions
   SET text = 'Jakim typem układu termodynamicznego jest żywy organizm?',
       ...
       explanation = 'Żywy organizm to uklad otwarty - wymienia z otoczeniem zarowno energie (cieplo, praca) jak i materie (pokarm, tlen, CO2, metabolity). Utrzymuje stan stacjonarny.'
...
UPDATE public.questions
   SET text = 'Które z poniższych stwierdzeń dotyczy procesów odwracalnych?',
       ...
       explanation = 'W procesach odwracalnych praca wykonana PRZEZ układ jest maksymalna (lub praca wykonana NAD układem jest minimalna). Proces przebiega przez stany rownowagowe.'
...
UPDATE public.questions
   SET text = 'Współczynnik dyfuzji:',
       ...
       explanation = 'Współczynnik dyfuzji D zależy od: temperatury, rodzaju substancji rozpuszczonej, rozpuszczalnika, lepkości ośrodka. D = kT/(6*pi*eta*r) - równanie Stokesa-Einsteina.'
...
UPDATE public.questions
   SET text = 'Przy obniżeniu temperatury ciała o masie 75kg o temperaturę 2K ciepło tracone do otoczenia wynosi',
       ...
       explanation = 'Q = m*c*delta_T. Dla ciała ludzkiego c ≈ 3.5 kJ/(kg*K). Q = 75 kg * 3.5 kJ/(kg*K) * 2 K = 525 kJ. Uwaga: ciepło wlasciwe ciała rozni się od wody.'
...
UPDATE public.questions
   SET text = 'Zgodnie z pierwszą zasadą termodynamiki (ΔU=Q+W) zmiana energii wewnętrznej układu jest równa sumie pracy i',
       ...
       explanation = 'I zasadą: $dU = Q + W$. Q to cieplo DODANE do układu (konwencja Gibbs-Helmholtza). Jesli cieplo jest oddawane, Q < 0.'
...
UPDATE public.questions
   SET text = 'Zgodnie z 1 zasadą termodynamiki zmiana energii wewnętrznej układu jest równa',
       ...
       explanation = 'I zasadą termodynamiki: $dU = Q + W$. Zmiana energii wewnętrznej = cieplo dostarczone + praca wykonana NA układzie. Obie wielkości dodajemy.'
...
UPDATE public.questions
   SET text = 'Za selektywny transport przez błony komórkowe odpowiadają związane z błoną białka integralne i powierzchniowe',
       options = '[{"id":"a","text":"prawda"},{"id":"b","text":"fałsz"}]'::jsonb,
       explanation = 'Białka integralne (transmembranowe) odpowiadają za selektywny transport: kanaly jonowe, transportery, pompy. Białka peryferyjne pelnia inne funkcje.'
...
UPDATE public.questions
   SET text = 'Próg pobudliwości to',
       ...
       explanation = 'Próg pobudliwości to wartość potencjału (ok. -55 mV), powyżej ktorej zostaje wyzwolony potencjał czynnościowy. Poniżej progu - bodziec podprogowy.'
...
UPDATE public.questions
   SET text = 'Układ termodynamiczny który nie wymienia z otoczeniem substancji, ale może wymieniać energię, to układ',
       ...
       explanation = 'Układ zamknięty nie wymienia materii z otoczeniem, ale może wymieniać energie (cieplo, prace). Przykład: gaz w cylindrze z ruchomym tlokiem.'
...
UPDATE public.questions
   SET text = 'Entalpia swobodna danej substancji zależy od ciśnienia, temperatury i jej ilości',
       options = '[{"id":"a","text":"prawda"},{"id":"b","text":"fałsz"}]'::jsonb,
       explanation = 'Entalpia swobodna G zależy od temperatury T, ciśnienia p i ilości substancji n: $G = G(T$, p, n). Dla mieszanin dodatkowo od skladu.'
...
UPDATE public.questions
   SET text = 'Energia wewnętrzna organizmu nie ulega zmianie i ciało pozostaje w stanie stacjonarnym gdy',
       ...
       explanation = 'Stan stacjonarny: moc cieplna (produkcja ciepła) = strumien cieplny (oddawanie ciepła). Energia wewnętrzna i temperatura sa stale.'
...
UPDATE public.questions
   SET text = 'Potencjał wewnątrz komórki jest ujemny w stosunku do potencjału elektrycznego jej otoczenia',
       options = '[{"id":"a","text":"prawda"},{"id":"b","text":"fałsz"}]'::jsonb,
       explanation = 'Potencjał spoczynkowy: wnetrze komórki jest ujemne (ok. -70 mV) wzgledem zewnetrza. Wynika z asymetrycznego rozkładu jonow K+, Na+, Cl- i pompy Na/K.'
...
UPDATE public.questions
   SET text = 'W trakcie pomiarów i ich opracowania istotne jest, aby zwracać uwagę na możliwe błędy. Jednym z błędów jest błąd systematyczny. Błąd ten może być spowodowany przez',
       ...
       explanation = 'Dobranie zbyt małej liczby pomiarów to błąd metodyczny/systematyczny zwiazany z planowaniem eksperymentu, nie błąd pomiaru. Pozostale to przyczyny błędów przypadkowych/systematycznych.'
...
UPDATE public.questions
   SET text = 'Na zachowanie się krwi w naczyniach w trakcie przepływu ma istotny wpływ współczynnik lepkości krwi. Współczynnik lepkości krwi może zwiększyć się w przypadku:',
       ...
       explanation = 'Lepkość krwi rosnie przy: wzroscie hematokrytu (wiecej komorek) i spadku temperatury (większa lepkość osocza). Te same czynniki co dla kazdej cieczy plus agregacja erytrocytow.'
...
UPDATE public.questions
   SET text = 'Światło po odbiciu od powierzchni dielektryka pod kątem zwanym kątem Brewstera jest spolaryzowane liniowo. Warunek, jaki musi spełniać kąt padania (Φ) określa wzór ($n$ - współczynnik załamania światła na powierzchni dielektryka)',
       options = '[{"id":"a","text":"$n = ctg(Φ)$"},{"id":"b","text":"$n = \\\\tan(Φ)$"},{"id":"c","text":"$n = \\\\cos(Φ)$"},{"id":"d","text":"$n = \\\\sin(Φ)$"}]'::jsonb,
       explanation = 'Prawo Brewstera: $n = \\tan(phi_{B})$, gdzie phi_B to kąt Brewstera. Pod tym kątem światło odbite jest calkowicie spolaryzowane (kierunek prostopadly do płaszczyzny padania).'
...
UPDATE public.questions
   SET text = 'Wzór Einsteina dotyczy lepkości względnej roztworu (η ) ma postać η = η (1+2,5 Φ). Symbol Φ w 0 oznacza',
       ...
       explanation = 'We wzorze Einsteina phi to ulamek objętościowy - stosunek objętości cząstek rozpuszczonych do calkowitej objętości roztworu. Dla sfer: $eta_{wzgl} = 1 + 2$.5*phi.'
...
UPDATE public.questions
   SET text = 'Pisanie niepoprawnych jednostek, np. mPa zamiast Pa. Powoduje to, że wielkość zapisana znacznie odbiega (co do wartości) od pozostałych danych szeregu pomiarowego. Tego typu błąd nazwiemy błędem',
       ...
       explanation = 'Błąd gruby (pomylka) to oczywisty błąd jak zly zapis jednostek, pomylka w obliczeniach, odczyt zlej skali. Wyniki z bledami grubymi nalezy odrzucic.'
...
UPDATE public.questions
   SET text = 'Dielektryk jest substancją zawierającą cząsteczki cechujące się trwałym rozsunięciem ładunków na cząsteczce, któremu można przyporządkować wektor momentu dipolowego. Makroskopowo wielkością definiowaną dla dielektryka, którą można mierzyć, jest wektor polaryzacji próbki definiowany jako',
       ...
       explanation = 'Polaryzacja dielektryka P = suma momentów dipolowych / objetosc. Jednostka: C/m^2. Opisuje gęstość momentu dipolowego w materiale.'
...
UPDATE public.questions
   SET text = 'Fala ultradźwiękowa, natrafiając na granicę dwóch ośrodków o różnych impedancjach akustycznych, ulega częściowemu odbiciu. Współczynnik odbicia fali ultradźwiękowej na granicy powietrze-woda jest',
       ...
       explanation = 'Na granicy tkanek miekkich (podobna impedancja) odbija się ok. 1% energii. Na granicy tkanka-kosć lub tkanka-powietrze odbicie jest duze (ok. 99%) - duza roznica impedancji.'
...
UPDATE public.questions
   SET text = 'W widmie emisyjnym lampy rentgenowskiej wyróżnić można widmo ciągłe i charakterystyczne. Widmo ciągłe powstaje na skutek hamowania elektronów na',
       ...
       explanation = 'Widmo ciągłe RTG powstaje na anodzie (hamowanie elektronów). Lambda_min = hc/(eU) - najkrótsza długość fali jest odwrotnie proporcjonalna do napięcia przyspieszającego.'
...
UPDATE public.questions
   SET text = 'Na układ dwóch polaryzatorów (polaryzator i analizator) pada wiązka światła monochromatycznego o natężeniu I . Po przejściu przez obydwa polaryzatory rejestrowana jest wiązka świetlna o natężeniu I równym ($α$ - kąt między płaszczyznami przecięcia głównego polaryzatora i analizatora, określających płaszczyzny drgań światła spolaryzowanego)',
       options = '[{"id":"a","text":"$I = I •\\\\cos(\\\\alpha)$"},{"id":"b","text":"$I = I •\\\\sin(\\\\alpha)$"},{"id":"c","text":"$I = I •\\\\cos^{2}(\\\\alpha)$"},{"id":"d","text":"$I = I •\\\\sin^{2}(\\\\alpha)$"}]'::jsonb,
       explanation = 'Prawo Malusa: $I = I_{0} \cdot \cos^{2}(\alpha)$, gdzie alpha to kąt między kierunkami polaryzacji polaryzatora i analizatora. Dla alpha=90 stopni I=0.'
...
UPDATE public.questions
   SET text = 'W celu określenia dokładności pomiarowej posługujemy się pojęciem błędu. Różnicę między średnią arytmetyczną a wielkością zmierzoną nazwiemy błędem',
       ...
       explanation = 'Błąd bezwzgledny to roznica między średnia wartoscia pomiarów a wartoscia rzeczywista (lub przyjeta za rzeczywista). Ma te sama jednostke co mierzona wielkość.'
...
UPDATE public.questions
   SET text = 'Fale ultrasonograficzne mogą rozchodzić w tkankach organizmu człowieka, dzięki czemu jest możliwe obrazowanie ich struktury wewnętrznej. Prędkość fali ultrasonograficznej w tkankach miękkich jest',
       ...
       explanation = 'Prędkość USG w tkankach miękkich (ok. 1540 m/s) jest znacznie mniejsza niż w kościach (3000-4000 m/s), a nieco większa niż w wodzie (1480 m/s).'
...
UPDATE public.questions
   SET text = 'Przy przechodzeniu promieniowania rentgenowskiego lub gamma dochodzi do oddziaływania tych promieniowań z materią poprzez zjawiska: fotoelektryczne, Comptona lub kreacji par. W przypadku rozproszenia Comptonowskiego, możemy stwierdzić, że w wyniku tego oddziaływania',
       ...
       explanation = 'Efekt Comptona: foton traci energie (rozpraszany na elektronie), wiec jego częstotliwość maleje (E=hf), a długość fali rosnie ($\dfrac{\\lambda = c}{f})$.'
...
UPDATE public.questions
   SET text = 'Całkowita praca objętościowa i wydajność energetyczna serca w spoczynku wynoszą (z przybliżeniem) odpowiednio',
       ...
       explanation = 'Praca serca w spoczynku: ok. 1-1.2 J/skurcz. Wydajność energetyczna (sprawnosc mechaniczna): ok. 15-25%. Wiekszosc energii zamienia się w cieplo.'
...
UPDATE public.questions
   SET text = 'Podczas skurczu mięśnia dochodzi do skracania sarkomerów. Proces ten związany jest z',
       ...
       explanation = 'Skurcz mięśnia: miofilamenty cienkie (aktyna) przesuwaja się względem grubych (miozyna). Długość filamentow nie zmienia się - zmienia się ich wzajemne polozenie.'
...
UPDATE public.questions
   SET text = 'Jeśli podczas dostarczania ciepła do próbki substancji nie obserwujemy wzrostu jej temperatury, oznacza to, że',
       ...
       explanation = 'Brak wzrostu temperatury przy dostarczaniu ciepła = przemiana fazowa (topnienie, parowanie). Cieplo zuzywane jest na zmiane stanu, nie na wzrost temperatury.'
...
UPDATE public.questions
   SET text = 'Fale ze względu na sposób pobudzania do drgań elementów ośrodka, przez który przechodzą, dzielimy na podłużne i poprzeczne. Do fal podłużnych zaliczamy fale',
       ...
       explanation = 'Fale akustyczne (dźwiękowe) to fale mechaniczne podłużne - cząstki ośrodka drgaja wzdłuż kierunku propagacji fali. Wymagaja ośrodka materialnego.'
...
UPDATE public.questions
   SET text = 'Fala świetlna, przechodząc przez materię, może podlegać rozproszeniu Rayleigha lub Ramana. W przypadku rozpraszania Rayleigha możemy stwierdzić, że',
       ...
       explanation = 'Rozpraszanie Rayleigha jest sprezysłe (elastyczne) - foton nie traci energii, zmienia tylko kierunek. Rozpraszanie Ramana jest niesprezysłe - zmiana energii i częstotliwości.'
...
UPDATE public.questions
   SET text = 'W metodzie NMR zastosowanie impulsu π/2 powoduje odchylenie wektora magnetyzacji o kąt 90°. Po wyłączeniu pola radiowego, magnetyzacja precesując, powraca do kierunku pola magnetycznego. Czas potrzebny na to, aby poprzeczna składowa magnetyzacji zmalała do 37% jej wartości początkowej nazywamy czasem relaksacji',
       ...
       explanation = 'Po impulsie pi/2 wektor magnetyzacji obraca się o 90 stopni do płaszczyzny xy. Powrot do rownowagi: T1 (spin-sieć) - składowa z, T2 (spin-spin) - składowa xy.'
...
UPDATE public.questions
   SET text = 'Równanie Bragga pozwalające na rentgenowską analizę strukturalną ma postać ($n$ - kolejne liczby naturalne, λ - długość fali, α - kąt padania wiązki promieni X, d - odległość między warstwami sieci krystalicznej)',
       options = '[{"id":"a","text":"$2d\\\\lambda = nsin(\\\\alpha)$"},{"id":"b","text":"$n\\\\lambda = 2dsin(\\\\alpha)$"},{"id":"c","text":"$n\\\\lambda = dsin(\\alpha2)$"},{"id":"d","text":"$2nd\\\\lambda = \\\\sin(\\\\alpha)$"}]'::jsonb,
       explanation = 'Równanie Bragga: n*$\\lambda = 2d \cdot \\\\sin(\\theta)$, gdzie d to odległość miedzypłaszczyznowa, theta to kąt padania, n to rzad dyfrakcji. Warunek konstruktywnej interferencji.'
 WHERE id = 'biofiz-s2-087';

UPDATE public.questions
   SET text = 'Mięsień jest tkanką anizotropową, co wpływa na to, że zależność naprężenia w mięśniu jako funkcją odkształcenia jest funkcją nieliniową. Z zależności tej można wnioskować, że moduł Younga dla mięśnia poprzecznie prążkowanego',
       ...
       explanation = 'Mięsień jest nieliniowo sprezysty - moduł Younga (sztywnosc) zwiększa się ze wzrostem odkształcenia. Im bardziej rozciagniety, tym trudniej rozciagnac dalej.'
...
UPDATE public.questions
   SET text = 'W jednej z metod ultrasonograficznych możliwe jest określenie prędkości przepływu krwi w naczyniu krwionośnym. Metoda ta, zwana dopplerowską, polega na wyznaczeniu',
       ...
       explanation = 'Metoda Dopplerowską w USG: zmiana częstotliwości fali odbitej od poruszajacych się krwinek pozwala obliczyc prędkość przepływu krwi. Delta_f proporcjonalne do prędkości.'
...
UPDATE public.questions
   SET text = 'Przy przejściu przez substancję optycznie czynną światła spolaryzowanego dochodzi do skręcenia płaszczyzny polaryzacji wiązki świetlnej. Do substancji optycznie czynnych na pewno nie zaliczymy',
       ...
       explanation = 'Woda nie jest substancja optycznie czynną (nie skreca płaszczyzny polaryzacji). Cukry, bialka, kwasy nukleinowe - sa optycznie czynne (cząsteczki chiralne).'
...
UPDATE public.questions
   SET text = 'Jądro atomowe o niezerowym momencie magnetycznym ulega w zewnętrznym polu magnetycznym procesji. Zjawisko to polega na wirowaniu momentu magnetycznego jądra wokół kierunku zewnętrznego pola magnetycznego z częstotliwością ($γ$ - współczynnik giromagnetyczny jądra',
       ...
       explanation = 'Częstotliwość Larmora: $omega_{L} = \gamma \cdot B$, gdzie gamma to współczynnik giromagnetyczny, B to pole magnetyczne. Opisuje precesje momentu magnetycznego jądra.'
...
UPDATE public.questions
   SET text = 'Fala tętna jest sprężystym odkształceniem ścian tętnic, powstałym na skutek zwiększonego ciśnienia po wyrzucie krwi do aorty. Szybkość fali tętna w naczyniach sprężystych nie zależy od',
       ...
       explanation = 'Prędkość fali tętna v = sqrt(E*h/(rho*d)), gdzie E to modul Younga ściany, h to grubość, rho to gęstość krwi (**A NIE LEPKOŚĆ!!**), d to srednica.'
...
UPDATE public.questions
   SET text = 'Wzór przedstawiony poniżej przedstawia ($n$ - liczba pomiarów, x - wynik i-tego pomiaru) i',
       ...
       explanation = 'yWzór pokazuje BŁĄD STANDARDOWY (standard error): $SE = \dfrac{\\sigma}{√n}$, gdzie σ to odchylenie standardowe. Wariancja to σ². Błąd bezwzględny to |x - x_śr|. Błąd standardowy mówi jak dokładna jest średnia.'
...
UPDATE public.questions
   SET text = 'Człowiek w swoim codziennym życiu narażony jest na wpływ promieniowania jonizującego, pochodzącego od czynników naturalnych (promieniowanie kosmiczne, promieniowanie z izotopów promieniotwórczych znajdujących się w niewielkich ilościach w otoczeniu). Związana z tym przeciętna dawka skuteczna (efektywna) promieniowania jonizującego dla człowieka od tła wynosi (Sv - Siwert)',
       ...
       explanation = 'Średnia roczna dawka promieniowania naturalnego: ok. 2-3 mSv (radon, promieniowanie kosmiczne, izotopy w zywnosci, promieniowanie z gruntu).'
...
UPDATE public.questions
   SET text = 'Współczynnik lepkości określa własności cieczy związane z wzajemnym oddziaływaniem molekuł w trakcie przepływu cieczy (w sąsiednich warstwach cieczy). Współczynnik ten definiowany jest jako iloraz',
       ...
       explanation = 'Współczynnik lepkości eta = naprezenie scinajace / szybkosc ścinania = tau / (dv/dy). Jednostka: Pa*s. Dla cieczy newtonowskiej eta = const.'
...
UPDATE public.questions
   SET text = 'Prawo Webera-Fechnera zastosowane do narządu słuchu pozwala stwierdzić, że najmniejszy zauważalny bodziec, czyli próg różnicy natężenia odbieranej fali dźwiękowej jest',
       ...
       explanation = 'Prawo Webera-Fechnera: $\dfrac{delta_{I}}{I} = const. Najmniejszy zauwa$żalny przyrost natężenia (próg roznicowy) jest proporcjonalny do natężenia dzwięku juz dzialajacego.'
...
UPDATE public.questions
   SET text = 'Komórki i tkanki umieszczone w polu elektrycznym reagują na to pole. Jednym ze zjawisk obserwowanych w tym przypadku jest dyspersja przenikalności dielektrycznej tkanek. Cechą charakterystyczną tego zjawiska jest zależność przenikalności dielektrycznej od',
       ...
       explanation = 'Elektroporacja zależy od częstotliwości pola elektrycznego. Przy odpowiedniej częstotliwości błona staje się przepuszczalna - tworzą się przejsciowe pory.'
...
UPDATE public.questions
   SET text = 'Polaryzacja elektryczna ośrodka jest reakcją ośrodka na przyłożone zewnętrzne pole elektryczne. Szybkość zaniku polaryzacji elektrycznej po wyłączeniu pola elektrycznego charakteryzowane jest przez czas relaksacji elektrycznej. Czas ten jest czasem potrzebnym na to, aby polaryzacja po wyłączeniu pola zmalała',
       ...
       explanation = 'Czas relaksacji tau - to czas, w ktorym polaryzacja maleje e razy (2.71...) czyli do ok. 37% wartości poczatkowej. P(t) = P_0 * exp(-t/tau).'
...
UPDATE public.questions
   SET text = 'Ciała stałe pod wpływem przyłożonej siły ulegają odkształceniom. Zdolność materiału do osiągnięcia nowych kształtów oraz zachowania kształtów uprzednio uzyskanych po zdjęciu obciążenia bez naruszenia spójności to',
       ...
       explanation = 'Plastyczność to zdolność materiału do trwalego odksztalcenia bez zerwania. Sprężystość - powrot do ksztaltu. Wytrzymałość - odpornosc na zniszczenie.'
...
UPDATE public.questions
   SET text = 'Jednym z parametrów stosowanych w rentgenowskiej tomografii komputerowej jest projekcja. Parametr ten jest definiowany wzorem ($l$ - natężenie wiązki padającej, l - natężenie wiązki przechodzącej, d - grubość woksla, ln () - logarytm naturalny)',
       options = '[{"id":"a","text":"i jest równy iloczynowi współczynników pochłaniania woksli, przez które przechodzi promieniowanie"},{"id":"b","text":"i jest równy sumie współczynników pochłaniania woksli, przez które przechodzi promieniowanie"},{"id":"c","text":"$P = d • \\ln(\\dfrac{l}{l}) i jest rowny iloczynowi wspołczynnikow pochłaniania woksli, przez ktore przechodzi promieniowanie$"},{"id":"d","text":"$P = d • \\ln(\\dfrac{l}{l}) i jest rowny sumie wspołczynnikow pochłaniania woksli, przez ktore przechodzi promieniowanie$"}]'::jsonb,
...
UPDATE public.questions
   SET text = 'Reakcją ciał na przyłożenie zewnętrznego pola elektrycznego jest niezerowy wektor polaryzacji, który po wyłączeniu pola elektrycznego zanika. Szybkość zaniku polaryzacji elektrycznej po wyłączeniu pola elektrycznego nie zależy od',
       ...
       explanation = 'Polaryzacja P jest proporcjonalna do natężenia pola E: $P = epsilon_{0} \cdot chi \cdot E$, gdzie chi to podatnosc elektryczna ośrodka.'
...
UPDATE public.questions
   SET text = 'Mamy do dyspozycji dwie kapilary o tej samej długości, przy czym promień jednej z kapilar jest dwukrotnie większy. Przy przepływie przez kapilary tej samej cieczy (np. wody) opór naczyniowy kapilary o dwukrotnie większym promieniu jest',
       ...
       explanation = 'Prawo Poiseuille: Q ~ r^ 4. Dwukrotnie mniejszy promień: $Q2 = Q1 \cdot (\dfrac{1}{2})^4 = \dfrac{Q1}{16}$. Opór szesnastokrotnie większy.'
...
UPDATE public.questions
   SET text = 'Fale akustyczne odbierane przez ucho są wzmacniane w uchu środkowym. Elementy struktury ucha środkowego odpowiedzialne za wzmocnienie to',
       ...
       explanation = 'Wzmocnienie w uchu środkowym: roznica powierzchni błony bębenkowej i okienka owalnego (17:1) oraz dzwignia kosteczek słuchowych (1.3:1). Laczne wzmocnienie ok. 22x.'
...
UPDATE public.questions
   SET text = 'Poziomy energetyczne niektórych jąder atomowych umieszczonych w silnym zewnętrznym polu magnetycznym (B ) ulegają rozszczepieniu ze względu na kierunek ich momentów magnetycznych względem B . Różnica między poziomami energii jąder przy ustawieniu przeciwnym ich momentów magnetycznych jest',
       ...
       explanation = 'Różnica energii między poziomami spinowymi: $delta_{E} = \gamma \cdot h_{bar} \cdot B$. Proporcjonalna do współczynnika giromagnetycznego gamma i indukcji B.'
 WHERE id = 'biofiz-s2-109';

UPDATE public.questions
   SET text = 'Światło jest falą elektromagnetyczną, w której pola elektryczne i magnetyczne drgają w kierunkach wzajemnie prostopadłych i prostopadle do kierunku rozchodzenia się fali. Aby falą świetlna była spolaryzowana liniowo koniecznym jest, aby',
       options = '[{"id":"a","text":"drgania pola elektrycznego odbywały się w płaszczyznach wzajemnie równoległych"},{"id":"b","text":"falą przechodziła przez ośrodek optycznie czynny"},{"id":"c","text":"drgania pola elektrycznego mogą mieć dowolny kierunek"},{"id":"d","text":"drgania pola elektrycznego odbywały się w płaszczyznach wzajemnie prostopadłych"}]'::jsonb,
       explanation = 'Światło spolaryzowane liniowo: drgania pola E w jednej plaszczyznie. Powstaje przez odbicie pod kątem Brewstera, przejscie przez polaryzator, dwojlomnosc.'
...
UPDATE public.questions
   SET text = 'Zjawiskami mającymi wpływ na lepkość krwi są agregacja i elongacja krwinek czerwonych. Zwiększenie stopnia agregacji krwinek czerwonych (zachodzące przy małych szybkościach ścinania)',
       ...
       explanation = 'Elongacja (wydluzanie) erytrocytow przy duzych szybkościach ścinania zmniejsza lepkość krwi. Agregacja (przy małych szybkościach) zwieksza lepkość.'
...
UPDATE public.questions
   SET text = 'Zjawisko luminescencji obserwowane jest w ciałach stałych, cieczach i gazach. Dzielone jest na dwa typy: fosforescencję i fluorescencję. Porównując te dwa typy pod względem czasu wygaszania, możemy stwierdzić, że czas wygaszania fluorescencji jest zazwyczaj',
       ...
       explanation = 'Fluorescencja: czas zycia stanu wzbudzonego $10^{-9}$ - $10^{-7}$ s (nanosekundy). Fosforescencja: $10^{-3}$ - $10^{2}$ s (milisekundy do sekund). Fluorescencja jest krótsza.'
...
UPDATE public.questions
   SET text = 'Głównym elementem refraktometru Abbego, pozwalającego wyznaczyć współczynnik załamania substancji umieszczonej między pryzmatami, jest układ pryzmatów o dużym współczynniku załamania. Na matowej powierzchni pierwszego z pryzmatów dochodzi do zjawiska',
       ...
       explanation = 'Refraktometr Abbego: na jednym pryzmacie zachodzi załamania graniczne (kąt graniczny zaleza od n), na drugim zachodzi całkowite wewnetrzne odbicie.'
...
UPDATE public.questions
   SET text = 'Jednym z ważnych parametrów określających falę rozchodzącą się w danym ośrodku jest natężenie fali, które definiujemy jako iloraz',
       ...
       explanation = 'Natężenie fali I = moc/powierzchnie = P/S. Jednostka: W/m^2. Energia przechodzaca przez jednostke powierzchni w jednostce czasu.'
...
UPDATE public.questions
   SET text = 'W obrazowaniu NMR tkanek wewnętrznych organizmu wykorzystywane jest silne pole magnetyczne oraz pole elektromagnetyczne z zakresu radiowego. Zadaniem pola elektromagnetycznego z zakresu radiowego jest',
       ...
       explanation = 'Impuls RF w NMR odchyla magnetyzacje z kierunku równoległego (wzdłuż B0) do kierunku prostopadłego. Relaksacja przywraca rownowage.'
...
UPDATE public.questions
   SET text = 'Ważnymi parametrami wykorzystywanymi do charakteryzowania zróżnicowania między tkankami w obrazowaniu wnętrza organizmu za pomocą magnetycznego rezonansu jądrowego są czasy relaksacji. Czas relaksacji spin-sieć (T1) jest czasem potrzebnym na to, aby po impulsie π/2 składowa magnetyzacji:',
       ...
       explanation = 'Czas relaksacji T1 (spin-sieć): składowa podłużna Mz narasta do wartości rownowagowej. T1 to czas gdy Mz osiaga 63-67% wartości koncowej.'
...
UPDATE public.questions
   SET text = 'Tomograf rentgenowski składający się z dookólnej matrycy detektorów i ruchomej lampy rentgenowskiej, obracającej w sposób ciągły wokół pacjenta oraz wykorzystujący wiązkę wachlarzykowatą o kącie rozwartości 60° zaliczymy do rentgenowskich tomografów generacji',
       ...
       explanation = 'IV generacja CT: pelny pierscien nieruchomych detektorów (360°), lampa obraca się wewnatrz. Szybsze skanowanie niż III generacja.'
...
UPDATE public.questions
   SET text = 'Po wzbudzeniu próbki umieszczonej w zewnętrznym polu magnetycznym, polem elektromagnetycznym z zakresu radiowego, w cewce odbiorczej obserwowany jest zanikający sygnał sinusoidalny (free induction decay). Przebieg tego sygnału w czasie pozwala wyznaczyć czas relaksacji T . Sygnał ten związany jest z zanikającą w czasie',
       ...
       explanation = 'Po impulsie RF składową poprzeczną Mxy (precesujaca) indukuje sygnał w cewce odbiorczej. T2 opisuje zanik skladowej poprzecznej.'
...
Jeżeli promieniowanie jonizujące przejdzie przez materię o grubości równej d = 2D, to natężenie promieniowania zmaleje',
       ...
       explanation = 'Prawo osłabienia: $I = I_{0} \cdot \exp(-\mu \cdot x). Przy grubo$ści równej HVL (half-value layer) natężenie maleje dwukrotnie.'
...
UPDATE public.questions
   SET text = 'Lampa rentgenowska w czasie pracy emituje promieniowanie rentgenowskie w postaci pasma o wielu długościach fal. Cechą charakterystyczną widma ciągłego lampy rentgenowskiej jest granica krótkofalowa widma promieniowania rentgenowskiego, która',
       ...
       explanation = 'Minimalna długość fali lambda_min = hc/(eU). Odwrotnie proporcjonalna do napięcia U. Wyzsze napięcie = krótsza lambda_min = twardsze promieniowanie.'
...
UPDATE public.questions
   SET text = 'Aby utrzymać stałą temperaturę wnętrza ciała, organizm wymienia ciepło z otoczeniem. Strumień cieplny, który zależy od różnicy T 4 – T 4, gdzie T - temperatura bezwzględna skóry, T - temperatura s ot s ot bezwzględna otoczenia, nazwiemy strumieniem',
       ...
       explanation = 'Wymiana ciepla przez promieniowanie (radiacje) - emisja fal EM z powierzchni ciała. Prawo Stefana-Boltzmanna: $P = \epsilon \cdot \sigma \cdot A \cdot T^{4}.$'
...
UPDATE public.questions
   SET text = 'Jeżeli przy natężeniu dźwięku I = 2 · 10-6 W/m2 stwierdzono, że najmniejsza zauważalna zmiana natężenia wynosi ∆I = a [W/m2], to przy natężeniu tego samego dźwięku równym I = 6 · 10-6 W/m2 najmniejsza zauważalna zmiana będzie wynosiła',
       options = '[{"id":"a","text":"$\\dfrac{a}{3}$"},{"id":"b","text":"$a + 4 \\dfrac{W}{m2}$"},{"id":"c","text":"$a - 4 \\dfrac{W}{m2}$"},{"id":"d","text":"$3a$"}]'::jsonb,
       explanation = 'Prawo Webera: $\dfrac{delta_{I}}{I} = const. Przy trojkrotnie wiekszym nat$ężeniu (I2=3I1), próg roznicowy tez jest trojkrotnie większy: $delta_{I2} = 3 \cdot delta_{I1} = 3a$.'
...
UPDATE public.questions
   SET text = 'Przy ustalonym ciśnieniu naprężenie sprężyste ściany naczynia ($r$ - promień, a - grubość ściany) jest wprost proporcjonalne do',
       options = '[{"id":"a","text":"$\\dfrac{r}{a}$"},{"id":"b","text":"$\\dfrac{r2}{a}$"},{"id":"c","text":"$\\dfrac{a}{r}$"},{"id":"d","text":"$\\dfrac{a}{r2}$"}]'::jsonb,
       explanation = 'Prawo Laplacea: naprężenie w scianie = p*r/a, gdzie p ciśnienie, r promień, a grubość ściany. Proporcjonalne do r/a.'
...
UPDATE public.questions
   SET text = 'Strumień cieczy przepływającej laminarnie przez rurę sztywną zależy',
       ...
       explanation = 'Prawo Poiseuille: $Q = \dfrac{\pi \cdot r^{4} \cdot delta_{p}}{8 \cdot eta \cdot L}. Strumie$ń proporcjonalny do r^4, czyli do kwadratu pola przekroju (S ~ r^2).'
...
UPDATE public.questions
   SET text = 'Zaznacz błędną odpowiedź. Ciśnienie śródpęcherzykowe',
       ...
       explanation = 'Ciśnienie śródpęcherzykowe jest WIĘKSZE od wewnątrzopłucnowego (podoplucnowego). Różnica to ciśnienie sprezystosci pluc.'
...
UPDATE public.questions
   SET text = 'Dla cieczy warstwa adsorbowana',
       ...
       explanation = 'Surfaktanty (substancje powierzchniowo czynne) adsorbuja się na powierzchni i zmniejszaja napięcie powierzchniowe cieczy.'
...
UPDATE public.questions
   SET text = 'Uzupełnij wg kolejności w tekście: Przy wdechu powiększa się powierzchnia pęcherzyków oraz ... się grubość pokrywających je surfaktantów i ... napięcie powierzchniowe.',
       ...
       explanation = 'Przy wdechu: powierzchnia pęcherzyków rosnie, stężenie surfaktantu maleje (rozcieczenie), napięcie powierzchniowe zwiększa się.'
...
UPDATE public.questions
   SET text = 'Jednostką współczynnika absorpcji w układzie SI jest',
       ...
       explanation = 'Współczynnik absorpcji (rozpuszczalnosci) alfa = c/p (prawo Henryego). c w mol/m^3, p w Pa, wiec alfa w mol/(m^3*Pa) = Pa^-1 * mol/m^3.'
...
UPDATE public.questions
   SET text = 'Napięcie powierzchniowe wyraża się',
       ...
       explanation = 'Napięcie powierzchniowe sigma = F/L (siła na jednostke długości). Jednostka: N/m. Energia powierzchniowa na jednostke pola: J/m^2 = N/m.'
...
UPDATE public.questions
   SET text = 'Cząsteczki przy powierzchni cieczy',
       ...
       explanation = 'Cząsteczki przy powierzchni mają większa energie - brak sasiadow z jednej strony, niezrownowazzone siły kohezji. To źródło napięcia powierzchniowego.'
...
UPDATE public.questions
   SET text = 'Wentylacja minutowa to',
       ...
       explanation = 'Wentylacja minutowa = objętość oddechowa * częstotliwość oddechow = ok. 500 ml * 12/min = 6 L/min w spoczynku. Obejmuje wdech i wydech.'
...
UPDATE public.questions
   SET text = 'Energia powierzchniowa właściwa to',
       ...
       explanation = 'Energia powierzchniowa właściwa = współczynnik napięcia powierzchniowego sigma. Jednostka: J/m^2 = N/m.'
...
UPDATE public.questions
   SET text = 'Jaka jest rola surfaktantów w procesie oddychania?',
       ...
       explanation = 'Surfaktant zmniejsza współczynnik napięcia powierzchniowego pęcherzyków płucnych. Zapobiega zapadaniu malych pęcherzyków (prawo Laplacea).'
...
UPDATE public.questions
   SET text = 'Każda cząsteczka w głębi cieczy',
       ...
       explanation = 'Cząsteczka w głębi cieczy oddziałuje z sasiadami we wszystkich kierunkach - siły się rownowaza. Wypadkowa siła = 0.'
...
UPDATE public.questions
   SET text = 'Zaznacz odpowiedź błędną. Zdolność dyfuzyjna',
       ...
       explanation = 'Zdolność dyfuzyjna ZALEŻY od właściwości błon (grubości, powierzchni, przepuszczalnosci). DL = V/(pA-pV) * rozpuszczalnosc.'
...
UPDATE public.questions
   SET text = 'Prawo Henry''ego wyraża wzór (gdzie: c - stężenie gazu rozpuszczonego w cieczy, p - ciśnienie cząstkowe gazu pozostałego nad cieczą, α - współczynnik rozpuszczalności gazu)',
       options = '[{"id":"a","text":"$c = \\\\alpha∙p$"},{"id":"b","text":"$c = \\alpha2p$"},{"id":"c","text":"$c = \\dfrac{1}{\\alphap}$"},{"id":"d","text":"$c = \\dfrac{\\\\alpha}{p}$"}]'::jsonb,
       explanation = 'Prawo Henryego: $c = \alpha \cdot p. St$ężenie gazu rozpuszczonego proporcjonalne do ciśnienia czesciowego gazu nad cieczą. Alpha to współczynnik absorpcji.'
...
UPDATE public.questions
   SET text = 'Metoda planimetryczna do wyznaczenia pracy wykonywanej przez układ oddechowy, polega na',
       ...
       explanation = 'Metoda planimetryczna: rejestracja zmian ciśnienia i objętości, obliczenie pola pod krzywa p-V = praca oddechowa.'
...
UPDATE public.questions
   SET text = 'Zaznacz odpowiedź błędną. Szybkość dyfuzji gazów z pęcherzyków do krwi',
       ...
       explanation = 'Szybkość dyfuzji jest WPROST proporcjonalna do zdolności dyfuzyjnej (nie odwrotnie). V = DL * delta_p.'
...
UPDATE public.questions
   SET text = 'Adsorbcja polega na',
       ...
       explanation = 'Adsorpcja - gromadzenie substancji NA powierzchni ciała. Absorpcja - wchlanianie W cala objetosc. To różne zjawiska.'
...
UPDATE public.questions
   SET text = 'Odcinek PQ na krzywej EKG interpretujemy jako',
       ...
       explanation = 'Odcinek PQ (po zalamku P): przewodzenie impulsu przez węzeł AV i pęczek Hisa. Opoznienie AV ok. 0.1 s.'
...
UPDATE public.questions
   SET text = 'Odcinek ST na krzywej EKG interpretujemy jako',
       ...
       explanation = 'Odcinek ST: początkową faza repolaryzacji komór. Unienienie/obnizenie ST moze wskazywac na niedokrwienie.'
...
UPDATE public.questions
   SET text = 'Odstęp PQ na krzywej EKG interpretujemy jako',
       ...
       explanation = 'Odstęp PQ (od P do Q): depolaryzacja przedsionków + przewodzenie przez węzeł AV. Norma: 0.12-0.20 s.'
...
UPDATE public.questions
   SET text = 'Odstęp QT na krzywej EKG interpretujemy jako',
       ...
       explanation = 'Odstęp QT: od początku QRS do konca T - caly czas depolaryzacji i repolaryzacji komór. Norma zależy od HR.'
...
UPDATE public.questions
   SET text = 'Odstęp ST na krzywej EKG interpretujemy jako',
       ...
       explanation = 'Odstęp ST: od końca QRS (punkt J) do końca T - faza plateau i repolaryzacja komór.'
...
UPDATE public.questions
   SET text = 'Odstęp RR na krzywej EKG interpretujemy jako',
       ...
       explanation = 'Odstęp RR: między dwoma kolejnymi zalamkami R - jeden pelny cykl pracy serca. HR = 60/RR.'
...
UPDATE public.questions
   SET text = 'Zespół QRS na krzywej EKG interpretujemy jako',
       ...
       explanation = 'Zespół QRS: depolaryzacja komór. Q - depolaryzacja przegrody, R - sciany bocznej, S - podstawy komór. Czas < 0.12 s.'
...
UPDATE public.questions
   SET text = 'Prawidłowe miejsce podpięcia elektrody żółtej do pacjenta podczas pomiaru EKG to',
       ...
       explanation = 'Elektroda zolta - lewa ręka. Mnemotechnika: slonce (zolty) - lewa ręka.'
...
UPDATE public.questions
   SET text = 'Prawidłowe miejsce podpięcia elektrody czerwonej do pacjenta podczas pomiaru EKG to',
       ...
       explanation = 'Elektroda czerwona - prawa ręka. Mnemotechnika: $czerwony = start = prawa (jak w wyscigu)$.'
...
UPDATE public.questions
   SET text = 'Prawidłowe miejsce podpięcia elektrody zielonej do pacjenta podczas pomiaru EKG to',
       ...
       explanation = 'Elektroda zielona - lewa noga/goleń. Mnemotechnika: trawa (zielona) = dol = lewa noga.'
...
UPDATE public.questions
   SET text = 'Prawidłowe miejsce podpięcia elektrody czarnej do pacjenta podczas pomiaru EKG to',
       ...
       explanation = 'Elektroda czarna (uziemienie) - prawa noga/goleń. Nie uczestniczy w rejestracji, tylko uziemia pacjenta.'
...
UPDATE public.questions
   SET text = 'Prawidłowe podpięcie elektrody brązowej V4 do pacjenta podczas pomiaru EKG to',
       ...
       explanation = 'V4 (brazowa): V miedzyzebrze w linii środkowo-obojczykowej lewej. Na koniuszku serca.'
...
UPDATE public.questions
   SET text = 'Prawidłowe podpięcie elektrody fioletowej V6 do pacjenta podczas pomiaru EKG to',
       ...
       explanation = 'V6 (fioletowa): V miedzyzebrze w linii pachowej środkowej lewej. Najbardziej na lewo z odprowadzen przedsercowych.'
...
UPDATE public.questions
   SET text = 'Wg Korotkowa ciśnienie skurczowe (górne) odpowiada',
       ...
       explanation = 'Metoda Korotkowa: ciśnienie skurczowe = faza I (pojawienie się pierwszych tonow). Krew zaczyna przeplywac przez scisnięta tętnice.'
...
UPDATE public.questions
   SET text = 'Wg Korotkowa ciśnienie rozkurczowe (dolne) odpowiada',
       ...
       explanation = 'Ciśnienie rozkurczowe = faza V (zanikniecie tonow). Krew przeplywla swobodnie, bez turbulencji.'
 WHERE id = 'biofiz-s2-157';

UPDATE public.questions
   SET text = 'Podczas pomiaru ciśnienia mankiet należy opróżniać z prędkością',
       options = '[{"id":"a","text":"$1 \\dfrac{mmHg}{sek}$"},{"id":"b","text":"$5 \\dfrac{mmHg}{sek}$"},{"id":"c","text":"$2 \\dfrac{mmHg}{sek}$"},{"id":"d","text":"nie ma znaczenia prędkość opróżniania mankietu"}]'::jsonb,
       explanation = 'Mankiet należy oproznic z prędkością ok. 2-3 mmHg/uderzenie serca (ok. 2 mmHg/s). Zbyt szybko = błędy w pomiarze.'
...
UPDATE public.questions
   SET text = 'Gdy podczas pomiaru ciśnienia mankiet opróżniany jest zbyt szybko to',
       ...
       explanation = 'Przy zbyt szybkim oproznianiu nie wolno dopełniać mankietu - trzeba calkowicie spuscic i powtórzyć pomiar po 1-2 min (zastoj zylny).'
...
UPDATE public.questions
   SET text = 'Pulsoksymetria to metoda opierająca się na',
       ...
       explanation = 'Pulsoksymetria - metoda spektrofotometryczna. Mierzy absorbcje światła czerwonego i podczerwonego przez oksyhemoglobine i deoksyhemoglobine.'
...
UPDATE public.questions
   SET text = 'Podczas przeprowadzania wywiadu SAMPLE z pacjentem należy zapytać o',
       ...
       explanation = 'SAMPLE: Symptoms (objawy), Allergies (alergie), Medications (leki), Past history (choroby), Last meal (ostatni posiłek), Events (okoliczności zdarzenia).'
...
UPDATE public.questions
   SET text = 'Falą elektromagnetyczna z zakresu UV ma w porównaniu z falą z zakresu IR:',
       ...
       explanation = '**UV** leży po stronie krótkofalowej widma, **IR** po długofalowej. Zatem UV ma **mniejszą długość fali** niż IR. Ponieważ $c = \lambda f$ (stała prędkość światła), krótsza falą oznacza **większą częstotliwość**. UV: krótka $\lambda$, duża $f$, większa energia kwantu ($E = hf$) — stąd jonizujący charakter dalekiego UV i jego szkodliwość biologiczna. IR: długa $\lambda$, mała $f$, niskoenergetyczne kwanty odczuwane jako ciepło. Reguła: krótsza falą ↔ wyższa częstotliwość ↔ większa energia.'
...
UPDATE public.questions
   SET text = 'Warunkiem koniecznym do działania lasera jest inwersja obsadzeń, czyli:',
       ...
       explanation = '**Inwersja obsadzeń** to nierównowagowy stan, w którym **więcej cząstek zajmuje poziom wyższy** niż niższy — odwrotnie niż przewiduje rozkład Boltzmanna w równowadze. Dopiero wtedy przeważa **emisją wymuszoną** nad absorpcją i możliwe jest wzmacnianie światła (akcja laserowa). Opcja B opisuje stan równowagowy, A wprost wyklucza inwersję, a D to emisją **spontaniczna**, nie wymuszoną. Inwersja = przewaga obsadzenia stanu wzbudzonego.'
...
UPDATE public.questions
   SET text = 'Wysokość dźwięku związana jest z',
       ...
       explanation = 'Wysokość dźwięku (cecha psychologiczna) jest związana z częstotliwością (cecha fizyczna). Im wyzsza częstotliwość, tym wyzszy ton. Zakres slyszalny: 16 Hz - 20 kHz.'
...
UPDATE public.questions
   SET text = 'Cechy fizyczne dźwięku to',
       ...
       explanation = 'Fizyczne cechy dźwięku to: natężenie (W/m^2), częstotliwość (Hz), struktura widmowa (harmoniczne). Wysokość, głośność i barwa to cechy psychologiczne - subiektywne wrazenia słuchowe.'
...
UPDATE public.questions
   SET text = 'Częstotliwości, których ucho ludzkie nie słyszy mieszczą się w zakresie',
       ...
       explanation = 'Ucho ludzkie nie słyszy częstotliwości Powyżej 20 kHz (ultradzwieki) i ponizej 16-20 Hz (infradzwieki). Zakres slyszalny to ok. 16 Hz - 20 kHz.'
...
UPDATE public.questions
   SET text = 'Cechami psychologicznymi dźwięku są',
       ...
       explanation = 'Cechy psychologiczne dźwięku to: wysokość, głośność, barwa. Struktura widmowa i natężenie dźwięku to cechy fizyczne, mierzalne obiektywnie przyrządami.'
 WHERE id = 'biofiz-s3-004';

UPDATE public.questions
   SET text = 'Jednostką natężenia dźwięku jest',
       options = '[{"id":"a","text":"Hz"},{"id":"b","text":"Bel"},{"id":"c","text":"dB"},{"id":"d","text":"$\\dfrac{W}{m2}$"}]'::jsonb,
       explanation = 'Natezenie dźwięku mierzymy w W/m^2 (watach na metr kwadratowy) - to moc akustyczna przypadajaca na jednostke powierzchni. dB to jednostka poziomu natężenia.'
...
UPDATE public.questions
   SET text = 'Krzywe izofoniczne to',
       ...
       explanation = 'Krzywe izofoniczne (rownej głośności) laczą punkty o tym samym subiektywnym wrazeniu głośności przy różnych czestotliwosciach i natezeniach. Ucho ma rozna czulosc dla różnych częstotliwości.'
...
UPDATE public.questions
   SET text = 'Jednostką poziomu głośności jest',
       ...
       explanation = 'Poziom głośności mierzymy w fonach. 1 fon = poziom głośności rownowazny tonowi 1 kHz o danym poziomie natezenia w dB. Glosnosc w fonach = poziom natezenia w dB dla tonu 1 kHz.'
...
UPDATE public.questions
   SET text = 'Prędkość dźwięku jest największa w',
       ...
       explanation = 'Prędkość dźwięku jest największa w ciałach stałych (np. stal ~5000 m/s), mniejsza w cieczach (~1500 m/s w wodzie), najmniejsza w gazach (~340 m/s w powietrzu). Sztywniejszy ośrodek = szybszy dźwięk.'
...
UPDATE public.questions
   SET text = 'Decybel jest jednostką',
       ...
       explanation = 'Decybel (dB) to jednostka poziomu natężenia dźwięku: $L = 10 \cdot \log(\dfrac{I}{I_{0}})$, gdzie I_0 = $10^{-12}$ W/m^2 (próg slyszalnosci). To skala logarytmiczna, nie liniowa.'
...
UPDATE public.questions
   SET text = 'Jeden dB równa się',
       ...
       explanation = '1 decybel (dB) = 0.1 bela (B). Bel to zbyt duza jednostka do praktycznego uzycia, dlatego stosuje się decybele. 10 dB = 1 B.'
...
UPDATE public.questions
   SET text = 'Fale ultradźwiękowe padając na ruchome struktury biologiczne ulegają odbiciu lub rozproszeniu i zmieniają swoją',
       ...
       explanation = 'Efekt Dopplera: fala odbita od ruchomej struktury zmienia częstotliwość. Jesli struktura zbliza się, częstotliwość rosnie; jesli oddala, maleje. Podstawa USG Doppler.'
...
UPDATE public.questions
   SET text = 'Biorąc pod uwagę długości kosteczek słuchowych oraz różne powierzchnie błony okienka owalnego i bębenka przyjmuje się,że wzmocnienie dźwięku w uchu środkowym jest',
       ...
       explanation = 'Uklad kosteczek słuchowych i stosunek powierzchni błony bebenkowej do okienka owalnego daje wzmocnienie ok. 20-22 razy. Konieczne do dopasowania impedancji powietrze-plyny ucha wewnetrznego.'
...
UPDATE public.questions
   SET text = 'Który z parametrów charakteryzujących ultradźwięki nie ulega zmianie podczas przejścia przez tkanki i narządy',
       ...
       explanation = 'Przy przejsciu USG przez różne tkanki częstotliwość pozostaje stała (okreslona przez źródło). Zmienia się prędkość, długość fali i ciśnienie akustyczne (tlumienie).'
...
UPDATE public.questions
   SET text = 'Fizyczne cechy dźwięku to',
       ...
       explanation = 'Fizyczne cechy dźwięku to przede wszystkim częstotliwość (Hz), natężenie (W/m^2) i struktura widmowa. Wysokosc i głośność to cechy psychologiczne.'
...
UPDATE public.questions
   SET text = 'Gdy wiązka ultradźwięków pada na granicę ośrodków pod kątem różnym od kąta prostego i prędkość fali zmienia się na granicy ośrodków to takie zjawisko nazywamy',
       ...
       explanation = 'Gdy fala pada ukosnie na granicę ośrodków o różnych predkosciach, zachodzi załamanie (refraction) - zmiana kierunku propagacji zgodnie z prawem Snella. Odbicie zachodzi tez, ale to osobne zjawisko.'
...
UPDATE public.questions
   SET text = 'Rezonans występuje w układach biologicznych i przyrządach badawczych. Zjawisko to polega na przekazie energii z jednego układu drgającego do drugiego:',
       ...
       explanation = '**Rezonans** zachodzi, gdy częstotliwość wymuszająca pokrywa się z **częstotliwością własną** układu odbierającego energię — wówczas amplitudą drgań osiąga **maksimum**, a przekaz energii jest najefektywniejszy. To struktura układu odbierającego (jego częstotliwość własna) decyduje o warunku rezonansu. Pozostałe opcje błędnie wiążą amplitudę z układem przesyłającym lub czynią ją niezależną od struktury, co przeczy istocie rezonansu.'
...
UPDATE public.questions
   SET text = 'W metodach ultrasonograficznych ważnymi parametrami są prędkość rozchodzenia się fali w ośrodku i gęstość ośrodka. Iloczyn tych parametrów nazywamy:',
       ...
       explanation = '**Impedancją akustyczną** to **$Z = \rho c$** (gęstość ośrodka razy prędkość fali). Decyduje o odbiciu i przejściu fali na granicy ośrodków — im większa różnica $Z$, tym silniejsze odbicie (stąd potrzeba żelu sprzęgającego w USG, dopasowującego impedancję). **Tłumienie** opisuje zanik energii wzdłuż drogi, a **ciśnienie akustyczne** to lokalne wahania ciśnienia w fali. Iloczyn $\rho c$ jednoznacznie definiuje impedancję.'
...
UPDATE public.questions
   SET text = 'Średnia arytmetyczna z szeregu pomiarowego jest',
       ...
       explanation = 'Średnia arytmetyczna jest estymatorem (przybliżeniem) wartości rzeczywistej wielkości mierzonej. Nigdy nie znamy dokładnej wartości rzeczywistej - średnia z pomiarów jest jej najlepszym oszacowaniem.'
...
UPDATE public.questions
   SET text = 'Odchylenie standardowe',
       ...
       explanation = 'Odchylenie standardowe (sigma) jest miara rozproszenia (dyspersji) wyników pomiarowych. Okresla, jak bardzo wyniki odbiegaja od średniej. Wariancja to kwadrat odchylenia standardowego, nie odwrotnie.'
...
UPDATE public.questions
   SET text = 'Wariancja',
       ...
       explanation = 'Wariancja (s^2 lub sigma^2) jest miara rozproszenia wyników pomiarowych, zdefiniowana jako średnia kwadratow odchyleń od średniej. Odchylenie standardowe to pierwiastek z wariancji, nie odwrotnie.'
...
UPDATE public.questions
   SET text = 'Średnia arytmetyczna określona jest z warunku na minimum funkcji będącej sumą po wszystkich pomiarach',
       ...
       explanation = 'Średnia arytmetyczna minimalizuje sume kwadratów różnic między wartosciami zmierzonymi a średnia. To jest podstawa metody najmniejszych kwadratów (MNK). Minimalizujemy: Sum[(xi - x_sr)^2].'
...
UPDATE public.questions
   SET text = 'Błąd standardowy',
       ...
       explanation = 'Błąd standardowy (SE = sigma/sqrt(n)) jest błędem średniej arytmetycznej. Okresla niepewność wyznaczenia średniej. Maleje proporcjonalnie do sqrt(n), nie liniowo.'
...
UPDATE public.questions
   SET text = 'Rozkład normalny mierzonej wielokrotnie wielkości',
       ...
       explanation = 'Rozkład normalny (Gaussa) obrazuje częstotliwość (prawdopodobienstwo) wystapienia danej wartości mierzonej. Maksimum krzywa Gaussa przyjmuje dla średniej, nie dla odchylenia standardowego.'
...
UPDATE public.questions
   SET text = 'Błąd bezwzględny pomiaru jest to',
       ...
       explanation = 'Błąd bezwzględny to różnica między wartoscia zmierzoną a wartoscia rzeczywista (lub jej przybliżeniem - średnia): $Delta_{x} = x_{i} - x_{sr}$. Ma te same jednostki co wielkości mierzona.'
...
UPDATE public.questions
   SET text = 'Błąd względny pomiaru jest to',
       ...
       explanation = 'Błąd względny to iloraz błędu bezwzględnego do wartości rzeczywistej (średniej): $delta = \dfrac{Delta_{x}}{x_{sr}}$. Jest wielkością bezwymiarowa, czesto wyrazana w procentach.'
...
UPDATE public.questions
   SET text = 'Błąd systematyczny jest to błąd spowodowany',
       ...
       explanation = 'Błąd systematyczny wynika z wadliwego przyrządu pomiarowego (zła skalą, zle wyzerowanie). Powoduje stale przesuniecie wszystkich wynikow w jedna strone. Zwiekszanie liczby pomiarów go nie eliminuje.'
...
UPDATE public.questions
   SET text = 'Błąd systematyczny można zmniejszyć (usunąć) poprzez',
       ...
       explanation = 'Błąd systematyczny można usunąć przez kalibrację (wzorcowanie) przyrządu pomiarowego. Zwiekszanie liczby pomiarów nie pomaga - błąd systematyczny nie usrednia się do zera.'
...
UPDATE public.questions
   SET text = 'Przyczyną błędu przypadkowego może być',
       ...
       explanation = 'Błędy przypadkowe (losowe) wynikaja z losowych fluktuacji warunkow pomiaru: drgania, zmiany temperatury, ciśnienia itp. Mają charakter losowy i usredniaja się przy duzej liczbie pomiarów.'
...
UPDATE public.questions
   SET text = 'Błędy przypadkowe w pomiarach',
       ...
       explanation = 'Błędy przypadkowe występują zawsze w kazdym pomiarze. Nie można ich całkowicie wyeliminować, ale można zmniejszyć ich wpływ na wynik koncowy przez zwiększenie liczby pomiarów (średnia jest dokladniejsza).'
...
UPDATE public.questions
   SET text = 'Błąd gruby w pomiarach',
       ...
       explanation = 'Błąd gruby (pomylka) wynika najczęściej z bledu ludzkiego: zly odczyt skali, zly zapis wyniku, pomylka obliczeniowa. Jest znaczaco większy niż błędy przypadkowe i powinien byc odrzucony.'
...
UPDATE public.questions
   SET text = 'Statystyczny rozkład błędów przypadkowych jest',
       ...
       explanation = 'Błędy przypadkowe mają rozkład normalny (Gaussa) ze średnia równą zero (błędy dodatnie i ujemne sa rownie prawdopodobne). Im mniejsze odchylenie standardowe, tym węższa (bardziej skupiona) krzywa rozkładu.'
...
UPDATE public.questions
   SET text = 'Do liczenia błędów wielkości mierzonych pośrednio (wyliczanych ze wzoru, w którym występują wielkości mierzone) możemy wykorzystać metodę',
       ...
       explanation = 'Metoda pochodnej logarytmicznej dziala tylko dla funkcji bedacych iloczynem lub ilorazem wielkości mierzonych, bo ln(ab) = ln( a) + ln( b) i ln(a/ b) = ln( a) - ln(b). Dla sum/roznic trzeba uzyc roznicy zupełnej.'
...
UPDATE public.questions
   SET text = 'Błąd względny obliczenia objętości kuli przy pomiarze jej promienia',
       ...
       explanation = 'Objetosc kuli V = (4/3)*pi*r^3. Błąd względny: dV/V = 3*dr/r, czyli błąd względny objętości jest 3-krotnie większy od błędu względnego promienia (wykladnik potęgi przy r).'
...
UPDATE public.questions
   SET text = 'Błąd bezwzględny obliczenia pomiaru objętości kuli przy pomiarze promienia kuli',
       ...
       explanation = 'Błąd bezwzględny objętości: $dV = (\dfrac{dV}{dr}) \cdot dr = 4 \cdot \pi \cdot r^{2} \cdot dr$. Jest proporcjonalny do r^2 (kwadratu promienia) i do dr (błędu bezwzględnego promienia).'
 WHERE id = 'biofiz-w1-017';

UPDATE public.questions
   SET text = 'Pochodna z funkcji ln(x) jest równa (x wielkość mierzona)',
       options = '[{"id":"a","text":"$(lnx)\\dfrac{’ = 1}{x}$"},{"id":"b","text":"$(lnx)’ = x$"},{"id":"c","text":"$(lnx)’ = x2$"},{"id":"d","text":"$(lnx)\\dfrac{’ = x}{2}$"}]'::jsonb,
       explanation = 'Pochodna funkcji logarytmicznej: (ln x)'' = 1/x. To podstawowy wzór rozniczkowania, kluczowy w metodzie pochodnej logarytmicznej do obliczania błędów.'
...
UPDATE public.questions
   SET text = 'Pochodna ze stałej',
       ...
       explanation = 'Pochodna stałej jest równa zero: (c)'' = 0. Stała nie zmienia się, wiec jej "szybkosc zmiany" (pochodna) wynosi zero.'
...
UPDATE public.questions
   SET text = 'Pochodna z sumy dwóch funkcji',
       ...
       explanation = 'Pochodna sumy jest równa sumie pochodnych: (f + g)'' = f'' + g''. Rozniczkowanie jest operacja liniowa.'
...
UPDATE public.questions
   SET text = 'Pochodna z iloczynu stałej i funkcji',
       ...
       explanation = 'Pochodna iloczynu stałej i funkcji: (c*f)'' = c*f''. Stała "wychodzi przed pochodna" - rozniczkowanie jest operacja liniowa.'
 WHERE id = 'biofiz-w1-021';

UPDATE public.questions
   SET text = 'Pochodna z funkcji x^(n) wynosi',
       options = '[{"id":"a","text":"$n \\cdot x^(n)$"},{"id":"b","text":"$n \\cdot x^(n+1)$"},{"id":"c","text":"$(n-1) \\cdot x^(n-1)$"},{"id":"d","text":"$n \\cdot x^(n-1)$"}]'::jsonb,
       explanation = 'Pochodna funkcji potegowej: (x^n)'' = n*x^(n-1). Wykladnik "schodzi na dol" jako współczynnik, a sam zmniejsza się o 1.'
...
UPDATE public.questions
   SET text = 'Wokół punktu naniesionego na wykres y=f(x) (Δx i Δy – błędy bezwzględne wielkości x i y), rysujemy i i i i prostokąt błędu, którego boki są równe',
       ...
       explanation = 'Prostokąt błędu ma boki równe 2*Delta_x i 2*Delta_y, bo błąd moze byc dodatni lub ujemny. Punkt moze znajdowac się w zakresie +/- Delta od wartości zmierzonej.'
...
UPDATE public.questions
   SET text = 'Linię dopasowania do punktów pomiarowych (linię trendu) prowadzimy',
       ...
       explanation = 'Linię trendu prowadzimy przez prostokąty błędów, jak najbliżej punktów pomiarowych. Nie musi wychodzic z początku układu ani przechodzic dokładnie przez punkty.'
...
UPDATE public.questions
   SET text = 'Metoda liniowej regresji jest takim dopasowaniem linii do punktów, że',
       ...
       explanation = 'Regresja liniowa (metoda najmniejszych kwadratów) minimalizuje sume kwadratów odległości punktów od prostej. Dlatego nazywa się "metoda najmniejszych kwadratów".'
...
UPDATE public.questions
   SET text = 'Współczynnik liniowej korelacji (współczynnik Pearsona) charakteryzujący zależność między dwoma szeregami danych',
       ...
       explanation = 'Współczynnik korelacji Pearsona przyjmuje wartości od -1 do +1. Wartość ujemna oznacza korelacje ujemna (funkcja malejaca), dodatnia - korelacje dodatnia (funkcja rosnaca).'
...
UPDATE public.questions
   SET text = 'Wartość pochodnej funkcji w danym punkcie określa',
       ...
       explanation = 'Pochodna określa szybkosc zmiany funkcji (nachylenie stycznej). Gdy pochodna > 0, funkcja rosnie; gdy pochodna < 0, funkcja maleje; gdy pochodna = 0, funkcja ma ekstremum.'
 WHERE id = 'biofiz-w1-027';

UPDATE public.questions
   SET text = 'Własności logarytmu poprawnie przedstawiają zależności',
       options = '[{"id":"a","text":"$\\ln(xy) = \\ln(x) \\ln(y) ; \\ln(xn) = n \\ln(x)$"},{"id":"b","text":"$\\ln(xy) = \\ln(x) + \\ln(y) ; \\ln(\\dfrac{x}{y}) = \\ln(x) - \\ln(y)$"},{"id":"c","text":"$\\ln(xn) = (\\ln(x))n ; \\ln(\\dfrac{x}{y}) = \\ln(x) – \\ln(y)$"},{"id":"d","text":"$\\ln(xy) = \\ln(x) \\ln(y) ; \\ln(\\dfrac{x}{y}) = \\ln(x) / \\ln(y)$"}]'::jsonb,
       explanation = 'Własności logarytmu: ln(xy) = ln( x) + ln(y), ln(x/ y) = ln( x) - ln(y), ln(x^ n) = n*ln(x). Logarytm zamienia mnozenie na dodawanie, dzielenie na odejmowanie, potegowanie na mnozenie.'
...
UPDATE public.questions
   SET text = 'Fala jest to:',
       ...
       explanation = 'Fala to rozprzestrzenianie się energii w ośrodku bez przemieszczania się samego ośrodka. Cząsteczki ośrodka wykonuja drgania wokol polozenia rownowagi, ale nie przemieszczaja się z fala.'
 WHERE id = 'biofiz-w3-001';

UPDATE public.questions
   SET text = 'Falą akustyczna',
       ...
       explanation = 'Falą akustyczna (dźwiękowa) jest falą sprezystą i podłużną - cząsteczki ośrodka drgaja wzdłuż kierunku rozchodzenia się fali. W przeciwienstwie do fal EM, wymaga ośrodka materialnego do propagacji.'
...
UPDATE public.questions
   SET text = 'Zakres częstotliwości słyszalnych fal akustycznych',
       ...
       explanation = 'Zakres slyszalny: 16 Hz - 20 kHz (20000 Hz). Infradźwieki: ponizej 16 Hz. Ultradzwieki: powyżej 20 kHz. To standardowe granice percepcji sluchowej czlowieka.'
 WHERE id = 'biofiz-w3-003';

UPDATE public.questions
   SET text = 'Falą elektromagnetyczna',
       ...
       explanation = 'Falą elektromagnetyczna jest falą poprzeczną (wektory E i B prostopadle do kierunku propagacji). Może rozchodzić się w próżni z prędkością światła c = 3*$10^{8}$ m/s - maksymalną prędkość we wszechswiecie.'
...
UPDATE public.questions
   SET text = 'Do fal elektromagnetycznych niejonizujących zaliczymy',
       ...
       explanation = 'Promieniowanie niejonizujące: światło widzialne, podczerwen (IR), ultrafiolet (UV) i fale radiowe. Promieniowanie jonizujące: rentgenowskie (X) i gamma - mają energie wystarczajaca do jonizacji atomow.'
...
UPDATE public.questions
   SET text = 'Natężenie fali jest to',
       ...
       explanation = 'Natężenie fali I = P/S, gdzie P to moc, S to powierzchnia prostopadla do kierunku rozchodzenia się fali. Jednostka: W/m^2. To iloraz mocy do powierzchni, nie iloczyn ani energia.'
...
UPDATE public.questions
   SET text = 'W danym ośrodku długość fali',
       ...
       explanation = 'Długość fali $\\lambda = \dfrac{c}{f}$, czyli jest odwrotnie proporcjonalna do częstotliwości. Im większa częstotliwość, tym krótsza fala. W danym ośrodku prędkość v jest stała.'
...
UPDATE public.questions
   SET text = 'Przy przejściu fali przez granicę dwóch ośrodków',
       ...
       explanation = 'Przy przejściu przez granicę ośrodków częstotliwość fali pozostaje stała (okreslona przez źródło), ale zmienia się długość fali i prędkość. $\\lambda = \dfrac{v}{f}$, wiec jesli v się zmienia przy stalym f, to lambda tez się zmienia.'
...
UPDATE public.questions
   SET text = 'Ciśnienie akustyczne (p) fali USG (bez tłumienia) zmienia się zgodnie ze wzorem (po - amplituda ciśnienia, ω - częstość drgań, x – odległość, t - czas, c – prędkość fali)',
       options = '[{"id":"a","text":"$p = p \\\\omega cos[\\\\omega(t-\\dfrac{x}{c})]$"},{"id":"b","text":"$p = p exp[\\\\omega(t-\\dfrac{x}{c})]$"},{"id":"c","text":"$p = p \\\\omega cos[ (t-\\dfrac{x}{c})]$"},{"id":"d","text":"$p = p cos[\\\\omega(t-\\dfrac{x}{c})]$"}]'::jsonb,
       explanation = 'Równanie fali plaskiej: $p = p_{0} \cdot cos[\omega \cdot (t - \dfrac{x}{c})]$. Amplituda p_0 jest stała (bez tłumienia), argument funkcji cos zawiera (t - x/c) - roznica czasu i przesuniecia podzielonego przez prędkość.'
...
UPDATE public.questions
   SET text = 'Długość fali jest',
       ...
       explanation = 'Długość fali to najmniejsza odległość między punktami o tej samej fazie (np. dwoma sasiednimi maksimami lub minimami). Zależy od ośrodka poprzez prędkość: $\\lambda = \dfrac{v}{f}$.'
...
UPDATE public.questions
   SET text = 'Efekt piezoelektryczny polega na',
       ...
       explanation = 'Efekt piezoelektryczny: odksztalcenie mechaniczne kryształu powoduje powstanie ładunków elektrycznych przeciwnego znaku na przeciwległych ściankach. Odksztalcenie jest prostopadle do ścian z ładunkami.'
...
UPDATE public.questions
   SET text = 'Głowice ultradźwiękowe',
       ...
       explanation = 'Głowice USG generują ultradźwięki wykorzystujac odwrotny efekt piezoelektryczny (napięcie -> odksztalcenie -> fala). Do rejestracji wykorzystuja zwykly efekt piezoelektryczny (fala -> odksztalcenie -> napięcie).'
 WHERE id = 'biofiz-w3-013';

UPDATE public.questions
   SET text = 'Prędkość fali USG wynosi',
       options = '[{"id":"a","text":"$340 \\dfrac{m}{s} w powietrzu i 1500 \\dfrac{m}{s} w wodzie$"},{"id":"b","text":"nie zależy od ośrodka, w którym rozchodzi się fala"},{"id":"c","text":"$340 \\dfrac{km}{h} w powietrzu i 1500 \\dfrac{km}{h} w wodzie$"},{"id":"d","text":"$340 \\dfrac{km}{s} w powietrzu i 1500 \\dfrac{km}{s} w wodzie$"}]'::jsonb,
       explanation = 'Prędkość dźwięku: ok. 340 m/s w powietrzu, ok. 1500 m/s w wodzie. Prędkość zależy od ośrodka - w gestszych, sztywniejszych materialach jest większa. Jednostka: m/s, nie km/h ani km/s.'
...
UPDATE public.questions
   SET text = 'Prędkość fali USG',
       ...
       explanation = 'Prędkość USG w tkankach miękkich (~1540 m/ s) jest podobna do wody. W kościach jest znacznie większa (~4000 m/ s) ze wzgledu na większa sztywnosc. USG nie rozchodzi się w próżni.'
...
UPDATE public.questions
   SET text = 'Współczynnik osłabiania ultradźwięków w tkankach zależy od zjawisk',
       ...
       explanation = 'Oslabienie USG w tkankach wynika glownie z absorpcji (zamiana energii na cieplo) i rozpraszania (zmiana kierunku propagacji). Odbicie i załamania sa oddzielnymi zjawiskami na granicach ośrodków.'
 WHERE id = 'biofiz-w3-017';

UPDATE public.questions
   SET text = 'Współczynnik rozpraszania zależy od zjawiska ($f$ - częstotliwość fali)',
       options = '[{"id":"a","text":"$rozpraszania Tyndala (dla ktorego jest proporcjonalny do f^{4}) i rozpraszania Reyleigha (dla ktorego jest proporcjonalny do f)$"},{"id":"b","text":"$rozpraszania Tyndala (dla ktorego jest proporcjonalny do f^{2}) i rozpraszania Reyleigha (dla ktorego jest proporcjonalny do f^{4})$"},{"id":"c","text":"$rozpraszania Reyleigha (dla ktorego jest proporcjonalny do f^{2}) i rozpraszania Tyndala (dla ktorego jest proporcjonalny do f^{4})$"},{"id":"d","text":"$rozpraszania Reyleigha (dla ktorego jest proporcjonalny do f) i rozpraszania Tyndala (dla ktorego jest proporcjonalny do f^{2})$"}]'::jsonb,
       explanation = 'Rozpraszanie Rayleigha: proporcjonalne do f^ 4. Rozpraszanie Tyndalla (Mie): proporcjonalne do f^ 2. Wyzsze częstotliwości = większe rozpraszanie.'
...
UPDATE public.questions
   SET text = 'Rozpraszanie Rayleigha cechuje się tym, że rozmiary struktur rozpraszających są',
       ...
       explanation = 'Rozpraszanie Rayleigha zachodzi gdy rozmiary struktur rozpraszających sa dużo mniejsze od długości fali (d << lambda). Typowe dla malych cząstek, silnie zależy od częstotliwości (~f^4).'
...
UPDATE public.questions
   SET text = 'Rozpraszanie Tyndalla cechuje się tym, że rozmiary struktur rozpraszających są',
       ...
       explanation = 'Rozpraszanie Tyndalla (Mie) zachodzi gdy rozmiary struktur sa porównywalne z długością fali (d ~ lambda). Występuje np. na erytrocytach w USG. Zależność od częstotliwości: ~f^2.'
...
UPDATE public.questions
   SET text = 'Zdolność rozdzielcza w USG',
       ...
       explanation = 'Zdolność rozdzielcza USG jest wprost proporcjonalna do częstotliwości (odwrotnie proporcjonalna do długości fali). Wyzsze częstotliwości daja lepsza rozdzielczość, ale mniejsza penetracje.'
...
UPDATE public.questions
   SET text = 'Impedancja akustyczna ośrodka',
       ...
       explanation = 'Impedancja akustyczna Z = rho * v (iloczyn gęstości ośrodka i prędkości fali). Jednostka: kg/(m^2*s) lub rayl. Różnicą impedancji determinuje odbicie na granicach ośrodków.'
...
UPDATE public.questions
   SET text = 'Odbicie ultradźwięków od granicy między dwoma ośrodkami',
       ...
       explanation = 'Współczynnik odbicia USG zależy od różnicy impedancji akustycznych obu ośrodków: $R = [\dfrac{Z2-Z1}{Z2+Z1}]^2$. Im większa roznica impedancji, tym silniejsze odbicie (np. tkanka-powietrze: prawie 100%).'
...
UPDATE public.questions
   SET text = 'Współczynnik odbicia fali USG jest definiowany, jako',
       ...
       explanation = 'Współczynnik odbicia R = I_odbita / I_padajaca (iloraz natężeń). Okresla jaka czesc energii fali zostaje odbita na granicy ośrodków. Dla ciśnień: r = p_odbite / p_padające.'
...
UPDATE public.questions
   SET text = 'Metoda echograficzna, (pozwalająca obliczyć odległości struktur odbijających w organizmie) polega na pomiarze',
       ...
       explanation = 'Metoda echograficzna: wysylamy impuls USG i mierzymy czas powrotu echa. Znajac prędkość USG w tkance (ok. 1540 m/s), obliczamy odległość: $d = v \cdot \dfrac{t}{2} (dzielimy przez 2$, bo fala pokonuje droge tam i z powrotem).'
...
UPDATE public.questions
   SET text = 'Strefowe wzmacnianie ech USG polega na tym, że',
       ...
       explanation = 'Strefowe wzmacnianie (TGC - Time Gain Compensation) kompensuje tlumienie fali w tkankach. Im głębiej polozana struktura, tym bardziej wzmacniamy sygnal echa - wyrownujac jasnosc obrazu na różnych glebokosciach.'
...
UPDATE public.questions
   SET text = 'Dla fali ultradźwiękowej',
       ...
       explanation = 'Prędkość USG w tkankach: ok. 1500 m/s. Prędkość krwi w aorcie: ok. 1 m/s. Roznica: ok. 1500-krotna. USG jest znacznie szybsze niż przepływ krwi, co umozliwia obrazowanie w czasie rzeczywistym.'
...
UPDATE public.questions
   SET text = 'Promieniowanie rentgenowskie',
       ...
       explanation = 'Promieniowanie RTG jest mocniej pochłaniane przez tkanki o większej gęstości i zawierające pierwiastki o większej liczbie atomowej Z. Dlatego kosci (Ca) sa jasne na RTG, a tkanki miekkie ciemniejsze.'
...
UPDATE public.questions
   SET text = 'Promieniowanie rentgenowskie',
       ...
       explanation = 'Promieniowanie RTG to falą elektromagnetyczną (nie podłużną!) o wysokiej energii, powodującą jonizację materii. Oddziałuje glownie z elektronami powłok wewnętrznych (efekt fotoelektryczny, Compton).'
...
UPDATE public.questions
   SET text = 'Wzór $Ef = h$· ν = h · c / λ przedstawia energią fotonu, przy czym',
       ...
       explanation = 'E = h*nu = h*c/lambda, gdzie: h - stała Plancka (6.63*$10^{-34}$ J*s), c - prędkość światła, lambda - długość fali, nu (v) - częstotliwość. To podstawowe równanie Plancka dla energii fotonu.'
 WHERE id = 'biofiz-w4-003';

UPDATE public.questions
   SET text = 'Natężenie promieniowania definiuje wzór',
       options = '[{"id":"a","text":"$I = \\dfrac{E}{S} · t, gdzie E jest energia fali, S jest powierzchnia przez ktora fala przechodzi a t - jest czasem przejscia fali przez powierzchnie S$"},{"id":"b","text":"$I = \\dfrac{E}{S,} gdzie E jest energia fali a S jest powierzchnia przez ktora fala przechodzi$"},{"id":"c","text":"$I = \\dfrac{P}{t,} gdzie P jest moca fali a t - jest czasem przejscia fali o mocy P$"},{"id":"d","text":"$I = \\dfrac{E}{P} · t, gdzie P jest moca fali, S jest powierzchnia przez ktora fala przechodzi a t - jest czasem przejscia fali przez powierzchnie S$"}]'::jsonb,
...
UPDATE public.questions
   SET text = 'Grubość połówkowego pochłaniania',
       ...
       explanation = 'Grubość połówkowego pochłaniania (HVL - Half Value Layer) to grubość materialu, przy której natężenie promieniowania maleje o polowe. Im większa energia RTG, tym większa HVL.'
...
UPDATE public.questions
   SET text = 'Oddziaływanie promieniowania rentgenowskiego z materią opisują zjawiska:',
       ...
       explanation = 'Promieniowanie RTG oddzialuje z materią glownie poprzez: absorpcje (efekt fotoelektryczny - foton jest calkowicie pochlaniany) i efekt Comptona (nieelastyczne rozproszenie fotonu na elektronie).'
...
UPDATE public.questions
   SET text = 'Oddziaływanie Comptonowskie:',
       ...
       explanation = 'Efekt Comptona (rozproszenie) zmniejsza zdolność rozdzielcza obrazów RTG. Rozproszone fotony zmieniaja kierunek i docieraja do detektora, powodujac rozmycie obrazu i zmniejszenie kontrastu.'
...
UPDATE public.questions
   SET text = 'Zjawisko odpowiedzialne za zmniejszenie kontrastu na zdjęciach rentgenowskich to:',
       ...
       explanation = 'Efekt Comptona polega na zmianie kierunku fotonu po rozproszeniu na elektronie. Te rozproszone fotony tworzą "szum" na obrazie, zmniejszajac kontrast. Dlatego stosuje się siatki przeciwrozproszeniowe.'
...
UPDATE public.questions
   SET text = 'Miejsca na kliszy o większym zaczernieniu odpowiadają tkankom o:',
       ...
       explanation = 'Klisza RTG dziala jak negatyw: ciemniejsze miejsca = wiecej promieniowania doszlo = mniejsze pochłanianie przez tkanke. Kosci sa jasne (duze pochłanianie), pluca ciemne (male pochłanianie).'
...
UPDATE public.questions
   SET text = 'Środki kontrastujące w rentgenografii mają za zadanie:',
       ...
       explanation = 'Środki kontrastowe (np. bar, jod) mają duza liczbe atomowa Z, silnie pochlaniaja RTG, zwiekszajac kontrast. Gromadza się wybiórczo w określonych strukturach (np. jod w tarczycy, bar w przewodzie pokarmowym).'
...
UPDATE public.questions
   SET text = 'Rola wysokiego napięcia w lampie rentgenowskiej polega na',
       ...
       explanation = 'Wysokie napięcie (ok. 100 kV) przysiesza elektrony od katody (źródło e-) do anody (tarcza). Na anodzie elektrony sa hamowane, emitujac promieniowanie RTG (hamowania i charakterystyczne).'
...
UPDATE public.questions
   SET text = 'Aby uwidocznić naczynia krwionośne w prześwietleniu rentgenowskim należy wprowadzić kontrast poprzez',
       ...
       explanation = 'Kontrast do angiografii podaje się przed rozwidleniem naczynia - wtedy przeplynie do wszystkich odgalezien. Za rozwidleniem wypenil by tylko jedno naczynia.'
...
UPDATE public.questions
   SET text = 'Jaka część energii rozpędzonych elektronów w lampie rentgenowskiej zamienia się na promieniowanie rentgenowskie',
       ...
       explanation = 'Tylko ok. 1% energii elektronów zamienia się na promieniowanie RTG. Reszta (99%) zamienia się na ciepło, dlatego anoda wymaga intensywnego chlodzenia (anoda wirujaca, chlodzenie wodne/olejowe).'
...
UPDATE public.questions
   SET text = 'Napięcie w lampie rentgenowskiej przyśpieszające elektrony jest rzędu:',
       ...
       explanation = 'Napięcie w lampie RTG wynosi ok. 40-150 kV (kilovolty) w diagnostyce. Wyzsze napięcie = większa energia fotonow (krótsza fala), większa penetracja, mniejsze roznice kontrastu.'
...
UPDATE public.questions
   SET text = 'Obwód żarzenia katody ma na celu:',
       ...
       explanation = 'Obwód żarzenia (6-12 V) rozgrzewa katode do ok. 2000°C, powodujac emisje termoelektronowa - elektrony "wyparowuja" z powierzchni metalu i sa gotowe do przyspieszenia w kierunku anody.'
...
UPDATE public.questions
   SET text = 'Środki kontrastujące w prześwietleniu rentgenowskim muszą spełniać warunki:',
       ...
       explanation = 'Środki kontrastowe: ( 1) nie wchodzą w reakcje metaboliczne - sa obojetne, ( 2) mają dużą liczbę atomową Z - silnie pochlaniaja RTG, ( 3) sa szybko wydalane - minimalizuja ekspozycje organizmu.'
...
UPDATE public.questions
   SET text = 'Widmo promieniowania lampy rentgenowskiej składa się z:',
       ...
       explanation = 'Widmo RTG składa się z: widma ciągłego (Bremsstrahlung - hamowanie elektronów na anodzie, caly zakres energii) + widma charakterystycznego (przeskoki elektronów między powlokami atomów anody, dyskretne linie).'
...
UPDATE public.questions
   SET text = 'Dwukrotne zwiększenie wysokiego napięcia w lampie rentgenowskiej spowoduje:',
       ...
       explanation = 'Podwojenie napięcia: $lambda_{min} = \dfrac{hc}{eU}$, wiec 2x U -> lambda_min/2 (granica krotkofalowa maleje dwukrotnie). Natezenie promieniowania rosnie proporcjonalnie do U^2.'
...
UPDATE public.questions
   SET text = 'Widmo charakterystyczne serii K otrzymamy po wybiciu elektronu z powłoki:',
       ...
       explanation = 'Seria K: elektron z powłoki K (pierwszej, najblizszej jadra) jest wybijany, a elektrony z wyższych powłok (L, M...) "spadaja" na wolne miejsce, emitujac fotony charakterystyczne.'
...
UPDATE public.questions
   SET text = 'Rentgenowska tomografia komputerowa:',
       ...
       explanation = 'Tomografia komputerowa (CT) analizuje różne stopnie pochłaniania wiązki RTG przez tkanki. Na tej podstawie rekonstruuje obraz przekroju ciała (nie wykorzystuje pola magnetycznego - to MRI).'
...
UPDATE public.questions
   SET text = 'Najmniejszy element objętościowy analizowany w tomografii komputerowej nazywamy',
       ...
       explanation = 'Woksel (voxel = volume element) to najmniejszy element objętościowy w CT/MRI. Piksel to element 2D obrazu. Woksel ma wymiary: szerokość x wysokosc x grubość warstwy.'
...
UPDATE public.questions
   SET text = 'Projekcja w CAT jest określona wzorem ($I$ - natężenie wiązki padającej, I - natężenie wiązki o przechodzącej, d - grubość woksla)',
       options = '[{"id":"a","text":"$P = d \\ln(\\dfrac{I0}{I}) i jest rowna iloczynowi wspołczynnikow pochłaniania woksli przez ktore przechodzi o promieniowanie$"},{"id":"b","text":"$P = (\\dfrac{1}{d}) \\ln(\\dfrac{I0}{I}) i jest rowna iloczynowi wspołczynnikow pochłaniania woksli przez ktore o przechodzi promieniowanie$"},{"id":"c","text":"$P = (\\dfrac{1}{d}) \\ln(\\dfrac{I0}{I}) i jest rowna sumie wspołczynnikow pochłaniania woksli przez ktore o przechodzi promieniowanie$"},{"id":"d","text":"$P = d \\ln(\\dfrac{I0}{I}) i jest rowna sumie wspołczynnikow pochłaniania woksli przez ktore przechodzi o promieniowanie$"}]'::jsonb,
       explanation = 'Projekcja w CAT: $P = (\dfrac{1}{d})·\ln(\dfrac{I0}{I}) = \\sigma\mui (suma$, nie iloczyn!). Logarytm przekształca osłabienie wykładnicze I=I₀·e^(-Σμᵢ· d) w sumę liniową. To pozwala na rekonstrukcję obrazu algorytmem.'
...
UPDATE public.questions
   SET text = 'Skala Hounsfielda',
       ...
       explanation = 'Skala Hounsfielda: $HU = 1000·(\\mu-\mu_{woda})/\mu_{woda}$. Większy μ (pochłanianie, nie rozpraszanie!) → większy HU → JAŚNIEJSZY piksel. Woda=0, powietrze=-1000, kość kompaktowa=+1000. To liniowa skala pochłaniania względem wody.'
...
UPDATE public.questions
   SET text = 'W tomografach drugiej generacji zastosowano wiązkę:',
       ...
       explanation = 'CT 2. generacji: wiazka wachlarzowa (ok. 10 stopni), kilka detektorów, przesuw liniowy + obrot. Szybsze niż 1. generacja dzieki pomiarowi kilku projekcji jednoczesnie.'
...
UPDATE public.questions
   SET text = 'W tomografach trzeciej generacji wykorzystuje się wiązki rentgenowskie:',
       ...
       explanation = 'CT 3. generacji: wiazka wachlarzowa o rozwartości ok. 30-60 stopni, obejmuje caly przekroj pacjenta. Lampa i detektory obracaja się razem o 360 stopni. Czas: ok. 2-10 sekund.'
...
UPDATE public.questions
   SET text = 'Zwiększenie generacji tomografu rentgenowskiego wiąże się ze zwiększeniem:',
       ...
       explanation = 'Wyzsze generacje CT = wiecej detektorów, szybsze skanowanie, krótsza ekspozycja, mniejsza dawka promieniowania dla pacjenta przy lepszej jakosci obrazu.'
 WHERE id = 'biofiz-w4-027';

UPDATE public.questions
   SET text = 'Czwarta generacja tomografów rtg składa się z:',
       options = '[{"id":"a","text":"nieruchomej lampy rtg i ruchomej matrycy detektorów obracających się w sposób ciągły wokół pacjenta. Wykorzystuje się wiązkę wachlarzykowatą o kącie rozwartości 180o"},{"id":"b","text":"dookólnej matrycy detektorów i ruchomej lampy rtg obracającej w sposób ciągły wokół pacjenta. Wykorzystuje się wiązkę wachlarzykowatą o kącie rozwartości 30o"},{"id":"c","text":"ruchomej matrycy detektorów i ruchomej lampy rtg obracających się w sposób ciągły wokół pacjenta. Wykorzystuje się wiązkę wachlarzykowatą o kącie rozwartości 30o"},{"id":"d","text":"dookólnej matrycy detektorów i ruchomej lampy rtg obracającej w sposób ciągły wokół pacjenta. Wykorzystuje się wiązkę wachlarzykowatą o kącie rozwartości 60o"}]'::jsonb,
...
UPDATE public.questions
   SET text = 'Dawka skuteczna promieniowania jonizującego dla człowieka od tła wynosi:',
       ...
       explanation = 'Naturalne promieniowanie tla (kosmiczne + ziemskie + radon) daje dawkę ok. 2-3 mSv/rok dla przecietnego człowieka. W Polsce ok. 2.5 mSv/rok. To dawka referencyjna do porownan.'
...
UPDATE public.questions
   SET text = 'Rozróżniane różnice absorpcji w rentgenowskiej tomografii komputerowej są rzędu:',
       ...
       explanation = 'CT moze rozróżnić różnice w pochłanianiu na poziomie ok. 0.5% (5 promili), znacznie lepiej niż konwencjonalne RTG (ok. 5-10%). Dlatego CT widzi tkanki miekkie lepiej.'
...
UPDATE public.questions
   SET text = 'Szkodliwość promieniowania rentgenowskiego stosowanego w tomografii rentgenowskiej polega na:',
       ...
       explanation = 'Szkodliwość RTG polega na jonizacji materii - wybijaniu elektronów z atomow. To prowadzi do uszkodzen DNA, bialek, lipidow. Jonizacja moze inicjowac reakcje wolnorodnikowe.'
...
UPDATE public.questions
   SET text = 'Rozwój tomografii komputerowej nakierowany jest na:',
       ...
       explanation = 'Rozwój CT daży do: ( 1) zmniejszenia dawki dla pacjenta (bezpieczeństwo), ( 2) skrocenia czasu skanowania (komfort pacjenta, mniej artefaktów ruchowych). Czesciej, szybciej, bezpieczniej.'
...
UPDATE public.questions
   SET text = 'Tomografia rentgenowska opiera się na różnym stopniu:',
       ...
       explanation = 'CT opiera się na różnym stopniu pochłaniania (absorpcji) promieniowania RTG przez różne tkanki. Różne gęstości i skladz chemiczny = różne współczynniki pochłaniania = rozny obraz.'
...
UPDATE public.questions
   SET text = 'Dawki pochłonięte przez pacjenta podczas tomografii rentgenowskiej:',
       ...
       explanation = 'Dawka podczas CT (5-25 mSv) jest znacznie większa od rocznej dawki tla (ok. 2.5 mSv). Jedno badanie CT glowy to ok. 2 mSv, CT brzucha ok. 10-15 mSv.'
...
UPDATE public.questions
   SET text = 'Skala Hounsfielda (HU) to ilościowa skala radiologiczną w tomografii komputerowej, opierająca się na pomiarze osłabienia promieniowania rentgenowskiego. Wartość 0 HU określa:',
...
UPDATE public.questions
   SET text = 'Źródłem pola magnetycznego mogą być',
       ...
       explanation = 'Źródła pola magnetycznego: magnesy trwale i prądy elektryczne (w tym elektromagnesy - zwoje z prądem). Nieruchome ładunki tworzą tylko pole elektryczne.'
...
UPDATE public.questions
   SET text = 'Indukcja pola magnetycznego w solenoidzie jest proporcjonalna do',
       ...
       explanation = 'Indukcja w solenoidzie: $B = mu_{0} \cdot n \cdot I$, gdzie n = N/L (liczba zwoi na jednostke długości). Proporcjonalna do I i N, odwrotnie do L.'
...
UPDATE public.questions
   SET text = 'Pole magnetyczne wewnątrz długiego solenoidu jest',
       ...
       explanation = 'Pole wewnątrz długiego solenoidu jest jednorodne (B = const). Kierunek okresla regułą prawej dłoni (palce - kierunek prądu, kciuk - kierunek B).'
...
UPDATE public.questions
   SET text = 'Jądro atomowe posiada niezerowy moment magnetyczny w przypadku, gdy',
       ...
       explanation = 'Jądro ma niezerowy moment magnetyczny gdy ma niezerowy spin. Spin jadra zależy od liczby protonow i neutronow - nieparzysta suma = niezerowy spin.'
...
UPDATE public.questions
   SET text = 'Jądra atomowe mające zerowy spin',
       ...
       explanation = 'Jądra o zerowym spinie: parzystą liczba protonów I parzystą liczba neutronów. Protony i neutrony paruja się, ich spiny się kompensuja.'
...
UPDATE public.questions
   SET text = 'Rezonans jest zjawiskiem, w którym występuje przekaz energii między drgającymi układami',
       ...
       explanation = 'Rezonans: maksymalny przekaz energii gdy częstotliwość wymuszenia = częstotliwość wlasna układu. Amplitudą drgań osiaga maksimum.'
...
UPDATE public.questions
   SET text = 'Rezonans może zachodzić między',
       ...
       explanation = 'Rezonans występuje między sprzężonymi układami drgającymi: wahadłami fizycznymi, obwodami elektrycznymi RLC. Uklady musza byc sprzezone (wymieniac energie).'
...
UPDATE public.questions
   SET text = 'Dla próbki znajdującej się w obszarze bez zewnętrznego pola magnetycznego energię momentów magnetycznych spinów jądrowych są',
       ...
       explanation = 'Bez pola zewnętrznego: momenty magnetyczne jadra mają jednakowa energie niezależnie od kierunku, ustawione chaotycznie - wypadkowa magnetyzacja = 0.'
...
UPDATE public.questions
   SET text = 'Jeżeli umieścimy próbkę w silnym zewnętrznym polu magnetycznym to energie momentów magnetycznych jąder',
       ...
       explanation = 'W zewnętrznym polu B: energie momentów magnetycznych zaleza od kierunku (E = -mu*B*cos(theta)). Momenty rownolegle do B mają nizsza energie.'
...
UPDATE public.questions
   SET text = 'Obsadzenie poziomów energetycznych jąder o spinie połówkowym w zewnętrznym polu magnetycznym opisuje równanie będące rozkładem',
       ...
       explanation = 'Rozkład Boltzmanna: N_nizszy/N_wyzszy = exp(delta_E/(kT)). Wiecej jąder na nizszym poziomie energetycznym (stan rownowagi termicznej).'
...
UPDATE public.questions
   SET text = 'W nieobecności zewnętrznego pola magnetycznego wektor namagnesowania jest',
       ...
       explanation = 'Bez pola zewnętrznego: momenty magnetyczne ustawione chaotycznie (izotropowo), suma wektorowa = 0, magnetyzacja M = 0.'
...
UPDATE public.questions
   SET text = 'Magnetyzacja próbki w zewnętrznym polu magnetycznym jest proporcjonalna do',
       ...
       explanation = 'Magnetyzacja M proporcjonalna do: indukcji B, kwadratu momentu magnetycznego mu^2, liczby jąder N, odwrotnie do temperatury T (prawo Curie).'
...
UPDATE public.questions
   SET text = 'Precesja momentu magnetycznego skierowanego pod kątem względem zewnętrznego pola magnetycznego zachodzi z częstotliwością określoną równaniem',
       ...
       explanation = 'Precesja momentu magnetycznego w polu B z częstotliwością Larmora: $omega_{L} = \gamma \cdot B$, gdzie gamma to współczynnik giromagnetyczny.'
...
UPDATE public.questions
   SET text = 'Rolą pola radiowego (fal elektromagnetycznych z zakresu radiowego) w metodzie NMR jest',
       ...
       explanation = 'Pole RF (o częstotliwości Larmora) wytraca magnetyzacje z kierunku równoległego do B0. Powoduje rezonansowa absorpcje energii i obrót magnetyzacji.'
...
UPDATE public.questions
   SET text = 'Sygnał NMR (sygnał swobodnej precesji) przedstawia wykres, przy czym na osi pionowej jest',
       ...
       explanation = 'Sygnał NMR (FID - free induction decay) to składowa poprzeczna magnetyzacji Mxy - precesujaca i zanikajaca w czasie. Indukuje napięcie w cewce.'
...
UPDATE public.questions
   SET text = 'Czas relaksacji T2 jest czasem potrzebnym na to aby',
       ...
       explanation = 'T2 (spin-spin): czas zaniku skladowej poprzecznej Mxy do 33-37% wartości początkowej. Spowodowany rozfazowaniem spinow.'
...
UPDATE public.questions
   SET text = 'Przyczyną zaniku poprzecznej składowej magnetyzacji są',
       ...
       explanation = 'Zanik Mxy (relaksacja T2): oddziaływania spin-spin między sasiednimi jądrami oraz niejednorodnosc pola magnetycznego (gradienty) powoduja rozfazowanie.'
 WHERE id = 'biofiz-w5-023';

UPDATE public.questions
   SET text = 'Aby składowa podłużna magnetyzacji próbki zmalała do zera należy zastosować impuls',
       options = '[{"id":"a","text":"$2 \\\\pi$"},{"id":"b","text":"$\\dfrac{\\\\pi}{2}$"},{"id":"c","text":"π"},{"id":"d","text":"$\\dfrac{\\\\pi}{4}$"}]'::jsonb,
...
UPDATE public.questions
   SET text = 'Czas relaksacji T2 w ciałach stałych jest',
       ...
       explanation = 'W ciałach stałych T2 << T1. Silne oddzialywania spin-spin powoduja szybki zanik Mxy (krotkie T2). T1 moze byc bardzo dlugie (minuty-godziny).'
...
UPDATE public.questions
   SET text = 'Na obrazach tomograficznych NMR intensywności odcieni szarości poszczególnych piksli odpowiadać będą odpowiednim',
       ...
       explanation = 'Kontrast obrazu NMR zależy od czasów relaksacji T1 i T2 (oraz gęstości protonow). Różne tkanki mają różne T1 i T2.'
...
UPDATE public.questions
   SET text = 'Komórki nowotworowe w porównaniu do komórek zdrowych',
       ...
       explanation = 'Komórki nowotworowe mają dluzsze T1 i T2 niż zdrowe (wiecej wody, inna struktura). To podstawa diagnostyki nowotworow w MRI.'
...
UPDATE public.questions
   SET text = 'Woksel jest to',
       ...
       explanation = 'Woksel (voxel) = volumetric pixel - najmniejsza analizowana OBJĘTOŚĆ w tomografii 3D. Pixel = najmniejszy element obrazu 2D.'
...
UPDATE public.questions
   SET text = 'Mniejszy woksel w tomografii wiąże się z',
       ...
       explanation = 'Mniejszy woksel → WIĘKSZA zdolność rozdzielcza zarówno przestrzenną (3D) jak i planarną (2D). Mniejszy "piksel" → więcej szczegółów. Ale mniejszy woksel → mniej sygnału → większy szum. Trade-off jakość vs czas/szum.'
...
UPDATE public.questions
   SET text = 'Aby otrzymać tomogramy z analizowanego obszaru należy zastosować silne pole magnetyczne B z o nałożonymi gradientami pola magnetycznego wzdłuż',
       ...
       explanation = 'Do obrazowania 3D potrzebne sa gradienty pola w trzech prostopadłych kierunkach (x, y, z). Każdy gradient koduje polozenie w jednym wymiarze.'
...
UPDATE public.questions
   SET text = 'Jeżeli zastosujemy oprócz silnego pola magnetycznego B gradient pola magnetycznego skierowany o wzdłuż osi długiej pacjenta to otrzymamy sygnał od',
       ...
       explanation = 'Gradient wzdłuż z (os dluga pacjenta) wybiera warstwe - tylko jadra w warstwie o odpowiednim B rezonuja przy danej częstotliwości.'
...
UPDATE public.questions
   SET text = 'Zgodnie z równaniem Hilla prędkość skurczu mięśnia',
       ...
       explanation = 'Równanie Hilla: (F+a)(v+b) = const. Prędkość skurczu maleje ze wzrostem obciążenia (nieliniowo). Przy F=F_max, v=0 (skurcz izometryczny).'
...
UPDATE public.questions
   SET text = 'Przeciążenie to stan, w którym siła nacisku jest',
       ...
       explanation = 'Przeciążenie: siła nacisku > ciężar ciała. Przeciążenie n*g oznacza sile n razy większa od normalnego ciężaru. n>1 = Przeciążenie.'
...
UPDATE public.questions
   SET text = 'Podczas skurczu ciśnienie krwi w aorcie, u przeciętnego zdrowego człowieka wynosi około',
       ...
       explanation = 'Ciśnienie skurczowe (systoliczne) ok. 120 mmHg PONAD ciśnienie atmosferyczne. Rzeczywiste ciśnienie w aorcie = 760 + 120 = 880 mmHg.'
...
UPDATE public.questions
   SET text = 'Obniżenie lub podwyższenie ciśnienia w otoczeniu powoduje w gazach znajdujących się w organizmie zmiany określone prawem Boyle’a-Mariotte''a. Zaznacz prawidłową odpowiedź',
       ...
       explanation = 'Prawo Boylei-Mariottea: $p \cdot V = const przy T = const. Spadek ci$śnienia zewnętrznego powoduje wzrost objetosci gazu (pecherzyki powietrza przy wynurzaniu).'
...
UPDATE public.questions
   SET text = 'Naprężenie jest definiowane jako',
       ...
       explanation = 'Naprężenie sigma = F/A (siła / powierzchnią). Jednostka: $Pa = \dfrac{N}{m^{2}}$.'
...
UPDATE public.questions
   SET text = 'Krzywą zależności naprężenia ścinającego od prędkości ścinania dla cieczy newtonowskiej jest',
...
UPDATE public.questions
   SET text = 'Zgodnie z prawem Laplace’a ciśnienie wywierane na ściany naczynia jest',
       ...
       explanation = 'Prawo Laplacea: $p = \dfrac{T}{r} (lub T \cdot \dfrac{2}{r} dla sfery). Ci$śnienie wprost proporcjonalne do napięcia sprężystego T, odwrotnie do promienia r.'
...
UPDATE public.questions
   SET text = 'Opór naczyniowy można obliczyć z prawa Poiseuille''a jako iloraz różnicy ciśnień na końcach przewodu do',
       ...
       explanation = 'Opór naczyniowy R = delta_p / Q (różnica ciśnień / strumień objętościowy). Analogia do prawa Ohma: $R = \dfrac{U}{I}$.'
...
UPDATE public.questions
   SET text = 'Zgodnie z prawem Lamberta-Berra dla roztworów o małym stężeniu',
       ...
       explanation = 'Prawo Lamberta-Beera: $A = \epsilon \cdot c \cdot l. Absorpcja liniowo zale$żna od stężenia c (dla małych stężeń). epsilon to współczynnik absorpcji molowej.'
...
UPDATE public.questions
   SET text = 'Cechą psychologiczną dźwięku nie jest',
       ...
       explanation = 'Struktura widmowa to Cechą FIZYCZNA dźwięku. Cechy psychologiczne: wysokość, głośność, barwa (subiektywne odczucie).'
...
UPDATE public.questions
   SET text = 'Wskaż siły działające na obiekty w roztworze poruszające się ruchem jednostajnym podczas sedymentacji w ultrawirówce:',
       ...
       explanation = 'Przy sedymentacji z v=const: siła odśrodkowa = siła wyporu + siła oporu. F_odśrodkowa = F_wyporu + F_Stokesa.'
...
UPDATE public.questions
   SET text = 'W polarymetrze, zgodnie z prawem Malusa jeżeli kąt pomiędzy polaryzatorem i analizatorem wynosi 90°, to natężenie światła wychodzącego z analizatora jest:',
       ...
       explanation = 'Prawo Malusa: $I = I_{0} \cdot \cos^{2}(\alpha). Dla \alpha = 90$° (polaryzator prostopadły do analizatora): I = 0 (światło nie przechodzi).'
...
UPDATE public.questions
   SET text = 'Proces transportu ciepła na zasadzie unoszenia ciepła za pośrednictwem poruszającej się cieczy lub gazu nazywa się:',
       ...
       explanation = 'Konwekcją to transport ciepła przez ruch masy płynu. Może być naturalna (różnica gęstości) lub wymuszona (wentylator).'
...
UPDATE public.questions
   SET text = 'W danym ośrodku długość fali:',
       ...
       explanation = '$\\lambda = \dfrac{v}{f}$. Długość fali odwrotnie proporcjonalna do częstotliwości. Im wyższa częstotliwość, tym krótsza fala.'
...
UPDATE public.questions
   SET text = 'Który ze strumieni cieplnych zależy od różnicy temperatur skóry i otoczenia?',
       ...
       explanation = 'Strumień konwekcyjny zależy od różnicy temperatur skóry i otoczenia: Q = h*A*(T_skóry - T_otoczenia). h to współczynnik przejmowania ciepła.'
...
UPDATE public.questions
   SET text = 'W teorii pasmowej pojęcie strefa wzbroniona oznacza:',
       ...
       explanation = 'Strefa wzbroniona to minimalną energia potrzebna do przejścia elektronu z pasma walencyjnego do pasma przewodnictwa.'
...
UPDATE public.questions
   SET text = 'Prawo Hooke''a:',
       ...
       explanation = 'Prawo Hookea: $\sigma = E \cdot \epsilon. Liniowa zale$żność naprężenia od odkształcenia względnego. Spełnione tylko dla odkształceń sprężystych.'
...
UPDATE public.questions
   SET text = 'Zmiany wychylenia ($x$) ciała drgającego od czasu ($t$) dla ruchu drgającego tłumionego przedstawia równanie ($A$ - amplituda drgań, λ - współczynnik tłumienia, ω - częstość drgań) o',
       options = '[{"id":"a","text":"$x = A \\cdot e(\\lambdat) \\cdot \\\\sin(\\omegat)$"},{"id":"b","text":"$x = A \\cdot e(-\\omegat) \\cdot \\\\sin(\\lambdat)$"},{"id":"c","text":"$x = A \\cdot e(-\\lambdat) \\cdot \\\\sin(\\omegat)$"}]'::jsonb,
       explanation = 'Drgania tłumione: $x = A \cdot \exp(-\lambda \cdot t) \cdot \\sin(\omega \cdot t)$. Amplituda maleje wykładniczo (exp(-lambda*t)), drgania sinusoidalne.'
...
UPDATE public.questions
   SET text = 'Prawo osłabienia jonizującego promieniowania elektromagnetycznego mówi, że natężenie promieniowania po przejściu przez absorbent',
       ...
       explanation = 'Prawo osłabienia: $I = I_{0} \cdot \exp(-\mu \cdot x). Nat$ężenie maleje wykładniczo z grubością absorbentu x.'
...
UPDATE public.questions
   SET text = 'Wektor namagnesowania definiujemy jako',
       ...
       explanation = 'Wektor namagnesowania M = Σμᵢ/V (suma momentów podzieloną przez objętość). To makroskopowa magnetyzacja próbki. Bez podziału przez V byłaby to po prostu suma momentów - ale chcemy znać "gęstość" magnetyzacji'
...
UPDATE public.questions
   SET text = 'Prawo ciągłości strumienia dla rozgałęzionego obwodu (gdzie Q - natężenie przepływu, indeks n dotyczy rozgałęzień, S – pole przekroju naczynia, v - prędkość przepływu, Σ - oznacza sumowanie po n) wyraża się zależnością',
       options = '[{"id":"a","text":"$Q = \\SigmaQ V n n$"},{"id":"b","text":"$SV = S V n n$"},{"id":"c","text":"$Q = \\SigmaQ n$"},{"id":"d","text":"$Q = \\SigmaQ S n n$"}]'::jsonb,
       explanation = 'Prawo ciągłości przepływu: $Q = suma(Q_{n}). Strumie$ń wchodzący = suma strumieni wychodzących (zachowanie masy).'
...
UPDATE public.questions
   SET text = 'Linię dopasowania do punktów pomiarowych (linię trendu) prowadzimy:',
       ...
       explanation = 'Linią trendu: prowadzona przez prostokąty błędów, jak najbliżej punktów pomiarowych. Nie musi przechodzić przez wszystkie punkty.'
...
UPDATE public.questions
   SET text = 'Pochodna z funkcji In(x) jest równa (x wielkość mierzona)',
       options = '[{"id":"a","text":"$(Inx)\\dfrac{’ = 1}{x}$"},{"id":"b","text":"$(Inx)’ = x2$"},{"id":"c","text":"$(Inx)\\dfrac{’ = x}{2}$"},{"id":"d","text":"$(Inx)’ = x$"}]'::jsonb,
...
UPDATE public.questions
   SET text = 'Defektem masy jądra atomowego nazywamy różnicę pomiędzy',
       ...
       explanation = 'Defekt masy: różnica między sumą mas składników (nukleonów) a masą jądra. delta_m = Z*m_p + N*m_n - M_jądra. Energia wiązania = delta_m * c^2.'
...
UPDATE public.questions
   SET text = 'Współczynnik dyfuzji, dla cząsteczek kulistych:',
       ...
       explanation = 'Równanie Stokesa-Einsteina: $D = \dfrac{kT}{6 \cdot \pi \cdot eta \cdot r}$. D proporcjonalne do T, odwrotnie proporcjonalne do eta i r.'
...
UPDATE public.questions
   SET text = 'Precesja momentu magnetycznego skierowanego pod kątem względem zewnętrznego pola magnetycznego (B) zachodzi z częstotliwością określoną równaniem',
       ...
       explanation = 'Częstotliwość precesji w polu magnetycznym to częstotliwość Larmora: $omega_{L} = \gamma \cdot B$.'
...
UPDATE public.questions
   SET text = 'W polarymetrze zgodnie z prawem Malusa jeżeli kąt pomiędzy polaryzatorem i analizatorem wynosi 0⁰, to natężenie światła wychodzącego z analizatora jest',
       ...
       explanation = 'Prawo Malusa: $I = I_{0} \cdot \cos^{2}(\alpha). Dla \alpha = 0$° (równoległe płaszczyzny): I = I_0 (pełne natężenie przechodzi).'
...
UPDATE public.questions
   SET text = 'Zgodnie z równaniem Einsteina lepkość roztworu zawierającego cząsteczki kuliste zależy od',
       ...
       explanation = 'Równanie Einsteina: $eta = eta_{0} \cdot (1 + 2$.5*phi), gdzie phi to ułamek objętościowy (V_cząstek/V_roztworu). Lepkość zależy od phi.'
...
UPDATE public.questions
   SET text = 'Objętość cieczy przepływającej laminarnie przez rurkę o sztywnych ścianach (przy jednakowej różnicy ciśnień na końcach naczynia)',
       ...
       explanation = 'Prawo Poiseuille: $Q = \dfrac{\pi \cdot r^{4} \cdot delta_{p}}{8 \cdot eta \cdot L}. Q odwrotnie proporcjonalne do lepko$ści eta.'
...
UPDATE public.questions
   SET text = 'Wykres zależności współczynnika lepkości cieczy newtonowskiej od szybkości ścinania jest',
       ...
       explanation = 'Ciecz newtonowska: lepkość nie zależy od szybkości ścinania. Wykres eta vs (dv/dy) to linią poziomą.'
...
UPDATE public.questions
   SET text = 'Jednostką lepkości względnej cieczy jest',
       options = '[{"id":"a","text":"Pa s"},{"id":"b","text":"$\\dfrac{Pa}{s}$"},{"id":"c","text":"1 (wielkość bezwymiarowa)"},{"id":"d","text":"$\\dfrac{Ns}{m}$"}]'::jsonb,
...
UPDATE public.questions
   SET text = 'Wykres zależności natężenia (I) monochromatycznego promieniowania gamma po przejściu przez absorbent, od grubości absorbentu (x), przedstawia wykres',
       ...
       explanation = 'Wykres IV poprawnie przedstawia zależność natężenia promieniowania gamma od grubości absorbentu. Zjawisko to opisuje prawo osłabienia (absorpcji) promieniowania, które ma charakter wykładniczy. Wzór opisujący tę zależność to: $I(x) = I_{0} \cdot (e^{-mi \cdot x}).$'
...
UPDATE public.questions
   SET text = 'Przy przejściu fali przez granicę dwóch ośrodków',
       ...
       explanation = 'Przy przejściu przez granicę ośrodków: częstotliwość nie zmienia się (f=const), zmienia się długość fali ($\\lambda = \dfrac{v}{f}$, v zależy od ośrodka).'
...
UPDATE public.questions
   SET text = 'Ebulizacją nazywamy zjawisko',
       ...
       explanation = 'Ebulizacją = wrzenie płynów tkankowych. Występuje przy gwałtownym spadku ciśnienia (choroba dekompresyjna).'
...
UPDATE public.questions
   SET text = 'Projekcja w CAT jest określona wzorem (I₀ - natężenie wiązki padającej, I - natężenie wiązki o przechodzącej, d- grubość woksla)',
       options = '[{"id":"a","text":"$P = (\\dfrac{1}{d})\\ln(\\dfrac{I0}{I}) i jest rowna sumie wspołczynnikow pochłaniania woksli przez ktore o przechodzi promieniowanie$"},{"id":"b","text":"$P = d \\ln(\\dfrac{I0}{I}) i jest rowna sumie wspołczynnikow pochłaniania woksli przez ktore przechodzi o promieniowanie$"},{"id":"c","text":"$P = d \\ln(\\dfrac{I0}{I}) i jest rowna iloczynowi wspołczynnikow pochłaniania woksli przez ktore przechodzi o promieniowanie$"},{"id":"d","text":"$P = (\\dfrac{1}{d})\\ln(\\dfrac{I0}{I}) i jest rowna iloczynowi wspołczynnikow pochłaniania woksli przez ktore o przechodzi promieniowanie$"}]'::jsonb,
...
UPDATE public.questions
   SET text = 'Dawką pochłoniętą nazywamy',
       ...
       explanation = 'Dawka pochłonięta D = E/m (energia zaabsorbowana / masa). Jednostka: $Gy = \dfrac{J}{kg}$.'
...
UPDATE public.questions
   SET text = 'Co nazywamy dyspersją przenikalności dielektrycznej tkanek',
       ...
       explanation = 'Dyspersją dielektryczna: zależność przenikalności od częstotliwości pola elektrycznego. W tkankach występują dyspersje alfa, beta, gamma.'
...
UPDATE public.questions
   SET text = 'Falą akustyczna',
       ...
       explanation = 'Falą akustyczna to falą sprężysta i podłużna. Wymaga ośrodka materialnego (nie rozchodzi się w próżni). W ciałach stałych może być też poprzeczną.'
...
UPDATE public.questions
   SET text = 'Moduł Younga mięśnia',
       ...
       explanation = 'Moduł Younga mięśnia rośnie ze wzrostem odkształcenia - mięsień jest nieliniowo sprezysty. Im bardziej rozciagniety, tym sztywniejszy (większa wartość E).'
...
UPDATE public.questions
   SET text = 'Dawką ekspozycyjną nazywamy:',
       ...
       explanation = 'Dawka ekspozycyjną (kerama): iloraz sumy ładunków jonów jednego znaku wytworzonych przez promieniowanie X lub gamma do masy powietrza. Jednostka: C/kg.'
...
UPDATE public.questions
   SET text = 'Zakres słyszalnych częstotliwości rozciąga się:',
       ...
       explanation = 'Zakres slyszalny: 16-20 Hz do 20 kHz (20 000 Hz). Ponizej 16 Hz - infradZwieki, powyzej 20 kHz - ultradZwieki. Zakres zmienia się z wiekiem.'
...
UPDATE public.questions
   SET text = 'Grubość połówkowego pochłaniania jest to grubość ciała po przejściu przez którą',
       ...
       explanation = 'Grubość polowkowa (HVL): grubość materialu, po przejściu ktorej natężenie promieniowania maleje o polowe. Zależy od energii promieniowania i materialu.'
...
UPDATE public.questions
   SET text = 'Analiza spektralna polega na wyznaczaniu',
       ...
       explanation = 'Analiza spektralna: identyfikacja składników substancji na podstawie ich charakterystycznych długości fal (linii widmowych). Każdy pierwiastek ma unikalne widmo.'
...
UPDATE public.questions
   SET text = 'Zależność siły rozwijanej przez mięsień jako funkcji jego wydłużenia',
       ...
       explanation = 'Zależność siła-wydluzenie dla mięśnia jest nieliniowa i wykazuje histerezę - krzywa przy rozciaganiu rozni się od krzywej przy kurczeniu (rozpraszanie energii).'
...
UPDATE public.questions
   SET text = 'W celu wyznaczenia prędkości krwi w naczyniach metodą ultrasonografii dopplerowskiej wystarczy znać:',
       ...
       explanation = 'Metodą Dopplera: potrzebna częstotliwość fali padającej i odbitej (do obliczenia przesuniecia Dopplerowskiego) oraz prędkość fali w tkankach (do przeliczenia na prędkość krwi).'
 WHERE id = 'biofiz-w5-229';

UPDATE public.questions
   SET text = 'Falą elektromagnetyczna jest falą',
       ...
       explanation = 'Falą EM jest falą poprzeczną (E i B prostopadle do kierunku propagacji). Może rozchodzić się w próżni z prędkością c = 3*$10^{8}$ m/s.'
...
UPDATE public.questions
   SET text = 'Ultradźwięki',
       ...
       explanation = 'Ultradźwięki: fale akustyczne o częstotliwości powyzej 20 kHz (ponad próg slyszalnosci). Uzywane w USG diagnostycznym i terapeutycznym.'
...
UPDATE public.questions
   SET text = 'W półprzewodnikach domieszkowanych typu p',
       ...
       explanation = 'Półprzewodnik typu p: domieszka akceptorowa (np. bor w krzemie) przyjmuje elektron z pasma walencyjnego, tworzac dziurę. Nosniki wiekszosciowe: dziury.'
...
UPDATE public.questions
   SET text = 'Błąd systematyczny jest to błąd spowodowany',
       ...
       explanation = 'Błąd systematyczny: stały błąd spowodowany np. zla kalibracja przyrządu, zla skalą. Powtarza się w kazdym pomiarze w tym samym kierunku.'
 WHERE id = 'biofiz-w5-233';

UPDATE public.questions
   SET text = 'Praca objętościowa serca w spoczynku wynosi około',
       options = '[{"id":"a","text":"$1,1 \\dfrac{J}{skurcz}$"},{"id":"b","text":"$11 \\dfrac{W}{skurcz}$"},{"id":"c","text":"$11 \\dfrac{J}{skurcz}$"},{"id":"d","text":"$1,1 \\dfrac{W}{skurcz}$"}]'::jsonb,
       explanation = 'Praca objętościowa serca w spoczynku: ok. 1-1.2 J/skurcz (ciśnienie * objetosc wyrzutowa). Moc serca: ok. 1.3 W w spoczynku.'
...
UPDATE public.questions
   SET text = 'Siła lepkości R działająca na kulkę o promieniu r opadającą z prędkością v w cieczy o lepkości η wyraża się wzorem',
       options = '[{"id":"a","text":"$R = 8 \\cdot \\\\pi \\cdot r \\cdot η \\cdot v$"},{"id":"b","text":"$R = 6 \\cdot \\\\pi \\cdot r4 \\cdot η \\cdot v$"},{"id":"c","text":"$R = 6 \\cdot \\\\pi \\cdot r2 \\cdot η \\cdot v$"},{"id":"d","text":"$R = 6 \\cdot \\\\pi \\cdot r \\cdot η \\cdot v$"}]'::jsonb,
       explanation = 'Siła Stokesa (opor lepki): $F = 6 \cdot \pi \cdot eta \cdot r \cdot v$. Proporcjonalna do lepkości eta, promienia r i prędkości v. Dziala przeciwnie do ruchu.'
...
UPDATE public.questions
   SET text = 'Aby otrzymać tomogramy z analizowanego obszaru należy zastosować silne pole magnetyczne B o z nałożony i gradientami pola magnetycznego wzdłuż',
       ...
       explanation = 'W MRI do lokalizacji sygnalu stosuje się gradienty pola magnetycznego w trzech prostopadłych kierunkach (x, y, z). Pozwala to na rekonstrukcję 3D.'
...
UPDATE public.questions
   SET text = 'Czas wygaszania fluorescencji w porównaniu do czasu wygaszania fosforescencji jest zazwyczaj',
       ...
       explanation = 'Czas wygaszania fluorescencji ($10^{-9}$ - $10^{-6}$ s) jest znacznie krótszy niż fosforescencji ($10^{-3}$ s do godzin). Fosforescencja wymaga zmiany spinu (przejscie zabronione).'
...
UPDATE public.questions
   SET text = 'Lepkość cieczy',
       ...
       explanation = 'Lepkość cieczy: $eta = A \cdot \exp(\dfrac{W}{kT})$. Zależy wykładniczo od odwrotności temperatury. Wzrost T -> spadek lepkości (luzniejsze wiazania między czasteczkami).'
...
UPDATE public.questions
   SET text = 'Krzywa przedstawiona na załączonym wykresie opisuje zależność',
       ...
       explanation = 'Dyspersja dielektryczna: przenikalność dielektryczna maleje ze wzrostem częstotliwości (dipole nie nadazaja za zmianami pola). Krzywa relaksacyjna.'
...
UPDATE public.questions
   SET text = 'W polach elektromagnetycznych o niskich częstotliwościach oddziałujących na materiał biologiczny',
       ...
       explanation = 'Przy niskich częstotliwościach: przenikalność dielektryczna wysoką (dipole nadazaja za polem), pole elektryczne przenika przez tkanki, tlumieniu ulega pole magnetyczne.'
...
UPDATE public.questions
   SET text = 'Stosunek zmiany objętości przepływającej cieczy od czasu przepływu przez naczynie nazywa się',
       ...
       explanation = 'Strumien objętości Q = dV/dt (objetosc przeplywajaca w jednostce czasu). Jednostka: m^3/s. Równanie ciaglosci: $Q = const w rurce$.'
...
UPDATE public.questions
   SET text = 'Częstotliwość Larmora w związku z NMR zależy od',
       ...
       explanation = 'Częstotliwość Larmora: $omega_{L} = \gamma \cdot B$, gdzie gamma to współczynnik giromagnetyczny jądra, B to indukcja pola magnetycznego. Zależy od obu wielkości.'
...
UPDATE public.questions
   SET text = 'We wzorze Einsteina na lepkość roztworów zawierających cząsteczki kuliste symbol Φ oznacza η = η (1+2,5 Φ)',
       ...
       explanation = 'We wzorze Einsteina phi to ulamek objetosciowy - stosunek objętości cząstek rozproszonych do objętości roztworu. eta_wzgl = 1 + 2.5*phi.'
...
UPDATE public.questions
   SET text = 'Wzór Svedberga pozwala',
       ...
       explanation = 'Wzór Svedberga: $M = s \cdot R \cdot \dfrac{T}{[D} \cdot (1-v \cdot \rho)]$. Pozwala wyznaczyć masę molową z pomiarów współczynnika sedymentacji s i dyfuzji D.'
...
UPDATE public.questions
   SET text = 'Poziom natężenia dźwięku wynosi 1 B (bel), jeżeli jego natężenie :',
       ...
       explanation = '1 bel = 10 decybeli. L = log(I/I_0), gdzie I_0 to natężenie progowe. L = 1 B oznacza I = 10*I_0 (10-krotne natężenie).'
...
UPDATE public.questions
   SET text = 'Długość wiązania r jest odległością dla której ∩',
       ...
       explanation = 'Długość wiązania r_0 to odległość, dla której energia potencjalna jest minimalną (minimum krzywej Morse''a lub Lennarda-Jonesa). Stan rownowagi cząsteczki.'
...
UPDATE public.questions
   SET text = 'Czas relaksacji T1 jest czasem potrzebnym na to aby',
       ...
       explanation = 'T1 (spin-siec): czas relaksacji podluznej. Składowa Mz narastа od 0 do 63-67% wartości rownowazonej M_0 (lub maleje do 33-37% przy odwroceniu).'
...
UPDATE public.questions
   SET text = 'Tworzenie par elektron-pozyton zachodzi gdy kwant elektromagnetycznego promieniowania jonizującego znajdzie się w pobliżu jądra atomowego, a jego energia',
       ...
       explanation = 'Kreacja pary e-/e+: energia fotonu > 2*m_e*c^2 = 1.022 MeV (podwojna masa spoczynkowa elektronu). Foton zamienia się na pare elektron-pozyton.'
...
UPDATE public.questions
   SET text = 'Z zależności siły międzyatomowej F od odległości r pomiędzy atomami (wykres) można stwierdzić, że w miarę zbliżania się do atomów do siebie siły',
       ...
       explanation = 'Siły miedzyatomowe: przy malych odleglosciach dominuja siły odpychania (szybko malejace), przy wiekszych - siły przyciagania. Rownowaga przy r = r_0.'
...
UPDATE public.questions
   SET text = 'Częstotliwość drgań',
       ...
       explanation = 'Częstotliwość f = 1/T (odwrotność okresu). Ilość drgań w jednostce czasu. W ruchu harmonicznym prostym jest stała. Jednostka: Hz.'
...
UPDATE public.questions
   SET text = 'Jądro atomowe posiada niezerowy moment magnetyczny w przypadku, gdy',
       ...
       explanation = 'Moment magnetyczny jadra występuje gdy spin jadrowy I != 0. Spin jest sumа spinow i momentow pędu nukleonow. Oba musza byc niezerowe.'
...
UPDATE public.questions
   SET text = 'Wskaż prawidłowe stwierdzenie:',
       ...
       explanation = 'W kapilarach krew płynie wolno (ok. 0.5-1 mm/s) aby umożliwić wymianę gazowa i substancji odzywczych. Duza sumaryczna powierzchnia kapilar zmniejsza prędkość.'
...
UPDATE public.questions
   SET text = 'Zgodnie z prawem Henry’ego',
       ...
       explanation = 'Prawo Henry''ego: rozpuszczalność gazu jest proporcjonalna do ciśnienia cząstkowego tego gazu nad roztworem. c = k_H * p.'
...
UPDATE public.questions
   SET text = 'Czas relaksacji T1 w ciałach stałych jest',
       ...
       explanation = 'W ciałach stałych T2 << T1. T2 (spin-spin) jest krotki z powodu silnych oddzialywan dipolowych między spinami w sztywnej strukturze. T1 moze byc dlugi.'
...
UPDATE public.questions
   SET text = 'Komórki mięśniowe',
       ...
       explanation = 'Komórki mięśniowe poprzecznie prazkowane mogą zawierać wiele jąder (syncytium). Składają się z sarkomerów - jednostek kurczliwych zawierajacych miofilamenty.'
...
UPDATE public.questions
   SET text = 'Na podstawie pomiaru współczynnika rozpraszania światła przez koloid można wyliczyć',
       ...
       explanation = 'Pomiar rozpraszania światła (np. metoda nefelometryczna) pozwala wyznaczyć masę cząsteczkową polimerow i koloidow na podstawie równania Rayleigha.'
...
UPDATE public.questions
   SET text = 'Prawo rozpadu promieniotwórczego mówi, że liczba jąder rozpadających się w jednostce czasu jest proporcjonalna do',
       ...
       explanation = 'Prawo rozpadu: $\dfrac{dN}{dt} = -\lambda \cdot N. Liczba rozpadow jest proporcjonalna do liczby j$ąder N, które jeszcze nie uległy rozpadowi. Lambda to stała rozpadu.'
...
UPDATE public.questions
   SET text = 'kPa (kilopaskal) oznacza',
       ...
       explanation = 'kPa = kilopaskal = $10^{3}$ Pa = 1000 Pa. Przedrostek kilo oznacza 1000. Ciśnienie atmosferyczne to ok. 101 kPa.'
...
UPDATE public.questions
   SET text = 'W wiązaniu van der Waalsa zasięg sił odpychania jest',
       ...
       explanation = 'W wiązaniu van der Waalsa siły odpychania mają znacznie krótszy zasięg niż siły przyciągania. Odpychanie dominuje przy malych odleglosciach (nakladanie powlok elektronowych).'
...
UPDATE public.questions
   SET text = 'Jak wpływa zwiększenie średnicy naczynia na szybkość przepływu cieczy?',
       ...
       explanation = 'Prawo ciaglosci: $Q = A \cdot v = const. Dwukrotne zwi$ększenie pola przekroju A powoduje dwukrotne zmniejszenie prędkości v (przy stalym przeplywie).'
...
UPDATE public.questions
   SET text = 'W ruchu harmonicznym prostym (nietłumionym) działają siły',
       ...
       explanation = 'Ruch harmoniczny prosty (nietlumiony): dziala tylko siła sprezysła (F = -kx). Energia mechaniczna jest zachowana (E_k + E_p = const).'
...
UPDATE public.questions
   SET text = 'Próg słyszalności',
       ...
       explanation = 'Próg słyszalności: minimalne natężenie dźwięku słyszalne przez ucho. Przy 1 kHz: $I_{0} = 10^{-12} \dfrac{W}{m^{2}}$. Zależy od częstotliwości (krzywa izofoniczna).'
...
UPDATE public.questions
   SET text = 'W ruchu drgającym tłumionym działają siły',
       ...
       explanation = 'Ruch tlumiony: dziala siła sprezysła i siła oporu (tarcia). Energia mechaniczna nie jest zachowana - czesc zamienia się w cieplo. Amplituda maleje.'
...
UPDATE public.questions
   SET text = 'W naczyniach sprężystych wzrost ciśnienia napędowego powoduje rozciąganie się ściany naczynia',
       ...
       explanation = 'W naczyniach sprężystych wzrost ciśnienia rozciaga sciane, zwiekszajac srednice. Wedlug prawa Poiseuille''a R ~ 1/r^4, wiec opór maleje.'
...
UPDATE public.questions
   SET text = 'Moduł Younga',
       ...
       explanation = 'Moduł Younga E = sigma/epsilon. Określa właściwości sprezysłe ciała - im większy E, tym sztywniejszy material (trudniej go odksztalcic).'
...
UPDATE public.questions
   SET text = 'Poziom natężenia dźwięku',
       ...
       explanation = 'Poziom natężenia dźwięku L = log(I/I_0), gdzie I_0 = $10^{-12}$ W/m^2. Jednostka: bel (B) lub decybel (dB). 1 B = 10 dB.'
...
UPDATE public.questions
   SET text = 'Dwukrotne zwiększenie wysokiego napięcia w lampie rentgenowskiej spowoduje dwukrotne',
       ...
       explanation = 'Lambda_min = hc/(eU). Dwukrotne zwiększenie napięcia U: lambda_min maleje o polowe (granica krotkofalowa przesuwa się). Natezenie RTG rosnie.'
...
UPDATE public.questions
   SET text = 'W przypadku sił jądrowych odpowiedzialnych m.in. za wiązanie nukleonów w jądrze atomu NIE jest prawdziwe stwierdzenie, że są to siły',
       ...
       explanation = 'Siły jadrowe: krotki zasieg (ok. $10^{-15}$ m), charakter nasyceniowy (każdy nukleon oddzialuje tylko z sasiadami), znacznie silniejsze niż siły elektromagnetyczne.'
...
UPDATE public.questions
   SET text = 'Zależność przewodności i przenikalności dielektrycznej od częstotliwości pola elektromagnetycznego jest nazywana',
       ...
       explanation = 'Dyspersją: zależność wielkości od częstotliwości. Dyspersją dielektryczna: przenikalność i przewodność zaleza od częstotliwości pola elektrycznego.'
...
UPDATE public.questions
   SET text = 'Prędkość fali USG',
       ...
       explanation = 'Prędkość USG: w tkankach miękkich ok. 1540 m/s (nieco większa niż w wodzie - 1480 m/s), w kościach ok. 3000-4000 m/s (znacznie większa).'
...
UPDATE public.questions
   SET text = 'Jednostką współczynnika lepkości cieczy nie jest',
       ...
       explanation = 'Jednostki lepkości: Pa*s = Ns/m^2 = kg/(m*s). Pa/s NIE jest jednostka lepkości - wymiar nie zgadza się (lepkość = naprezenie / prędkość scinania).'
...
UPDATE public.questions
   SET text = 'Środki kontrastujące w prześwietleniu rentgenowskim muszą spełniać warunki',
       ...
       explanation = 'Środki kontrastowe: dużą liczba atomową (silne pochłanianie RTG), nie wchodzą w reakcje metaboliczne, nie sa toksyczne. Np. bar, jod.'
...
UPDATE public.questions
   SET text = 'Przejście elektronu z powłoki 3s1 atomu sodu na powłokę 3s2p5 atomu chloru',
       ...
       explanation = 'Sod oddaje elektron chlorowi - powstają jony Na+ i Cl- zwiazane elektrostatycznie. To typowe wiązanie jonowe (NaCl - sol kuchenna).'
...
UPDATE public.questions
   SET text = 'Kąt skręcenia płaszczyzny polaryzacji (α) dla roztworu o grubości (d), stężeniu c można obliczyć z równania',
       options = '[{"id":"a","text":"$\\\\alpha = \\\\alpha \\cdot c \\cdot d2 \\\\lambda$"},{"id":"b","text":"$\\\\alpha = \\\\alpha \\cdot c \\cdot d \\\\lambda$"},{"id":"c","text":"$\\\\alpha = \\\\alpha \\cdot \\dfrac{c}{d2} \\\\lambda$"},{"id":"d","text":"$\\\\alpha = \\\\alpha \\cdot c2d \\\\lambda$"}]'::jsonb,
       explanation = 'Kąt skrętu: $\alpha = [\alpha]_lambda \cdot c \cdot d$, gdzie [alpha] to skrecosc wlasciwa (zależy od długości fali lambda), c - stężenie, d - długość drogi.'
...
UPDATE public.questions
   SET text = 'Reologiczny model Maxwella składa się elementu lepkiego (tłoczek z cieczą) i sprężystego (sprężyną) połączonych',
       options = '[{"id":"a","text":"szeregowo"},{"id":"b","text":"równolegle"},{"id":"c","text":"równolegle z dołączonym szeregowo elementem sprężystym"},{"id":"d","text":"równolegle z dołączonym szeregowo elementem lepkim"}]'::jsonb,
       explanation = 'Model Maxwella: element lepki (tlumik) i sprezysty (sprężyną) polaczone szeregowo. Opisuje relaksacje naprezenia. Model Kelvina-Voigta: równolegle.'
...
UPDATE public.questions
   SET text = 'Prawo ciągłości strumienia można wyrazić w postaci ($S$ - pole przekroju naczynia, v - prędkość cieczy)',
       options = '[{"id":"a","text":"$S1 \\cdot v1 = S2 \\cdot v2$"},{"id":"b","text":"$S1 \\cdot v2 = S2 \\cdot v1$"},{"id":"c","text":"S1 * v1 < S2 * v2"},{"id":"d","text":"S1 * v1 > S2 * v2"}]'::jsonb,
...
UPDATE public.questions
   SET text = 'Graniczną liczbę lepkościową wyznacza się przez',
       ...
       explanation = 'Graniczna liczba lepkościowa [eta] = lim(c->0) [eta_sp/c]. Otrzymuje się ja przez ekstrapolację do stężenia zerowego. Charakteryzuje cząsteczkę polimeru.'
...
UPDATE public.questions
   SET text = 'Zgodnie z prawem ciągłości strumienia, zmniejszenie pola przekroju przewodu spowoduje, że prędkość przepływu',
       ...
       explanation = 'Prawo ciągłości: $S \cdot v = const. Zmniejszenie przekroju S powoduje wzrost pr$ędkości v. Przepływ objetosciowy pozostaje stały.'
...
UPDATE public.questions
   SET text = 'Aeroembolizm to zjawisko',
       ...
       explanation = 'Aeroembolizm (choroba kesonowa): tworzenie się pecherzykow gazu (glownie azotu) we krwi przy zbyt szybkim wyplywaniu z głębokości. Zatory gazowe.'
...
UPDATE public.questions
   SET text = 'Ściany tętnic są',
       ...
       explanation = 'Ściany tętnic (sprezysłe) magazynuja energie potencjalna sprężystości podczas skurczu serca. Podczas rozkurczu energia ta napedza krew - efekt Windkessela.'
...
UPDATE public.questions
   SET text = 'Izomeria optyczna to zjawisko',
       ...
       explanation = 'Izomeria optyczna: wystepowanie substancji w dwoch formach (enancjomery) - prawo- i lewoskrętnej. Zwiazane z asymetrycznym atomem wegla (chiralnosc).'
...
UPDATE public.questions
   SET text = 'Funkcje stanu to:',
       ...
       explanation = 'Funkcje stanu: U (energia wew.), H (entalpia), S (entropia), G (ent. swobodna), F (en. swobodna), mu (pot. chem.). Ciepło i praca NIE sa funkcjami stanu.'
...
UPDATE public.questions
   SET text = 'Prezbiopia to:',
       ...
       explanation = 'Prezbiopia = starczowzroczność. Utrata zdolnosci akomodacji z wiekiem (zmniejszona elastycznosc soczewki). Trudnosc widzenia z bliska.'
...
UPDATE public.questions
   SET text = 'Przystosowanie się oka do zmiennych warunków oświetleniowych nazywa się:',
       ...
       explanation = 'Adaptacją oka: przystosowanie do zmiennych warunków oswietlenia (jasnosc/ciemnosc). Akomodacją - dostosowanie do odległości. Refrakcją - zdolność skupiającą.'
...
UPDATE public.questions
   SET text = 'Zasada Prigogine’a jest określona przez stwierdzenie:',
       ...
       explanation = 'Zasada Prigogine''a (twierdzenie o minimum produkcji entropii): w stanie stacjonarnym szybkość tworzenia entropii jest minimalną (ale niezerowa).'
...
UPDATE public.questions
   SET text = 'W odwracalnym procesie izotermiczno-izobarycznym wykonanie pracy nieobjętościowej przez układ jest równe ubytkowi:',
       ...
       explanation = 'W procesie izotermiczno-izobarycznym (T,p=const) maksymalna praca nieobjętosciowa rowna jest zmianie entalpii swobodnej Gibbsa: $W_{max} = -delta_{G}$.'
...
UPDATE public.questions
   SET text = 'Termodynamiczny układ zamknięty:',
       ...
       explanation = 'Układ zamknięty: może wymieniać energie (cieplo, prace) z otoczeniem, ale nie może wymieniać materii. Masa ukladu jest stała.'
...
UPDATE public.questions
   SET text = 'Kątowa zdolność rozdzielcza oka',
       ...
       explanation = 'Kątowa zdolność rozdzielcza oka: odwrotność minimalnego kąta, pod ktorym widac dwa punkty jako oddzielne. Dla oka: ok. 1 minuta kątowa (1/60 stopnia).'
...
UPDATE public.questions
   SET text = 'Kryterium Rayleigha, dotyczące minimalnej odległości między dwoma punktami widzialnymi oddzielnie jest spełnione gdy:',
       ...
       explanation = 'Kryterium Rayleigha: dwa punkty sa rozroznialne gdy maximum dyfrakcyjne jednego pokrywa się z pierwszym minimum drugiego. Okreska granice rozdzielczości.'
...
UPDATE public.questions
   SET text = 'Jeżeli zdolność skupiająca soczewki wynosi 2 dioptrie, to jej ogniskowa wynosi',
       ...
       explanation = 'Zdolność skupiająca D = 1/f. Jesli D = 2 dioptrie, to f = 1/2 m = 0.5 m = 50 cm. Soczewka skupiająca o ogniskowej 50 cm.'
...
UPDATE public.questions
   SET text = 'Obraz otrzymany za pomocą mikroskopu jest',
       ...
       explanation = 'Obraz w mikroskopie: powiekszonу, odwroconу (gora-dol i lewo-prawo), pozornу (powstaje za okularem, widoczny przez okular ale nie można go rzutowac).'
...
UPDATE public.questions
   SET text = 'Definicja entropii Boltzmanna wyraża się wzorem S=klnW, gdzie k oznacza stałą Boltzmanna, a W jest:',
       ...
       explanation = 'Wzór Boltzmanna: $S = k \cdot \ln(W)$. W to prawdopodobienstwo termodynamiczne - liczba mikrostanow odpowiadajacych danemu makrostanowi układu.'
...
UPDATE public.questions
   SET text = 'Przedmiot umieszczony w odległości równej połowie ogniskowej soczewki cienkiej wypukłej daje obraz:',
       ...
       explanation = 'Przedmiot w odległości f/2 od soczewki skupiajacej: obraz pozorny, powiększony 2x, prosty, po tej samej stronie co przedmiot (przed ogniskiem).'
...
UPDATE public.questions
   SET text = 'Astygmatyzm oka nie polega na',
       ...
       explanation = 'Astygmatyzm: różne wartości refrakcji w różnych przekrojach (powierzchnia toryczna). NIE polega na ujemnej amplitudzie akomodacji - to by oznaczało prezbiopia.'
...
UPDATE public.questions
   SET text = 'Parametry stanu to',
       ...
       explanation = 'Parametry stanu: ciśnienie p, temperatura T, objetosc V, ilość moli n. Jednoznacznie okreslaja stan ukladu. Entalpia, entropia - to funkcje stanu.'
...
UPDATE public.questions
   SET text = 'Funkcją stanu nie jest',
       ...
       explanation = 'Ciepło NIE jest Funkcją stanu - zależy od drogi przemiany. Funkcje stanu: U, H, S, G, F - zaleza tylko od stanu poczatkowego i koncowego.'
...
UPDATE public.questions
   SET text = 'Aby zwiększyć zdolność rozdzielczą mikroskopu optycznego wprowadza się między obiektyw i preparat ciecz (olejek immersyjny), której współczynnik załamania n powinien być:',
       ...
       explanation = 'Immersja: ośrodek między obiektywem a preparatem o wspolczynniku załamania n > 1 (olej n=1.5, woda n=1.33). Zwieksza aperture numeryczna A = n*sin(u).'
...
UPDATE public.questions
   SET text = 'Która z wymienionych wielkości fizycznych nie jest funkcją stanu?',
       ...
       explanation = 'Praca NIE jest funkcją stanu - zależy od drogi przemiany. Potencjał chemiczny, entalpia swobodna, energia wewnętrzna - sa funkcjami stanu.'
...
UPDATE public.questions
   SET text = 'Zdolność tworzenia na siatkówce oka obrazów przedmiotów bliskich i dalekich nazwiemy',
       ...
       explanation = 'Akomodacją oka: zdolność zmiany ogniskowej soczewki (przez kurczenie mięśnia rzeskowego) w celu ostrego widzenia na różne odległości.'
 WHERE id = 'biofiz-w5-311';

UPDATE public.questions
   SET text = 'Apertura numeryczna (A) wyrażana jest wzorem ($n$ - współczynnik załamania, u - kąt aperturowy)',
       options = '[{"id":"a","text":"$A = 2u \\cdot sin n$"},{"id":"b","text":"$A = 2n \\cdot sin u$"},{"id":"c","text":"$A = u \\cdot sin n$"},{"id":"d","text":"$A = n \\cdot sin u$"}]'::jsonb,
       explanation = 'Apertura numeryczna: $A = n \cdot \\sin(u)$, gdzie n to współczynnik załamania ośrodka, u to polowa kąta rozwarcia stozka światła wchodzacego do obiektywu.'
...
UPDATE public.questions
   SET text = 'Jeśli kąt padania światła w ośrodku optycznie gęstszym jest większy od kąta granicznego to na granicy ośrodków',
       ...
       explanation = 'Całkowite wewnętrzne odbicie: następuje gdy kąt padania > kąt graniczny. Światło nie przechodzi do ośrodka rzadszego, odbija się calkowicie.'
...
UPDATE public.questions
   SET text = 'Prawo Bragga przedstawia równanie (gdzie: n - kolejne liczby naturalne, λ - długość fali, α - kąt pod którym obserwujemy wzmocnienie, a - odległość między płaszczyznami)',
       options = '[{"id":"a","text":"$n \\cdot \\\\lambda = 2 \\cdot a \\cdot sin2\\\\alpha$"},{"id":"b","text":"$n \\cdot \\\\lambda = a \\cdot sin2\\\\alpha$"},{"id":"c","text":"$2 \\cdot n \\cdot \\\\lambda = a \\cdot sin\\\\alpha$"},{"id":"d","text":"$n \\cdot \\\\lambda = 2 \\cdot a \\cdot sin\\\\alpha$"}]'::jsonb,
       explanation = 'Prawo Bragga: n*$\\lambda = 2 \cdot d \cdot \\\\sin(\\theta)$. Warunek konstruktywnej interferencji fal rozproszonych na plaszczyznach krystalicznych o odległości d.'
...
UPDATE public.questions
   SET text = 'Przesloną aperturową oka jest',
       ...
       explanation = 'Przesloną aperturową oka: tęczówka (iris) z otworem - zrenica. Reguluje ilosc światła wchodzacego do oka. Srednica zrenicy: 2-8 mm.'
