...
import type { AdminHourBucket } from "@/features/admin/server/loadAdminDashboard";

type AdminHourOfDayChartProps = {
  data: AdminHourBucket[];
};

export function AdminHourOfDayChart({ data }: AdminHourOfDayChartProps) {
