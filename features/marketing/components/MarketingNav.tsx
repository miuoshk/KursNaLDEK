  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/[0.08] bg-sidebar/85 backdrop-blur-xl">
      <div className="px-5 sm:px-8 lg:px-12">
        <nav
          className="mx-auto flex h-16 max-w-[1400px] items-center justify-between"
      ...
      {open ? (
        <div
          ...
          className="border-t border-border bg-sidebar px-5 pb-5 pt-3 sm:px-8 md:hidden lg:px-12"
        >
