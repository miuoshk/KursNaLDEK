            ...
            {mode === "confidence" ? (
              ...
              <div className="flex min-h-11 items-center">
                <button
                  ...
                  onClick={onNext}
                  className={cn(
                    "flex min-h-11 w-full items-center justify-center rounded-btn bg-brand-gold px-4 font-body text-body-sm font-semibold text-brand-bg transition-[filter] duration-200",
