/**
 * Insert e_farm_stoma_2026/1 + e_farm_lek_2026/1.
 * ID: FARM-NN-NNN = max seq z bazy + 1 per topic.
 */
...
const BATCHES = ["e_farm_stoma_2026/1", "e_farm_lek_2026/1"];
const items = JSON.parse(
  readFileSync(resolve("exports/farmakologia-batch-2026-1.json"), "utf8"),
);
