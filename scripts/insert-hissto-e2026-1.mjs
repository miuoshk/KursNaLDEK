/**
 * Insert e_hist_stoma_2026/5 (egzamin HISSTO e2026-1).
 * ID: HIST-NN-NNN = max seq z bazy + 1 per topic.
 * tracks = ['stomatologia']; theme_label = 2026.
 * Nie rusza kafelka histologia-THEME-2026 (wspólny z LEK).
 */
...
const BATCH = "e_hist_stoma_2026/5";
const items = JSON.parse(
  readFileSync(resolve("exports/histologia-batch-stoma-2026-5.json"), "utf8"),
);
